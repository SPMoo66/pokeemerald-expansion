...
static const u8 sMapsecToRegion[] = {
    ...
    [MAPSEC_LEAFY_CLEARING]             = REGION_HOENN,
    [MAPSEC_CAVE_OF_DREAMS]             = REGION_HOENN,
    [MAPSEC_WOODLAND_CRADLE]            = REGION_HOENN,
    [MAPSEC_SEASIDE_GROTTO]             = REGION_HOENN,
    [MAPSEC_REALMS_FRAY]                = REGION_HOENN,
    [MAPSEC_SUBMERGED_CAVERN]           = REGION_HOENN,
    [MAPSEC_TRACKLESS_FOREST]           = REGION_HOENN,
    [MAPSEC_NAMELESS_CAVERN]            = REGION_HOENN,
    [MAPSEC_CRESCENT_ISLE]              = REGION_HOENN,
    [MAPSEC_PATHLESS_PLAIN]             = REGION_HOENN,
    [MAPSEC_FLORAL_PARADISE]            = REGION_HOENN,
    [MAPSEC_GNARLED_DEN]                = REGION_HOENN,
    [MAPSEC_FABLED_CAVE]                = REGION_HOENN,
    [MAPSEC_FLURRY_PEAK]                = REGION_HOENN,
    [MAPSEC_DRAKES_SANCTUM]             = REGION_HOENN,
    [MAPSEC_SEA_SPIRITS_DEN]            = REGION_HOENN,
    [MAPSEC_MYSTERY]                    = REGION_HOENN,
    [MAPSEC_GALEFORCE_CLIFF]            = REGION_HOENN,
    [MAPSEC_SEASIDE_HOLLOW]             = REGION_HOENN,
    [MAPSEC_INFERNAL_DRYLANDS]          = REGION_HOENN,
    [MAPSEC_ROCKET_REFUGE]              = REGION_HOENN,
    [MAPSEC_OVERGROWN_JUNGLE]           = REGION_HOENN,
    [MAPSEC_ROUTE_10]                   = REGION_EXPANSION_1,
