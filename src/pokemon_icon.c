...
const u8 *const gMonIconTable[NUM_SPECIES + 1] =
{
    ...
    [SPECIES_ARSELLOSKY] = gMonIcon_Arsellosky,
    [SPECIES_EVALEON] = gMonIcon_Evaleon,
    [SPECIES_AEREON] = gMonIcon_Aereon,
    [SPECIES_CONTAGEON] = gMonIcon_Contageon,
    [SPECIES_LANEON] = gMonIcon_Laneon,
    [SPECIES_SCALEON] = gMonIcon_Scaleon,
    [SPECIES_TITANEON] = gMonIcon_Titaneon,
    // Fribian Forms
    [SPECIES_GOLEM_FRIBIAN] = gMonIcon_GolemFribian,
    [SPECIES_CLOYSTER_FRIBIAN] = gMonIcon_CloysterFribian,
    [SPECIES_SHUCKLE_FRIBIAN] = gMonIcon_ShuckleFribian,
    [SPECIES_OCTILLERY_FRIBIAN] = gMonIcon_OctilleryFribian,
    [SPECIES_SKARMORY_FRIBIAN] = gMonIcon_SkarmoryFribian,
    [SPECIES_BRELOOM_FRIBIAN] = gMonIcon_BreloomFribian,
    [SPECIES_GIGALITH_FRIBIAN] = gMonIcon_GigalithFribian,
    [SPECIES_WOOLOO_FRIBIAN] = gMonIcon_WoolooFribian,
    [SPECIES_DUBWOOL_FRIBIAN] = gMonIcon_DubwoolFribian,
    // Emeribian Forms
    [SPECIES_CHARIZARD_EMERIBIAN] = gMonIcon_CharizardEmeribian,
    [SPECIES_NINETALES_EMERIBIAN] = gMonIcon_NinetalesEmeribian,
    [SPECIES_ODDISH_EMERIBIAN] = gMonIcon_OddishEmeribian,
    [SPECIES_GLOOM_EMERIBIAN] = gMonIcon_GloomEmeribian,
    [SPECIES_VILEPLUME_EMERIBIAN] = gMonIcon_VileplumEmeribian,
    [SPECIES_BELLOSSOM_EMERIBIAN] = gMonIcon_BellossomEmeribian,
    [SPECIES_NOCTOWL_EMERIBIAN] = gMonIcon_NoctowlEmeribian,
    [SPECIES_SPINARAK_EMERIBIAN] = gMonIcon_SpinarakEmeribian,
    [SPECIES_ARIADOS_EMERIBIAN] = gMonIcon_AriadosEmeribian,
    [SPECIES_MAGCARGO_EMERIBIAN] = gMonIcon_MagcargoEmeribian,
    [SPECIES_RALTS_EMERIBIAN] = gMonIcon_RaltsEmeribian,
    [SPECIES_KIRLIA_EMERIBIAN] = gMonIcon_KirliaEmeribian,
    [SPECIES_GARDEVOIR_EMERIBIAN] = gMonIcon_GardevoirEmeribian,
    [SPECIES_DRIFLOON_EMERIBIAN] = gMonIcon_DrifloonEmeribian,
    [SPECIES_DRIFBLIM_EMERIBIAN] = gMonIcon_DrifblimEmeribian,
    [SPECIES_SKIDDO_EMERIBIAN] = gMonIcon_SkiddoEmeribian,
    [SPECIES_GOGOAT_EMERIBIAN] = gMonIcon_GogoatEmeribian,
    [SPECIES_HONEDGE_EMERIBIAN] = gMonIcon_HonedgeEmeribian,
    [SPECIES_DOUBLADE_EMERIBIAN] = gMonIcon_DoubladeEmeribian,
    [SPECIES_AEGISLASH_EMERIBIAN] = gMonIcon_AegislashEmeribian,
    [SPECIES_TREVENANT_EMERIBIAN] = gMonIcon_TrevenantEmeribian,
    [SPECIES_MIMIKYU_EMERIBIAN] = gMonIcon_MimikyuEmeribian,
    [SPECIES_FALINKS_EMERIBIAN] = gMonIcon_FalinksEmeribian,
    [SPECIES_GARDEVOIR_EMERIBIAN_MEGA] = gMonIcon_GardevoirEmeribianMega,
};
*/
