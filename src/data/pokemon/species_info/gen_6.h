...
#define FLORGES_MISC_INFO(Form, iconPal)                                              \
    ...
    [SPECIES_SKIDDO_EMERIBIAN] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(SkiddoEmeribian, 48, 56),
        .frontPicYOffset = 7,
        .frontAnimFrames = sAnims_SkiddoEmeribian,
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        BACK_PIC(SkiddoEmeribian, 56, 48),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_SMALL,
        PALETTES(SkiddoEmeribian),
        ICON(SkiddoEmeribian, 2),
        .footprint = gMonFootprint_Skiddo,
        .formSpeciesIdTable = sSkiddoFormSpeciesIdTable,
        LEARNSETS(SkiddoEmeribian),
    ...
    [SPECIES_GOGOAT_EMERIBIAN] =
    {
        ...
        .trainerScale = 290,
        .trainerOffset = 1,
        FRONT_PIC(GogoatEmeribian, 56, 64),
        .frontPicYOffset = 2,
        .frontAnimFrames = sAnims_GogoatEmeribian,
        .frontAnimId = ANIM_V_STRETCH,
        BACK_PIC(GogoatEmeribian, 64, 56),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_DIP_RIGHT_SIDE,
        PALETTES(GogoatEmeribian),
        ICON(GogoatEmeribian, 2),
        .footprint = gMonFootprint_Gogoat,
        .formSpeciesIdTable = sGogoatFormSpeciesIdTable,
        LEARNSETS(GogoatEmeribian),
        .isEmeribianForm = TRUE,
    },
...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_HONEDGE_EMERIBIAN] =
    {
        ...
        .trainerScale = 257,
        .trainerOffset = 0,
        FRONT_PIC(HonedgeEmeribian, 64, 56),
        .frontPicYOffset = 4,
        .frontAnimFrames = sAnims_HonedgeEmeribian,
        .frontAnimId = ANIM_SWING_CONVEX,
        .enemyMonElevation = 4,
        BACK_PIC(HonedgeEmeribian, 48, 56),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_V_SHAKE,
        PALETTES(HonedgeEmeribian),
        ICON(HonedgeEmeribian, 2),
        .footprint = gMonFootprint_Honedge,
        .formSpeciesIdTable = sHonedgeFormSpeciesIdTable,
        LEARNSETS(HonedgeEmeribian),
        .isEmeribianForm = TRUE,
        .evolutions = EVOLUTION({EVO_LEVEL, 30, SPECIES_DOUBLADE_EMERIBIAN}),
    },
    ...
    [SPECIES_DOUBLADE_EMERIBIAN] =
    {
        ...
        .trainerScale = 257,
        .trainerOffset = 0,
        FRONT_PIC(DoubladeEmeribian, 64, 64),
        .frontPicYOffset = 5,
        .frontAnimFrames = sAnims_DoubladeEmeribian,
        .frontAnimId = ANIM_GROW_VIBRATE,
        .enemyMonElevation = 5,
        BACK_PIC(DoubladeEmeribian, 64, 64),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_H_SHAKE,
        PALETTES(DoubladeEmeribian),
        ICON(DoubladeEmeribian, 2),
        .footprint = gMonFootprint_Doublade,
        .formSpeciesIdTable = sDoubladeFormSpeciesIdTable,
        LEARNSETS(DoubladeEmeribian),
        .isEmeribianForm = TRUE,
    ...
    [SPECIES_AEGISLASH_EMERIBIAN] =
    {
        ...
        .trainerScale = 290,
        .trainerOffset = 1,
        FRONT_PIC(AegislashEmeribian, 64, 64),
        .frontPicYOffset = 1,
        .frontAnimFrames = sAnims_AegislashEmeribian,
        .frontAnimId = ANIM_GROW_VIBRATE,
        BACK_PIC(AegislashEmeribian, 64, 64),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_H_SHAKE,
        PALETTES(AegislashEmeribian),
        ICON(AegislashEmeribian, 2),
        .footprint = gMonFootprint_Aegislash,
        .formSpeciesIdTable = sAegislashFormSpeciesIdTable,
        LEARNSETS(AegislashEmeribian),
        .isEmeribianForm = TRUE,
    },
    ...
    [SPECIES_SLURPUFF_MEGA] =
    {
        ...
        .trainerScale = 257,
        .trainerOffset = 0,
        FRONT_PIC(SlurpuffMega, 48, 56),
        .frontPicYOffset = 2,
        .frontAnimFrames = sAnims_SlurpuffMega,
        .frontAnimId = ANIM_V_STRETCH,
        BACK_PIC(SlurpuffMega, 64, 64),
        .backPicYOffset = 4,
        .backAnimId = BACK_ANIM_V_SHAKE_H_SLIDE,
        PALETTES(SlurpuffMega),
        ICON(Slurpuff, 1),
        .footprint = gMonFootprint_Slurpuff,
        LEARNSETS(Slurpuff),
        .formSpeciesIdTable = sSlurpuffFormSpeciesIdTable,
    ...
    [SPECIES_AURORUS_MEGA] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(AurorusMega, 64, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = sAnims_AurorusMega,
        .frontAnimId = ANIM_GROW_VIBRATE,
        BACK_PIC(AurorusMega, 64, 64),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_SHRINK_GROW_VIBRATE,
        PALETTES(AurorusMega),
        ICON(Aurorus, 0),
        .footprint = gMonFootprint_Aurorus,
        LEARNSETS(Aurorus),
        .formSpeciesIdTable = sAurorusFormSpeciesIdTable,
...
#define GOODRA_MISC_INFO                                        \
    ...
    [SPECIES_TREVENANT_EMERIBIAN] =
    {
        ...
        .trainerScale = 271,
        .trainerOffset = 0,
        FRONT_PIC(TrevenantEmeribian, 64, 64),
        .frontPicYOffset = 5,
        .frontAnimFrames = sAnims_TrevenantEmeribian,
        .frontAnimId = ANIM_H_SLIDE_SLOW,
        BACK_PIC(TrevenantEmeribian, 64, 64),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_V_SHAKE_LOW,
        PALETTES(TrevenantEmeribian),
        ICON(TrevenantEmeribian, 1),
        .footprint = gMonFootprint_Trevenant,
        .formSpeciesIdTable = sTrevenantFormSpeciesIdTable,
        LEARNSETS(TrevenantEmeribian),
        .isEmeribianForm = TRUE,
    },
