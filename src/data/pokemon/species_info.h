...
const struct SpeciesInfo gSpeciesInfo[] =
{
    ...
    [SPECIES_ARSELLOSKY] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Arsellosky, 64, 64),
        .frontPicYOffset = 3,
        .frontAnimFrames = sAnims_Arsellosky,
        //.frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        BACK_PIC(Arsellosky, 64, 64),
        .backPicYOffset = 0,
        //.backAnimId = BACK_ANIM_NONE,
        PALETTES(Arsellosky),
        ICON(Arsellosky, 0),
        //.footprint = gMonFootprint_None,
        LEARNSETS(Arsellosky),
    ...
    [SPECIES_EVALEON] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Evaleon, 64, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = sAnims_Evaleon,
        //.frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        BACK_PIC(Evaleon, 64, 64),
        .backPicYOffset = 0,
        //.backAnimId = BACK_ANIM_NONE,
        PALETTES(Evaleon),
        ICON(Evaleon, 2),
    ...
    [SPECIES_AEREON] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Aereon, 64, 64),
        .frontPicYOffset = 5,
        .frontAnimFrames = sAnims_Aereon,
        //.frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .enemyMonElevation = 14,
        BACK_PIC(Aereon, 64, 64),
        .backPicYOffset = 0,
        //.backAnimId = BACK_ANIM_NONE,
        PALETTES(Aereon),
        ICON(Aereon, 2),
    ...
    [SPECIES_CONTAGEON] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Contageon, 64, 64),
        .frontPicYOffset = 8,
        .frontAnimFrames = sAnims_Contageon,
        //.frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        BACK_PIC(Contageon, 64, 64),
        .backPicYOffset = 0,
        //.backAnimId = BACK_ANIM_NONE,
        PALETTES(Contageon),
        ICON(Contageon, 2),
    ...
    [SPECIES_LANEON] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Laneon, 64, 64),
        .frontPicYOffset = 1,
        .frontAnimFrames = sAnims_Laneon,
        //.frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        BACK_PIC(Laneon, 64, 64),
        .backPicYOffset = 6,
        //.backAnimId = BACK_ANIM_NONE,
        PALETTES(Laneon),
        ICON(Laneon, 2),
    ...
    [SPECIES_SCALEON] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Scaleon, 64, 64),
        .frontPicYOffset = 5,
        .frontAnimFrames = sAnims_Scaleon,
        //.frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        BACK_PIC(Scaleon, 64, 64),
        .backPicYOffset = 6,
        //.backAnimId = BACK_ANIM_NONE,
        PALETTES(Scaleon),
        ICON(Scaleon, 0),
    ...
    [SPECIES_TITANEON] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(Titaneon, 64, 64),
        .frontPicYOffset = 6,
        .frontAnimFrames = sAnims_Titaneon,
        //.frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        BACK_PIC(Titaneon, 64, 64),
        .backPicYOffset = 0,
        //.backAnimId = BACK_ANIM_NONE,
        PALETTES(Titaneon),
        ICON(Titaneon, 2),
