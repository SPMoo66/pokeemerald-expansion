...
const struct SpeciesInfo gSpeciesInfoGen5[] =
{
    ...
    [SPECIES_SERPERIOR_MEGA] =
    {
        ...
        .trainerScale = 405,
        .trainerOffset = 8,
        FRONT_PIC(SerperiorMega, 64, 56),
        .frontPicYOffset = 1,
        .frontAnimFrames = sAnims_SerperiorMega,
        .frontAnimId = ANIM_CIRCULAR_STRETCH_TWICE,
        BACK_PIC(SerperiorMega, 64, 64),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_V_STRETCH,
        PALETTES(SerperiorMega),
        ICON(Serperior, 1),
        .footprint = gMonFootprint_Serperior,
        LEARNSETS(Serperior),
        .formSpeciesIdTable = sSerperiorFormSpeciesIdTable,
    ...
    [SPECIES_DEWOTT] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 36, SPECIES_SAMUROTT},
                                {EVO_MOVE, MOVE_FEINT_ATTACK, SPECIES_SAMUROTT_HISUIAN}),
    },
...
#define SAMUROTT_MISC_INFO                                                  \
    ...
    [SPECIES_GIGALITH_FRIBIAN] =
    {
        ...
        .trainerScale = 290,
        .trainerOffset = 1,
        FRONT_PIC(GigalithFribian, 64, 64),
        .frontPicYOffset = 1,
        .frontAnimFrames = sAnims_GigalithFribian,
        .frontAnimId = ANIM_ROTATE_UP_SLAM_DOWN,
        BACK_PIC(GigalithFribian, 56, 64),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_V_SHAKE_LOW,
        PALETTES(GigalithFribian),
        ICON(GigalithFribian, 0),
        .footprint = gMonFootprint_Gigalith,
        .formSpeciesIdTable = sGigalithFormSpeciesIdTable,
        LEARNSETS(GigalithFribian),
        .isFribianForm = TRUE,
    },
...
#define DARUMAKA_MISC_INFO                                                  \
    ...
    [SPECIES_DARUMAKA] =
    {
        ...
        ICON(Darumaka, 0),
        LEARNSETS(Darumaka),
        .evolutions = EVOLUTION({EVO_LEVEL, 34, SPECIES_DARMANITAN_STANDARD_MODE}),
    },
...
#define DARMANITAN_UNOVAN_MISC_INFO                                         \
    ...
    [SPECIES_DARUMAKA_GALARIAN] =
    {
        ...
        .isGalarianForm = TRUE,
        .evolutions = EVOLUTION({EVO_LEVEL, 34, SPECIES_DARMANITAN_GALARIAN_STANDARD_MODE}),
    },
...
#define YAMASK_MISC_INFO                                            \
    ...
    [SPECIES_TRUBBISH] =
    {
        ...
        LEARNSETS(Trubbish),
        .evolutions = EVOLUTION({EVO_LEVEL, 33, SPECIES_GARBODOR}),
    },
...
#define SAWSBUCK_MISC_INFO                                                              \
    ...
    [SPECIES_KLINKLANG_MEGA] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(KlinklangMega, 64, 64),
        .frontPicYOffset = 5,
        .frontAnimFrames = sAnims_KlinklangMega,
        .frontAnimId = ANIM_CIRCULAR_STRETCH_TWICE,
        .enemyMonElevation = 1,
        BACK_PIC(KlinklangMega, 64, 64),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_CIRCLE_COUNTERCLOCKWISE,
        PALETTES(KlinklangMega),
        ICON(Klinklang, 0),
        .footprint = gMonFootprint_Klinklang,
        LEARNSETS(Klinklang),
        .formSpeciesIdTable = sKlinklangFormSpeciesIdTable,
    ...
    [SPECIES_HAXORUS_MEGA] =
    {
        ...
        .trainerScale = 286,
        .trainerOffset = 1,
        FRONT_PIC(HaxorusMega, 64, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = sAnims_HaxorusMega,
        .frontAnimId = ANIM_H_SHAKE,
        BACK_PIC(HaxorusMega, 64, 56),
        .backPicYOffset = 8,
        .backAnimId = BACK_ANIM_V_SHAKE_LOW,
        PALETTES(HaxorusMega),
        ICON(Haxorus, 2),
        .footprint = gMonFootprint_Haxorus,
        LEARNSETS(Haxorus),
        .formSpeciesIdTable = sHaxorusFormSpeciesIdTable,
...
#define BRAVIARY_MISC_INFO                                      \
    ...
    [SPECIES_HYDREIGON_MEGA] =
    {
        ...
        .trainerScale = 286,
        .trainerOffset = 1,
        FRONT_PIC(HydreigonMega, 64, 64),
        .frontPicYOffset = 2,
        .frontAnimFrames = sAnims_HydreigonMega,
        .frontAnimId = ANIM_RISING_WOBBLE,
        BACK_PIC(HydreigonMega, 64, 56),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_GROW_STUTTER,
        PALETTES(HydreigonMega),
        ICON(Hydreigon, 2),
        .footprint = gMonFootprint_Hydreigon,
        LEARNSETS(Hydreigon),
        .formSpeciesIdTable = sHydreigonFormSpeciesIdTable,
