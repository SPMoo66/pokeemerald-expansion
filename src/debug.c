...
extern const u8 Common_EventScript_MoveReminder[];
...
{
    { COMPOUND_STRING("Move Reminder"),      DebugAction_ExecuteScript, Common_EventScript_MoveReminder },
...
static const struct DebugMenuOption sDebugMenu_Actions_ROMInfo2[] =
{
    ...
    { COMPOUND_STRING("Emeralbody Version"), DebugAction_ExecuteScript, Debug_ShowEmeralbodyVersion },
    { NULL }
};
...
static void DebugAction_CreateFollowerNPC(u8 taskId)
{
    ...
    LockPlayerFieldControls();
    DestroyFollowerNPC();
    SetFollowerNPCData(FNPC_DATA_BATTLE_PARTNER, PARTNER_STEVEN_MOSSDEEP);
...
#define SOUND_LIST_BGM                       \
    ...
    X(MUS_VICTORY_IS_RIGHT_BEFORE_YOUR_EYES)
