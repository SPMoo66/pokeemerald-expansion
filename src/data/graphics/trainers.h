...
const struct TrainerSprite gTrainerSprites[] =
{
    ...
    TRAINER_SPRITE(TRAINER_PIC_AQUA_ADMIN_MATT, gTrainerFrontPic_AquaAdminMatt, gTrainerPalette_AquaAdminMatt),
    TRAINER_SPRITE(TRAINER_PIC_AQUA_ADMIN_SHELLY, gTrainerFrontPic_AquaAdminShelly, gTrainerPalette_AquaAdminShelly),
    ...
    TRAINER_SPRITE(TRAINER_PIC_CHAMPION_WALLACE, gTrainerFrontPic_ChampionWallace, gTrainerPalette_ChampionWallace, -8, 0, 0x200),
    ...
    TRAINER_SPRITE(TRAINER_PIC_MAGMA_ADMIN_COURTNEY, gTrainerFrontPic_MagmaAdminCourtney, gTrainerPalette_MagmaAdminCourtney),
    TRAINER_SPRITE(TRAINER_PIC_MAGMA_ADMIN_TABITHA, gTrainerFrontPic_MagmaAdminTabitha, gTrainerPalette_MagmaAdminTabitha),
    ...
    TRAINER_SPRITE(TRAINER_PIC_BARON, gTrainerFrontPic_Baron, gTrainerPalette_Baron),
    TRAINER_SPRITE(TRAINER_PIC_HARPER, gTrainerFrontPic_Harper, gTrainerPalette_Harper),
    TRAINER_SPRITE(TRAINER_PIC_JAKSON, gTrainerFrontPic_Jakson, gTrainerPalette_Jakson),
    TRAINER_SPRITE(TRAINER_PIC_REDD, gTrainerFrontPic_Redd, gTrainerPalette_Redd),
    TRAINER_SPRITE(TRAINER_PIC_SAKURA, gTrainerFrontPic_Sakura, gTrainerPalette_Sakura),
    TRAINER_SPRITE(TRAINER_PIC_WALLY_CONFIDENT, gTrainerFrontPic_WallyConfident, gTrainerPalette_WallyConfident),
    TRAINER_SPRITE(TRAINER_PIC_SKIER_M, gTrainerFrontPic_Skier_M, gTrainerPalette_Skier_M),
    TRAINER_SPRITE(TRAINER_PIC_SKIER_F, gTrainerFrontPic_Skier_F, gTrainerPalette_Skier_F),
    TRAINER_SPRITE(TRAINER_PIC_ROCKET_M, gTrainerFrontPic_Rocket_M, gTrainerPalette_Rocket_M),
    TRAINER_SPRITE(TRAINER_PIC_ROCKET_F, gTrainerFrontPic_Rocket_F, gTrainerPalette_Rocket_F),
    TRAINER_SPRITE(TRAINER_PIC_GIOVANNI, gTrainerFrontPic_Giovanni, gTrainerPalette_Giovanni),
    TRAINER_SPRITE(TRAINER_PIC_LEADER_ROARK, gTrainerFrontPic_LeaderRoark, gTrainerPalette_LeaderRoark),
    TRAINER_SPRITE(TRAINER_PIC_LEADER_GARDENIA, gTrainerFrontPic_LeaderGardenia, gTrainerPalette_LeaderGardenia),
    TRAINER_SPRITE(TRAINER_PIC_LEADER_MAYLENE, gTrainerFrontPic_LeaderMaylene, gTrainerPalette_LeaderMaylene),
    TRAINER_SPRITE(TRAINER_PIC_LEADER_WAKE, gTrainerFrontPic_LeaderWake, gTrainerPalette_LeaderWake),
    TRAINER_SPRITE(TRAINER_PIC_LEADER_FANTINA, gTrainerFrontPic_LeaderFantina, gTrainerPalette_LeaderFantina),
    TRAINER_SPRITE(TRAINER_PIC_LEADER_BYRON, gTrainerFrontPic_LeaderByron, gTrainerPalette_LeaderByron),
    TRAINER_SPRITE(TRAINER_PIC_LEADER_CANDICE, gTrainerFrontPic_LeaderCandice, gTrainerPalette_LeaderCandice),
    TRAINER_SPRITE(TRAINER_PIC_LEADER_VOLKNER, gTrainerFrontPic_LeaderVolkner, gTrainerPalette_LeaderVolkner),
    TRAINER_SPRITE(TRAINER_PIC_ELITE_FOUR_AARON, gTrainerFrontPic_EliteFourAaron, gTrainerPalette_EliteFourAaron),
    TRAINER_SPRITE(TRAINER_PIC_ELITE_FOUR_BERTHA, gTrainerFrontPic_EliteFourBertha, gTrainerPalette_EliteFourBertha),
...
const struct TrainerBacksprite gTrainerBacksprites[] =
{
    ...
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_STEVEN, 4, gTrainerBackPic_Steven, gTrainerBackPicPalette_Steven, sBackAnims_Hoenn),
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_BLANK, 4, gTrainerBackPic_Blank, gTrainerPalette_Wally, sBackAnims_Hoenn),
};
