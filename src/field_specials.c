...
void SetTrickHouseNuggetFlag(void)
{
    ...
    u16 flag = FLAG_HIDDEN_ITEM_TRICK_HOUSE_BIG_NUGGET;
    *specVar = flag;
    FlagSet(flag);
}
...
{
    u8 i;
    u16 starter = GetStarterPokemon(VarGet(VAR_STARTER_MON), VarGet(VAR_STARTER_SET));
...
{
    return FlagGet(FLAG_HIDDEN_ITEM_ROUTE_116_BIG_PEARL);
}
...
void GiveRandomDemoSpeciesCommon(void)
{
    ...
    u16 rnd = Random() % ARRAY_COUNT(sDemoBaseSpeciesCommon);
    ScriptGiveMon(sDemoBaseSpeciesCommon[rnd], 50, ITEM_NONE);
    StringCopy(gStringVar1, GetSpeciesName(sDemoBaseSpeciesCommon[rnd]));
}

void GiveRandomDemoSpeciesRare(void)
{
    static const u16 sDemoBaseSpeciesRare[] =
    {
        SPECIES_BULBASAUR,
        SPECIES_CHARMANDER,
        SPECIES_SQUIRTLE,
    ...
    u16 rnd = Random() % ARRAY_COUNT(sDemoBaseSpeciesRare);
    ScriptGiveMon(sDemoBaseSpeciesRare[rnd], 50, ITEM_NONE);
    StringCopy(gStringVar1, GetSpeciesName(sDemoBaseSpeciesRare[rnd]));
}

void GiveRandomDemoSpeciesLegendary(void)
{
    static const u16 sDemoBaseSpeciesLegendary[] =
    {
        SPECIES_ARTICUNO,
        SPECIES_ZAPDOS,
        SPECIES_MOLTRES,
