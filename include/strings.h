...
extern const u8 gText_Option1x[];           //tx_optionsPlus
extern const u8 gText_Option2x[];           //tx_optionsPlus
extern const u8 gText_Option3x[];           //tx_optionsPlus
extern const u8 gText_Option4x[];           //tx_optionsPlus
...
extern const u8 gText_YouWantedVar1ThatllBe_Cap[];
...
extern const u8 MatchCall_Text_JaksonUnavailable[];
extern const u8 MatchCall_Text_Jakson1[];
extern const u8 MatchCall_Text_Jakson2[];
extern const u8 MatchCall_Text_Jakson3[];
extern const u8 MatchCall_Text_Jakson4[];
extern const u8 MatchCall_Text_Jakson5[];
extern const u8 MatchCall_Text_Jakson6[];
extern const u8 MatchCall_Text_Jakson7[];
extern const u8 MatchCall_Text_Jakson8[];
extern const u8 MatchCall_Text_Jakson9[];
extern const u8 MatchCall_Text_HarperUnavailable[];
extern const u8 MatchCall_Text_Harper1[];
extern const u8 MatchCall_Text_Harper2[];
extern const u8 MatchCall_Text_Harper3[];
extern const u8 MatchCall_Text_Harper4[];
extern const u8 MatchCall_Text_Harper5[];
extern const u8 MatchCall_Text_Harper6[];
extern const u8 MatchCall_Text_Harper7[];
extern const u8 MatchCall_Text_ReddUnavailable[];
extern const u8 MatchCall_Text_Redd1[];
extern const u8 MatchCall_Text_Redd2[];
extern const u8 MatchCall_Text_Redd3[];
extern const u8 MatchCall_Text_Redd4[];
extern const u8 MatchCall_Text_Redd5[];
extern const u8 MatchCall_Text_Redd6[];
extern const u8 MatchCall_Text_Redd7[];
extern const u8 MatchCall_Text_Redd8[];
extern const u8 MatchCall_Text_Redd9[];
extern const u8 MatchCall_Text_SakuraUnavailable[];
extern const u8 MatchCall_Text_Sakura1[];
extern const u8 MatchCall_Text_Sakura2[];
extern const u8 MatchCall_Text_Sakura3[];
extern const u8 MatchCall_Text_Sakura4[];
extern const u8 MatchCall_Text_Sakura5[];
extern const u8 MatchCall_Text_Sakura6[];
extern const u8 MatchCall_Text_Sakura7[];
extern const u8 MatchCall_Text_Sakura8[];
extern const u8 MatchCall_Text_Sakura9[];
extern const u8 MatchCall_Text_BaronUnavailable[];
extern const u8 MatchCall_Text_BaronsMomUnavailable[];
extern const u8 MatchCall_Text_BaronsMom1[];
extern const u8 MatchCall_Text_BaronsMom2[];
extern const u8 MatchCall_Text_BaronsMom3[];
extern const u8 MatchCall_Text_BaronsMom4[];
extern const u8 MatchCall_Text_BaronsMom5[];
extern const u8 MatchCall_Text_BaronsMom6[];
...
extern const u8 MatchCall_Text_Looker1[];
extern const u8 MatchCall_Text_Looker2[];
extern const u8 MatchCall_Text_Looker3[];
extern const u8 MatchCall_Text_Looker4[];
extern const u8 MatchCall_Text_Looker5[];
...
extern const u8 gText_JaksonMatchCallDesc[];
extern const u8 gText_HarperMatchCallDesc[];
extern const u8 gText_ReddMatchCallDesc[];
extern const u8 gText_SakuraMatchCallDesc[];
extern const u8 gText_BaronMatchCallDesc[];
...
extern const u8 gText_BaronsMom[];
extern const u8 gText_LookerMatchCallDesc[];
extern const u8 gText_LookerMatchCallName[];
extern const u8 gText_MatchCallJakson_Strategy[];
extern const u8 gText_MatchCallJakson_Pokemon[];
extern const u8 gText_MatchCallJakson_Intro1[];
extern const u8 gText_MatchCallJakson_Intro2[];
extern const u8 gText_MatchCallHarper_Strategy[];
extern const u8 gText_MatchCallHarper_Pokemon[];
extern const u8 gText_MatchCallHarper_Intro1[];
extern const u8 gText_MatchCallHarper_Intro2[];
extern const u8 gText_MatchCallRedd_Strategy[];
extern const u8 gText_MatchCallRedd_Pokemon[];
extern const u8 gText_MatchCallRedd_Intro1[];
extern const u8 gText_MatchCallRedd_Intro2[];
extern const u8 gText_MatchCallSakura_Strategy[];
extern const u8 gText_MatchCallSakura_Pokemon[];
extern const u8 gText_MatchCallSakura_Intro1[];
extern const u8 gText_MatchCallSakura_Intro2[];
extern const u8 gText_MatchCallBaron_Strategy[];
extern const u8 gText_MatchCallBaron_Pokemon[];
extern const u8 gText_MatchCallBaron_Intro1[];
extern const u8 gText_MatchCallBaron_Intro2[];
...
extern const u8 gText_SelectFourthPkmn[];
extern const u8 gText_TheseFourPkmnOkay[];
