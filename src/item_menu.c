...
static const u16 sItemsByType[ITEMS_COUNT] =
{
    ...
    [ITEM_MAX_MUSHROOMS] = ITEM_TYPE_STAT_BOOST_DRINK,
    ...
    [ITEM_METAL_COAT] = ITEM_TYPE_HELD_ITEM,
    ...
    [ITEM_RETRO_MAIL] = ITEM_TYPE_MAIL,
        ...
        [ITEM_MAX_HONEY] = ITEM_TYPE_HEALTH_RECOVERY,
        ...
        [ITEM_BERSERK_GENE] = ITEM_TYPE_HELD_ITEM,
        ...
        [ITEM_BUG_TERA_SHARD] = ITEM_TYPE_TERA_SHARD,
        [ITEM_DARK_TERA_SHARD] = ITEM_TYPE_TERA_SHARD,
        [ITEM_DRAGON_TERA_SHARD] = ITEM_TYPE_TERA_SHARD,
        [ITEM_ELECTRIC_TERA_SHARD] = ITEM_TYPE_TERA_SHARD,
        [ITEM_FAIRY_TERA_SHARD] = ITEM_TYPE_TERA_SHARD,
        [ITEM_FIGHTING_TERA_SHARD] = ITEM_TYPE_TERA_SHARD,
        [ITEM_FIRE_TERA_SHARD] = ITEM_TYPE_TERA_SHARD,
        [ITEM_FLYING_TERA_SHARD] = ITEM_TYPE_TERA_SHARD,
        [ITEM_GHOST_TERA_SHARD] = ITEM_TYPE_TERA_SHARD,
        [ITEM_GRASS_TERA_SHARD] = ITEM_TYPE_TERA_SHARD,
        [ITEM_GROUND_TERA_SHARD] = ITEM_TYPE_TERA_SHARD,
        [ITEM_ICE_TERA_SHARD] = ITEM_TYPE_TERA_SHARD,
        [ITEM_NORMAL_TERA_SHARD] = ITEM_TYPE_TERA_SHARD,
        [ITEM_POISON_TERA_SHARD] = ITEM_TYPE_TERA_SHARD,
        [ITEM_PSYCHIC_TERA_SHARD] = ITEM_TYPE_TERA_SHARD,
        [ITEM_ROCK_TERA_SHARD] = ITEM_TYPE_TERA_SHARD,
        [ITEM_STEEL_TERA_SHARD] = ITEM_TYPE_TERA_SHARD,
        [ITEM_WATER_TERA_SHARD] = ITEM_TYPE_TERA_SHARD,
        [ITEM_STELLAR_TERA_SHARD] = ITEM_TYPE_TERA_SHARD,
        ...
        [ITEM_MEGA_STONE_X] = ITEM_TYPE_MEGA_STONE,
        [ITEM_MEGA_STONE_Y] = ITEM_TYPE_MEGA_STONE,
        [ITEM_MEGA_STONE_G] = ITEM_TYPE_MEGA_STONE,
        [ITEM_MEGA_STONE_LX] = ITEM_TYPE_MEGA_STONE,
        [ITEM_MEGA_STONE_LY] = ITEM_TYPE_MEGA_STONE,
        ...
        [ITEM_GROWTH_MULCH] = ITEM_TYPE_MULCH,
        [ITEM_DAMP_MULCH] = ITEM_TYPE_MULCH,
        [ITEM_STABLE_MULCH] = ITEM_TYPE_MULCH,
        [ITEM_GOOEY_MULCH] = ITEM_TYPE_MULCH,
        [ITEM_RICH_MULCH] = ITEM_TYPE_MULCH,
        [ITEM_SURPRISE_MULCH] = ITEM_TYPE_MULCH,
        [ITEM_BOOST_MULCH] = ITEM_TYPE_MULCH,
        [ITEM_AMAZE_MULCH] = ITEM_TYPE_MULCH,
        ...
        [ITEM_SCROLL_OF_DARKNESS] = ITEM_TYPE_EVOLUTION_ITEM,
        [ITEM_SCROLL_OF_WATERS] = ITEM_TYPE_EVOLUTION_ITEM,
        [ITEM_LEADERS_CREST] = ITEM_TYPE_EVOLUTION_ITEM,
        [ITEM_BLACK_AUGURITE] = ITEM_TYPE_EVOLUTION_ITEM,
        [ITEM_LINKING_CORD] = ITEM_TYPE_EVOLUTION_ITEM,
        [ITEM_PEAT_BLOCK] = ITEM_TYPE_EVOLUTION_ITEM,
        [ITEM_METAL_ALLOY] = ITEM_TYPE_EVOLUTION_ITEM,

        [ITEM_STRAWBERRY_SWEET] = ITEM_TYPE_EVOLUTION_SWEET,
        [ITEM_LOVE_SWEET] = ITEM_TYPE_EVOLUTION_SWEET,
        [ITEM_BERRY_SWEET] = ITEM_TYPE_EVOLUTION_SWEET,
        [ITEM_CLOVER_SWEET] = ITEM_TYPE_EVOLUTION_SWEET,
        [ITEM_FLOWER_SWEET] = ITEM_TYPE_EVOLUTION_SWEET,
        [ITEM_STAR_SWEET] = ITEM_TYPE_EVOLUTION_SWEET,
        [ITEM_RIBBON_SWEET] = ITEM_TYPE_EVOLUTION_SWEET,

        [ITEM_BOTTLE_CAP] = ITEM_TYPE_CAP,
        [ITEM_GOLD_BOTTLE_CAP] = ITEM_TYPE_CAP,

        [ITEM_PRETTY_FEATHER] = ITEM_TYPE_SELLABLE,
        ...
        [ITEM_BIG_BAMBOO_SHOOT] = ITEM_TYPE_SELLABLE,
        [ITEM_TINY_BAMBOO_SHOOT] = ITEM_TYPE_SELLABLE,
        ...
        [ITEM_STRANGE_SOUVENIR] = ITEM_TYPE_RELIC,

        [ITEM_GALARICA_TWIG] = ITEM_TYPE_SHARD,
        [ITEM_ARMORITE_ORE] = ITEM_TYPE_SHARD,
        [ITEM_DYNITE_ORE] = ITEM_TYPE_SHARD,
