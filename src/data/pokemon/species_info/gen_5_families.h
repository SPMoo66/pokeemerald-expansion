...
#define COTTONEE_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_GRASS)
    ...
    [SPECIES_PETILIL] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_SUN_STONE, SPECIES_LILLIGANT},
                                {EVO_LEVEL, 28, SPECIES_LILLIGANT_HISUI, CONDITIONS({IF_TYPE_IN_PARTY, TYPE_FIGHTING})}),
    },
    ...
    [SPECIES_BASCULIN_RED_STRIPED] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 45, SPECIES_BASCULEGION_M, CONDITIONS({IF_GENDER, MON_MALE})},
                                {EVO_LEVEL, 45, SPECIES_BASCULEGION_F, CONDITIONS({IF_GENDER, MON_FEMALE})})
    },
    ...
    [SPECIES_YAMASK] =
    {
        ...
        .abilities = { ABILITY_MUMMY, ABILITY_NONE, ABILITY_WANDERING_SPIRIT },
        .bodyColor = BODY_COLOR_BLACK,
