...
{
    {.question = sQuizLadyQuestion1,  .answer = EC_WORD_POKEDEX,    .prize = ITEM_PEARL},
    {.question = sQuizLadyQuestion2,  .answer = EC_WORD_DARK,       .prize = ITEM_PRETTY_FEATHER},
    {.question = sQuizLadyQuestion3,  .answer = EC_WORD_LEVEL,      .prize = ITEM_STARDUST},
