...
const u32 gBattleEnvironmentPalette_Frontier[] = INCBIN_U32("graphics/battle_environment/building/battle_frontier.gbapal.lz"); // this is also used for link battles
...
const u32 gBattleEnvironmentPalette_BuildingAqua[] = INCBIN_U32("graphics/battle_environment/building/palette4.gbapal.lz");
const u32 gBattleEnvironmentPalette_BuildingMagma[] = INCBIN_U32("graphics/battle_environment/building/palette5.gbapal.lz");
const u32 gBattleEnvironmentPalette_StadiumLeader[] = INCBIN_U32("graphics/battle_environment/stadium/palette8.gbapal.lz");
