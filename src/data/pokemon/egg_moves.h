...
static const u16 sOddishEmeribianEggMoveLearnset[] = {
    MOVE_SOAK,
    MOVE_RAIN_DANCE,
    MOVE_AQUA_RING,
    MOVE_INGRAIN,
...
static const u16 sDoduoEmeribianEggMoveLearnset[] = {
    MOVE_QUICK_ATTACK,
    MOVE_SUPERSONIC,
    MOVE_HAZE,
    MOVE_FEINT_ATTACK,
...
static const u16 sSpinarakEmeribianEggMoveLearnset[] = {
    MOVE_SIGNAL_BEAM,
    MOVE_PURSUIT,
    MOVE_TOXIC_SPIKES,
    MOVE_MEGAHORN,
...
static const u16 sHoppipEmeribianEggMoveLearnset[] = {
    MOVE_AMNESIA,
    MOVE_HELPING_HAND,
    MOVE_HAIL,
    MOVE_ENCORE,
...
static const u16 sShuckleFribianEggMoveLearnset[] = {
    MOVE_SWEET_SCENT,
    MOVE_KNOCK_OFF,
    MOVE_HELPING_HAND,
    MOVE_ACUPRESSURE,
...
static const u16 sArselloskyEggMoveLearnset[] = {
    MOVE_DRILL_PECK,
    MOVE_PURSUIT,
    MOVE_WHIRLWIND,
    MOVE_SKY_ATTACK,
...
static const u16 sRaltsEmeribianEggMoveLearnset[] = {
        MOVE_DISABLE,
        MOVE_MEAN_LOOK,
        MOVE_MEMENTO,
        MOVE_DESTINY_BOND,
...
static const u16 sDrifloonEmeribianEggMoveLearnset[] = {
    MOVE_MEMENTO,
    MOVE_BODY_SLAM,
    MOVE_DISABLE,
    MOVE_HAZE,
...
static const u16 sBunearyEmeribianEggMoveLearnset[] = {
    MOVE_FAKE_OUT,
    MOVE_FAKE_TEARS,
    MOVE_FLAIL,
    MOVE_COPYCAT,
...
static const u16 sSkiddoEmeribianEggMoveLearnset[] = {
    MOVE_GRASSY_TERRAIN,
    MOVE_EMBARGO,
    MOVE_ROCK_POLISH,
    MOVE_BULLDOZE,
...
static const u16 sHonedgeEmeribianEggMoveLearnset[] = {
        MOVE_ASTONISH,
        MOVE_SHADOW_PUNCH,
        MOVE_CURSE,
    MOVE_UNAVAILABLE,
...
static const u16 sMimikyuEmeribianEggMoveLearnset[] = {
    MOVE_GRUDGE,
    MOVE_NIGHT_SLASH,
    MOVE_DISABLE,
    MOVE_CURSE,
...
static const u16 sWoolooFribianEggMoveLearnset[] = {
    MOVE_COUNTER,
    MOVE_STOMP,
    MOVE_SWAGGER,
    MOVE_GRASSY_GLIDE,
...
#if P_FAMILY_FALINKS
static const u16 sFalinksEmeribianEggMoveLearnset[] = {
    MOVE_CORROSIVE_GAS,
    MOVE_BANEFUL_BUNKER,
    MOVE_IRON_DEFENSE,
    MOVE_GEAR_UP,
