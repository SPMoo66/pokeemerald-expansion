...
// Gen5 assets
static const u8 sMapPopUpTilesPrimary_Black[] = INCGFX_U8("graphics/map_popup/black_primary.png", ".4bpp");
static const u8 sMapPopUpTilesSecondary_Black[] = INCGFX_U8("graphics/map_popup/black_secondary.png", ".4bpp");
static const u16 sMapPopUpTilesPalette_Black[16] = INCGFX_U16("graphics/map_popup/black.pal", ".gbapal");
