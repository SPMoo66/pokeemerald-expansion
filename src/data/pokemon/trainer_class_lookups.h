const u16 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_JAKSON] = TRAINER_PIC_FRONT_JAKSON,
    [FACILITY_CLASS_HARPER] = TRAINER_PIC_FRONT_HARPER,
    [FACILITY_CLASS_REDD] = TRAINER_PIC_FRONT_REDD,
    [FACILITY_CLASS_SAKURA] = TRAINER_PIC_FRONT_SAKURA,
    [FACILITY_CLASS_BARON] = TRAINER_PIC_FRONT_BARON,
};
...
const enum TrainerClassID gFacilityClassToTrainerClass[] =
{
    ...
    [FACILITY_CLASS_JAKSON] = TRAINER_CLASS_RIVAL,
    [FACILITY_CLASS_HARPER] = TRAINER_CLASS_RIVAL,
    [FACILITY_CLASS_REDD] = TRAINER_CLASS_RIVAL,
    [FACILITY_CLASS_SAKURA] = TRAINER_CLASS_RIVAL,
    [FACILITY_CLASS_BARON] = TRAINER_CLASS_RIVAL,
};
