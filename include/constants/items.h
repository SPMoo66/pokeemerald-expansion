...
enum __attribute__((packed)) Item
{
    ...
    // Mega Stones
    ITEM_MEGA_STONE_X = 292,
    ITEM_MEGA_STONE_Y = 293,
    ITEM_MEGA_STONE_G = 294,
    ITEM_MEGA_STONE_LX = 295,
    ITEM_MEGA_STONE_LY = 296,
    ITEM_PIDGEOTITE = 297,
    ITEM_ALAKAZITE = 298,
    ...
    // Charms
    ITEM_OVAL_CHARM = 710,
    ITEM_SHINY_CHARM = 711,
    ITEM_CATCHING_CHARM = 712,
    ITEM_EXP_CHARM = 713,

    // Form-changing Key Items
    ITEM_ROTOM_CATALOG = 714,
    ITEM_GRACIDEA = 715,
    ITEM_REVEAL_GLASS = 716,
    ITEM_DNA_SPLICERS = 717,
    ITEM_ZYGARDE_CUBE = 718,
    ITEM_PRISON_BOTTLE = 719,
    ITEM_N_SOLARIZER = 720,
    ITEM_N_LUNARIZER = 721,
    ITEM_REINS_OF_UNITY = 722,

    // Battle Mechanic Key Items
    ITEM_MEGA_RING = 723,
    ITEM_Z_POWER_RING = 724,
    ITEM_DYNAMAX_BAND = 725,
    ...
    ITEM_GOOD_ROD = 730,
    ITEM_SUPER_ROD = 731,
    ITEM_DOWSING_MACHINE = 732,
    ITEM_ITEMFINDER = ITEM_DOWSING_MACHINE, // Pre-Gen IV name
    ITEM_DOWSING_MCHN = ITEM_DOWSING_MACHINE, // Gen IV-V name
    ITEM_TOWN_MAP = 733,
    ITEM_VS_SEEKER = 734,
    ITEM_TM_CASE = 735,
    ITEM_BERRY_POUCH = 736,
    ITEM_POKEMON_BOX_LINK = 737,
    ITEM_POKEMON_BOX = ITEM_POKEMON_BOX_LINK, // Pre-Gen VIII name
    ITEM_COIN_CASE = 738,
    ITEM_POWDER_JAR = 739,
    ITEM_WAILMER_PAIL = 740,
    ITEM_POKE_RADAR = 741,
    ITEM_POKEBLOCK_CASE = 742,
    ITEM_SOOT_SACK = 743,
    ITEM_POKE_FLUTE = 744,
    ITEM_FAME_CHECKER = 745,
    ITEM_TEACHY_TV = 746,

    // Story Key Items
    ITEM_SS_TICKET = 747,
    ITEM_EON_TICKET = 748,
    ITEM_MYSTIC_TICKET = 749,
    ITEM_AURORA_TICKET = 750,
    ITEM_OLD_SEA_MAP = 751,
    ITEM_LETTER = 752,
    ITEM_DEVON_PARTS = 753,
    ITEM_DEVON_GOODS = ITEM_DEVON_PARTS, // Pre-Gen VI name
    ITEM_GO_GOGGLES = 754,
    ITEM_DEVON_SCOPE = 755,
    ITEM_BASEMENT_KEY = 756,
    ITEM_SCANNER = 757,
    ITEM_STORAGE_KEY = 758,
    ITEM_KEY_TO_ROOM_1 = 759,
    ITEM_RM_1_KEY = ITEM_KEY_TO_ROOM_1, // Pre-Gen VI name
    ITEM_KEY_TO_ROOM_2 = 760,
    ITEM_RM_2_KEY = ITEM_KEY_TO_ROOM_2, // Pre-Gen VI name
    ITEM_KEY_TO_ROOM_4 = 761,
    ITEM_RM_4_KEY = ITEM_KEY_TO_ROOM_4, // Pre-Gen VI name
    ITEM_KEY_TO_ROOM_6 = 762,
    ITEM_RM_6_KEY = ITEM_KEY_TO_ROOM_6, // Pre-Gen VI name
    ITEM_METEORITE = 763,
    ITEM_MAGMA_EMBLEM = 764,
    ITEM_CONTEST_PASS = 765,
    ITEM_WISH_TAG = 766,
    ITEM_SECRET_KEY = 767,
    ITEM_BIKE_VOUCHER = 768,
    ITEM_GOLD_TEETH = 769,
    ITEM_CARD_KEY = 770,
    ITEM_LIFT_KEY = 771,
    ITEM_SILPH_SCOPE = 772,
    ITEM_TRI_PASS = 773,
    ITEM_RAINBOW_PASS = 774,
    ITEM_TEA = 775,
    ITEM_RUBY = 776,
    ITEM_SAPPHIRE = 777,

    // GEN IX ITEMS
    ITEM_ABILITY_SHIELD = 778,
    ITEM_CLEAR_AMULET = 779,
    ITEM_PUNCHING_GLOVE = 780,
    ITEM_COVERT_CLOAK = 781,
    ITEM_LOADED_DICE = 782,
    ITEM_AUSPICIOUS_ARMOR = 783,
    ITEM_BOOSTER_ENERGY = 784,
    ITEM_BIG_BAMBOO_SHOOT = 785,
    ITEM_GIMMIGHOUL_COIN = 786,
    ITEM_LEADERS_CREST = 787,
    ITEM_MALICIOUS_ARMOR = 788,
    ITEM_MIRROR_HERB = 789,
    ITEM_SCROLL_OF_DARKNESS = 790,
    ITEM_SCROLL_OF_WATERS = 791,
    ITEM_TERA_ORB = 792,
    ITEM_TINY_BAMBOO_SHOOT = 793,

    ITEM_BUG_TERA_SHARD = 794,
    ITEM_DARK_TERA_SHARD = 795,
    ITEM_DRAGON_TERA_SHARD = 796,
    ITEM_ELECTRIC_TERA_SHARD = 797,
    ITEM_FAIRY_TERA_SHARD = 798,
    ITEM_FIGHTING_TERA_SHARD = 799,
    ITEM_FIRE_TERA_SHARD = 800,
    ITEM_FLYING_TERA_SHARD = 801,
    ITEM_GHOST_TERA_SHARD = 802,
    ITEM_GRASS_TERA_SHARD = 803,
    ITEM_GROUND_TERA_SHARD = 804,
    ITEM_ICE_TERA_SHARD = 805,
    ITEM_NORMAL_TERA_SHARD = 806,
    ITEM_POISON_TERA_SHARD = 807,
    ITEM_PSYCHIC_TERA_SHARD = 808,
    ITEM_ROCK_TERA_SHARD = 809,
    ITEM_STEEL_TERA_SHARD = 810,
    ITEM_WATER_TERA_SHARD = 811,

    ITEM_ADAMANT_CRYSTAL = 812,
    ITEM_GRISEOUS_CORE = 813,
    ITEM_LUSTROUS_GLOBE = 814,

    ITEM_BLACK_AUGURITE = 815,
    ITEM_LINKING_CORD = 816,
    ITEM_PEAT_BLOCK = 817,
    ITEM_BERSERK_GENE = 818,

    ITEM_FAIRY_FEATHER = 819,
    ITEM_SYRUPY_APPLE = 820,
    ITEM_UNREMARKABLE_TEACUP = 821,
    ITEM_MASTERPIECE_TEACUP = 822,
    ITEM_CORNERSTONE_MASK = 823,
    ITEM_WELLSPRING_MASK = 824,
    ITEM_HEARTHFLAME_MASK = 825,
    ITEM_HEALTH_MOCHI = 826,
    ITEM_MUSCLE_MOCHI = 827,
    ITEM_RESIST_MOCHI = 828,
    ITEM_GENIUS_MOCHI = 829,
    ITEM_CLEVER_MOCHI = 830,
    ITEM_SWIFT_MOCHI = 831,
    ITEM_FRESH_START_MOCHI = 832,
    ITEM_GLIMMERING_CHARM = 833,
    ITEM_METAL_ALLOY = 834,
    ITEM_STELLAR_TERA_SHARD = 835,

    ITEM_POKEVIAL = 836, // Pokevial Branch

    ITEM_JUBILIFE_MUFFIN = 837,
    ITEM_REMEDY = 838,
    ITEM_FINE_REMEDY = 839,
    ITEM_SUPERB_REMEDY = 840,
    ITEM_AUX_EVASION = 841,
    ITEM_AUX_GUARD = 842,
    ITEM_AUX_POWER = 843,
    ITEM_AUX_POWERGUARD = 844,
    ITEM_CHOICE_DUMPLING = 845,
    ITEM_SWAP_SNACK = 846,
    ITEM_TWICE_SPICED_RADISH = 847,
    ITEM_POKESHI_DOLL = 848,

    ITEM_STRANGE_BALL = 849,

    ITEM_SHINY_LURE = 850,
    ITEM_INFINIREPEL = 851,

    // Legends Z-A Mega Stones
    ITEM_CLEFABLITE = 852,
    ITEM_VICTREEBELITE = 853,
    ITEM_STARMINITE = 854,
    ITEM_DRAGONINITE = 855,
    ITEM_MEGANIUMITE = 856,
    ITEM_FERALIGITE = 857,
    ITEM_SKARMORITE = 858,
    ITEM_FROSLASSITE = 859,
    ITEM_EMBOARITE = 860,
    ITEM_EXCADRITE = 861,
    ITEM_SCOLIPITE = 862,
    ITEM_SCRAFTINITE = 863,
    ITEM_EELEKTROSSITE = 864,
    ITEM_CHANDELURITE = 865,
    ITEM_CHESNAUGHTITE = 866,
    ITEM_DELPHOXITE = 867,
    ITEM_GRENINJITE = 868,
    ITEM_PYROARITE = 869,
    ITEM_FLOETTITE = 870,
    ITEM_MALAMARITE = 871,
    ITEM_BARBARACITE = 872,
    ITEM_DRAGALGITE = 873,
    ITEM_HAWLUCHANITE = 874,
    ITEM_ZYGARDITE = 875,
    ITEM_DRAMPANITE = 876,
    ITEM_FALINKSITE = 877,
    ...
    ITEM_DARKRANITE = 879,
    ITEM_ZERAORITE = 880,
    ITEM_RAICHUNITE_X = 881,
    ITEM_RAICHUNITE_Y = 882,
    ITEM_CHIMECHITE = 883,
    ITEM_ABSOLITE_Z = 884,
    ITEM_STARAPTITE = 885,
    ITEM_GARCHOMPITE_Z = 886,
    ITEM_LUCARIONITE_Z = 887,
    ITEM_GOLURKITE = 888,
    ITEM_MEOWSTICITE = 889,
    ITEM_CRABOMINITE = 890,
    ITEM_GOLISOPITE = 891,
    ITEM_MAGEARNITE = 892,
    ITEM_SCOVILLAINITE = 893,
    ITEM_BAXCALIBRITE = 894,
    ITEM_TATSUGIRINITE = 895,
    ITEM_GLIMMORANITE = 896,
    ITEM_WHETSTONE = 897,
    ITEM_WRIST_WEIGHTS = 898,
