...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_ROCKET] = { _("Team Rocket") },
    [TRAINER_CLASS_HIKER] = { _("Hiker"), 6, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_ULTRA : BALL_POKE },
    ...
    [TRAINER_CLASS_BIRD_KEEPER] = { _("Bird Keeper"), 5 },
    [TRAINER_CLASS_COLLECTOR] = { _("Collector"), 12, BALL_PREMIER },
    [TRAINER_CLASS_SWIMMER_M] = { _("Swimmer♂"), 2, BALL_DIVE },
    [TRAINER_CLASS_TEAM_MAGMA] = { _("Team Magma") },
    [TRAINER_CLASS_EXPERT] = { _("Expert"), 10, BALL_TIMER },
    [TRAINER_CLASS_AQUA_ADMIN] = { _("Aqua Admin"), 10, BALL_ULTRA },
    ...
    [TRAINER_CLASS_AROMA_LADY] = { _("Aroma Lady"), 6, BALL_LOVE },
    ...
    [TRAINER_CLASS_POKEMANIAC] = { _("Pokémaniac"), 15, BALL_CHERISH },
    [TRAINER_CLASS_GUITARIST] = { _("Guitarist"), 5 },
    [TRAINER_CLASS_KINDLER] = { _("Kindler"), 6 },
    ...
    [TRAINER_CLASS_TRIATHLETE] = { _("Triathlete"), 10, BALL_SPORT },
    ...
    [TRAINER_CLASS_TWINS] = { _("Twins"), 3, BALL_REPEAT },
    [TRAINER_CLASS_SAILOR] = { _("Sailor"), 6, BALL_LURE },
    [TRAINER_CLASS_WILD] = { _("Wild"), 1, BALL_PARK },
    [TRAINER_CLASS_MAGMA_ADMIN] = { _("Magma Admin"), 10, BALL_ULTRA },
    [TRAINER_CLASS_RIVAL] = { _("{PKMN} Trainer"), 15 },
    [TRAINER_CLASS_BUG_CATCHER] = { _("Bug Catcher"), 3, BALL_NET },
    [TRAINER_CLASS_PKMN_RANGER] = { _("{PKMN} Ranger"), 12, BALL_SAFARI },
    [TRAINER_CLASS_MAGMA_LEADER] = { _("Magma Leader"), 20, BALL_MASTER },
    [TRAINER_CLASS_LASS] = { _("Lass"), 4 },
    [TRAINER_CLASS_YOUNG_COUPLE] = { _("Young Couple"), 8, BALL_QUICK },
    [TRAINER_CLASS_OLD_COUPLE] = { _("Old Couple"), 10, BALL_TIMER },
    [TRAINER_CLASS_SIS_AND_BRO] = { _("Sis and Bro"), 3 },
    [TRAINER_CLASS_SKIER] = { _("Skier"), 4 },
    ...
    [TRAINER_CLASS_BOSS] = { _("Boss"), 15, BALL_MASTER },
                                                                        ...
                                                                        | BATTLE_TYPE_TRAINER_HILL)))
    {
        ...
        for (s32 i = 0; i < monsCount; i++)
        {
            ...
            if (gSaveBlock2Ptr->optionsLevelSync) { // Checks if the level sync option is set
                ...
                {
                    CreateMon(&party[i], partyData[monIndex].species, lvl + 3, personalityValue, otId);
                }
                else // If no trainer level flag is set, scales to level - 2
                {
                    CreateMon(&party[i], partyData[monIndex].species, lvl - 2, personalityValue, otId);
                }
            }
            ...
            {                                            // It sets levels to the normally assigned trainer levels during first run, then +10 after completing the game once
                ...
                CreateMon(&party[i], partyData[monIndex].species, 55 + i + VarGet(VAR_ELITE_4_STATE) + gameClearLevelBoost,personalityValue, otId);
            }
            else
            {
            ...
            if (!IsBattleControllerActiveOrPendingSyncAnywhere(battler))
            {
                    ...
                    && gBattleResources->bufferB[battler][1] == B_ACTION_RUN)
                {
                    ...
                    return;
                         ...
                         && gBattleResources->bufferB[battler][1] == B_ACTION_RUN)
                {
                    BattleScriptExecute(BattleScript_PrintCantRunFromBattle);
                    gBattleCommunication[battler] = STATE_BEFORE_ACTION_CHOSEN;
                    return;
                }
...
static void HandleEndTurn_BattleWon(void)
{
            ...
            && gBattleTypeFlags & (BATTLE_TYPE_FRONTIER | BATTLE_TYPE_TRAINER_HILL | BATTLE_TYPE_EREADER_TRAINER))
    {
        ...
        if (!FlagGet(FLAG_DONT_PLAY_VICTORY_MUSIC))
        {
    ...
    FlagClear(FLAG_DONT_PLAY_VICTORY_MUSIC);
