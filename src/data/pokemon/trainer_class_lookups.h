const u16 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_JAKSON] = TRAINER_PIC_JAKSON,
    [FACILITY_CLASS_HARPER] = TRAINER_PIC_HARPER,
    [FACILITY_CLASS_REDD] = TRAINER_PIC_REDD,
    [FACILITY_CLASS_SAKURA] = TRAINER_PIC_SAKURA,
    [FACILITY_CLASS_BARON] = TRAINER_PIC_BARON,
};
