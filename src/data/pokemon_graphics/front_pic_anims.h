...
#endif //P_GIGANTAMAX_FORMS
PLACEHOLDER_ANIM_SINGLE_FRAME(CharizardEmeribian);
...
PLACEHOLDER_ANIM_SINGLE_FRAME(FearowMega);
...
PLACEHOLDER_ANIM_SINGLE_FRAME(NidoqueenMega);
...
PLACEHOLDER_ANIM_SINGLE_FRAME(NidokingMega);
...
#endif //P_ALOLAN_FORMS
PLACEHOLDER_ANIM_SINGLE_FRAME(NinetalesEmeribian);
...
PLACEHOLDER_ANIM_SINGLE_FRAME(WigglytuffMega);
...
#endif //P_GEN_2_CROSS_EVOS
PLACEHOLDER_ANIM_SINGLE_FRAME(OddishEmeribian);
PLACEHOLDER_ANIM_SINGLE_FRAME(GloomEmeribian);
PLACEHOLDER_ANIM_SINGLE_FRAME(VileplumeEmeribian);
PLACEHOLDER_ANIM_SINGLE_FRAME(BellossomEmeribian);
...
#endif //P_ALOLAN_FORMS
PLACEHOLDER_ANIM_SINGLE_FRAME(GolemFribian);
...
PLACEHOLDER_ANIM_SINGLE_FRAME(RapidashMega);
...
PLACEHOLDER_ANIM_SINGLE_FRAME(CloysterFribian);
...
PLACEHOLDER_ANIM_SINGLE_FRAME(Tangtrip);
#endif //P_GEN_4_CROSS_EVOS
...
PLACEHOLDER_ANIM_SINGLE_FRAME(ElectivireMega);
#endif //P_GEN_4_CROSS_EVOS
...
PLACEHOLDER_ANIM_SINGLE_FRAME(MagmortarMega);
#endif //P_GEN_4_CROSS_EVOS
...
static const union AnimCmd sAnim_MeganiumEmeribian_1[] =
{
    ANIMCMD_FRAME(1, 40),
    ANIMCMD_FRAME(0, 5),
    ANIMCMD_END,
...
static const union AnimCmd sAnim_TyphlosionEmeribian_1[] =
{
    ANIMCMD_FRAME(1, 40),
    ANIMCMD_FRAME(0, 5),
    ANIMCMD_END,
...
static const union AnimCmd sAnim_FeraligatrEmeribian_1[] =
{
    ANIMCMD_FRAME(1, 10),
    ANIMCMD_FRAME(0, 10),
    ANIMCMD_FRAME(1, 25),
...
PLACEHOLDER_ANIM_SINGLE_FRAME(NoctowlEmeribian);
...
PLACEHOLDER_ANIM_SINGLE_FRAME(SpinarakEmeribian);
PLACEHOLDER_ANIM_SINGLE_FRAME(AriadosEmeribian);
...
PLACEHOLDER_ANIM_SINGLE_FRAME(DudunsparceMega);
#endif //P_GEN_9_CROSS_EVOS
...
PLACEHOLDER_ANIM_SINGLE_FRAME(ShuckleFribian);
...
static const union AnimCmd sAnim_Sludgma_1[] =
{
    ANIMCMD_FRAME(0, 10),
    ANIMCMD_FRAME(1, 10),
    ANIMCMD_FRAME(0, 10),
...
static const union AnimCmd sAnim_Mudcargo_1[] =
{
    ANIMCMD_FRAME(0, 10),
    ANIMCMD_FRAME(1, 10),
    ANIMCMD_FRAME(0, 10),
...
PLACEHOLDER_ANIM_SINGLE_FRAME(MagcargoEmeribian);
...
PLACEHOLDER_ANIM_SINGLE_FRAME(OctilleryFribian);
...
PLACEHOLDER_ANIM_SINGLE_FRAME(SkarmoryFribian);
...
PLACEHOLDER_ANIM_SINGLE_FRAME(HoOhMega);
...
static const union AnimCmd sAnim_MightyenaEmeribian_1[] =
{
    ANIMCMD_FRAME(0, 27),
    ANIMCMD_FRAME(1, 6),
    ANIMCMD_FRAME(0, 6),
...
PLACEHOLDER_ANIM_SINGLE_FRAME(GardevoirMegaQ);
#endif //P_MEGA_EVOLUTIONS
...
PLACEHOLDER_ANIM_SINGLE_FRAME(GalladeMegaQ);
#endif //P_MEGA_EVOLUTIONS
#endif //P_GEN_4_CROSS_EVOS

PLACEHOLDER_ANIM_SINGLE_FRAME(RaltsEmeribian);
PLACEHOLDER_ANIM_SINGLE_FRAME(KirliaEmeribian);
PLACEHOLDER_ANIM_SINGLE_FRAME(GardevoirEmeribian);
PLACEHOLDER_ANIM_SINGLE_FRAME(GardevoirEmeribianMega);
...
PLACEHOLDER_ANIM_SINGLE_FRAME(BreloomFribian);
...
PLACEHOLDER_ANIM_SINGLE_FRAME(ExploudMega);
...
PLACEHOLDER_ANIM_SINGLE_FRAME(CrawdauntMega);
...
PLACEHOLDER_ANIM_SINGLE_FRAME(MiloticMegaE);
...
PLACEHOLDER_ANIM_SINGLE_FRAME(EmpoleonMega);
...
static const union AnimCmd sAnim_ShinxEmeribian_1[] =
{
    ANIMCMD_FRAME(0, 20),
    ANIMCMD_FRAME(1, 10),
    ANIMCMD_FRAME(0, 10),
...
static const union AnimCmd sAnim_LuxioEmeribian_1[] =
{
    ANIMCMD_FRAME(1, 40),
    ANIMCMD_FRAME(0, 20),
    ANIMCMD_END,
...
static const union AnimCmd sAnim_LuxrayEmeribian_1[] =
{
    ANIMCMD_FRAME(0, 15),
    ANIMCMD_FRAME(1, 20),
    ANIMCMD_FRAME(0, 15),
...
PLACEHOLDER_ANIM_SINGLE_FRAME(VespiquenMega);
...
PLACEHOLDER_ANIM_SINGLE_FRAME(DrifloonEmeribian);
PLACEHOLDER_ANIM_SINGLE_FRAME(DrifblimEmeribian);
...
PLACEHOLDER_ANIM_SINGLE_FRAME(LumineonMega);
...
PLACEHOLDER_ANIM_SINGLE_FRAME(SerperiorMega);
...
PLACEHOLDER_ANIM_SINGLE_FRAME(GigalithFribian);
...
PLACEHOLDER_ANIM_SINGLE_FRAME(KlinklangMega);
...
PLACEHOLDER_ANIM_SINGLE_FRAME(HaxorusMega);
#endif //P_FAMILY_AXEW
...
PLACEHOLDER_ANIM_SINGLE_FRAME(HydreigonMega);
...
PLACEHOLDER_ANIM_SINGLE_FRAME(SkiddoEmeribian);
PLACEHOLDER_ANIM_SINGLE_FRAME(GogoatEmeribian);
...
PLACEHOLDER_ANIM_SINGLE_FRAME(HonedgeEmeribian);
PLACEHOLDER_ANIM_SINGLE_FRAME(DoubladeEmeribian);
PLACEHOLDER_ANIM_SINGLE_FRAME(AegislashEmeribian);
...
PLACEHOLDER_ANIM_SINGLE_FRAME(SlurpuffMega);
...
PLACEHOLDER_ANIM_SINGLE_FRAME(AurorusMega);
...
PLACEHOLDER_ANIM_SINGLE_FRAME(TrevenantEmeribian);
...
PLACEHOLDER_ANIM_SINGLE_FRAME(TsareenaMega);
...
PLACEHOLDER_ANIM_SINGLE_FRAME(MimikyuEmeribian);
...
PLACEHOLDER_ANIM_SINGLE_FRAME(WoolooFribian);
PLACEHOLDER_ANIM_SINGLE_FRAME(DubwoolFribian);
...
PLACEHOLDER_ANIM_SINGLE_FRAME(FalinksEmeribian);
...
PLACEHOLDER_ANIM_SINGLE_FRAME(Arsellosky);
PLACEHOLDER_ANIM_SINGLE_FRAME(Evaleon);
PLACEHOLDER_ANIM_SINGLE_FRAME(Aereon);
PLACEHOLDER_ANIM_SINGLE_FRAME(Contageon);
...
PLACEHOLDER_ANIM_SINGLE_FRAME(Raitora);

PLACEHOLDER_ANIM_SINGLE_FRAME(Madame);
PLACEHOLDER_ANIM_SINGLE_FRAME(Apimarill);
PLACEHOLDER_ANIM_SINGLE_FRAME(Solflora);
PLACEHOLDER_ANIM_SINGLE_FRAME(Shibirefugu);
...
#endif //P_GIGANTAMAX_FORMS
SINGLE_ANIMATION(CharizardEmeribian);
#endif //P_FAMILY_CHARMANDER
#if P_FAMILY_SQUIRTLE
...
#endif //P_ALOLAN_FORMS
SINGLE_ANIMATION(NinetalesEmeribian);
#endif //P_FAMILY_VULPIX
#if P_FAMILY_JIGGLYPUFF
#if P_GEN_2_CROSS_EVOS
...
SINGLE_ANIMATION(WigglytuffMega);
#endif //P_FAMILY_JIGGLYPUFF
#if P_FAMILY_ZUBAT
...
#endif //P_GEN_2_CROSS_EVOS
SINGLE_ANIMATION(OddishEmeribian);
SINGLE_ANIMATION(GloomEmeribian);
SINGLE_ANIMATION(VileplumeEmeribian);
SINGLE_ANIMATION(BellossomEmeribian);
#endif //P_FAMILY_ODDISH
#if P_FAMILY_PARAS
...
SINGLE_ANIMATION(CloysterFribian);
#endif //P_FAMILY_SHELLDER
#if P_FAMILY_GASTLY
...
SINGLE_ANIMATION(ElectivireMega);
#endif //P_GEN_4_CROSS_EVOS
#endif //P_FAMILY_ELECTABUZZ
#if P_FAMILY_MAGMAR
#if P_GEN_2_CROSS_EVOS
...
SINGLE_ANIMATION(MagmortarMega);
#endif //P_GEN_4_CROSS_EVOS
#endif //P_FAMILY_MAGMAR
#if P_FAMILY_PINSIR
...
SINGLE_ANIMATION(MeganiumEmeribian);
#endif //P_FAMILY_CHIKORITA
#if P_FAMILY_CYNDAQUIL
...
SINGLE_ANIMATION(NoctowlEmeribian);
#endif //P_FAMILY_HOOTHOOT
#if P_FAMILY_LEDYBA
...
SINGLE_ANIMATION(SpinarakEmeribian);
SINGLE_ANIMATION(AriadosEmeribian);
#endif //P_FAMILY_SPINARAK
#if P_FAMILY_CHINCHOU
...
SINGLE_ANIMATION(DudunsparceMega);
#endif //P_GEN_9_CROSS_EVOS
#endif //P_FAMILY_DUNSPARCE
#if P_FAMILY_GLIGAR
...
SINGLE_ANIMATION(ShuckleFribian);
#endif //P_FAMILY_SHUCKLE
#if P_FAMILY_HERACROSS
...
SINGLE_ANIMATION(MagcargoEmeribian);
SINGLE_ANIMATION(Sludgma);
SINGLE_ANIMATION(Mudcargo);
#endif //P_FAMILY_SLUGMA
#if P_FAMILY_SWINUB
...
SINGLE_ANIMATION(OctilleryFribian);
#endif //P_FAMILY_REMORAID
#if P_FAMILY_DELIBIRD
...
SINGLE_ANIMATION(SkarmoryFribian);
#endif //P_FAMILY_SKARMORY
#if P_FAMILY_HOUNDOUR
...
SINGLE_ANIMATION(MightyenaEmeribian);
#endif //P_FAMILY_POOCHYENA
#if P_FAMILY_ZIGZAGOON
...
SINGLE_ANIMATION(GardevoirMegaQ);
#endif //P_MEGA_EVOLUTIONS
#if P_GEN_4_CROSS_EVOS
SINGLE_ANIMATION(Gallade);
#if P_MEGA_EVOLUTIONS
SINGLE_ANIMATION(GalladeMega);
SINGLE_ANIMATION(GalladeMegaQ);
#endif //P_MEGA_EVOLUTIONS
#endif //P_GEN_4_CROSS_EVOS
SINGLE_ANIMATION(RaltsEmeribian);
SINGLE_ANIMATION(KirliaEmeribian);
SINGLE_ANIMATION(GardevoirEmeribian);
#if P_MEGA_EVOLUTIONS
SINGLE_ANIMATION(GardevoirEmeribianMega);
#endif //P_MEGA_EVOLUTIONS
#endif //P_FAMILY_RALTS
#if P_FAMILY_SURSKIT
...
SINGLE_ANIMATION(BreloomFribian);
#endif //P_FAMILY_SHROOMISH
#if P_FAMILY_SLAKOTH
...
SINGLE_ANIMATION(CrawdauntMega);
#endif //P_FAMILY_CORPHISH
#if P_FAMILY_BALTOY
...
SINGLE_ANIMATION(ShinxEmeribian);
SINGLE_ANIMATION(LuxioEmeribian);
SINGLE_ANIMATION(LuxrayEmeribian);
#endif //P_FAMILY_SHINX
#if P_FAMILY_CRANIDOS
...
SINGLE_ANIMATION(VespiquenMega);
#endif //P_FAMILY_COMBEE
#if P_FAMILY_PACHIRISU
...
SINGLE_ANIMATION(DrifloonEmeribian);
SINGLE_ANIMATION(DrifblimEmeribian);
#endif //P_FAMILY_DRIFLOON
#if P_FAMILY_BUNEARY
...
SINGLE_ANIMATION(SerperiorMega);
#endif //P_FAMILY_SNIVY
#if P_FAMILY_TEPIG
...
SINGLE_ANIMATION(GigalithFribian);
#endif //P_FAMILY_ROGGENROLA
#if P_FAMILY_WOOBAT
...
SINGLE_ANIMATION(KlinklangMega);
#endif //P_FAMILY_KLINK
#if P_FAMILY_TYNAMO
...
SINGLE_ANIMATION(HydreigonMega);
#endif //P_FAMILY_DEINO
#if P_FAMILY_LARVESTA
...
SINGLE_ANIMATION(SkiddoEmeribian);
SINGLE_ANIMATION(GogoatEmeribian);
#endif //P_FAMILY_SKIDDO
#if P_FAMILY_PANCHAM
...
SINGLE_ANIMATION(HonedgeEmeribian);
SINGLE_ANIMATION(DoubladeEmeribian);
SINGLE_ANIMATION(AegislashEmeribian);
#endif //P_FAMILY_HONEDGE
#if P_FAMILY_SPRITZEE
...
SINGLE_ANIMATION(TrevenantEmeribian);
#endif //P_FAMILY_PHANTUMP
#if P_FAMILY_PUMPKABOO
...
SINGLE_ANIMATION(MimikyuEmeribian);
#endif //P_FAMILY_MIMIKYU
#if P_FAMILY_BRUXISH
...
SINGLE_ANIMATION(WoolooFribian);
SINGLE_ANIMATION(DubwoolFribian);
#endif //P_FAMILY_WOOLOO
#if P_FAMILY_CHEWTLE
...
SINGLE_ANIMATION(FalinksEmeribian);
#endif //P_FAMILY_FALINKS
#if P_FAMILY_PINCURCHIN
...
SINGLE_ANIMATION(Arsellosky);
SINGLE_ANIMATION(Evaleon);
SINGLE_ANIMATION(Aereon);
SINGLE_ANIMATION(Contageon);
