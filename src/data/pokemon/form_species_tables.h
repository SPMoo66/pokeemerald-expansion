...
static const u16 sCrawdauntFormSpeciesIdTable[] = {
    SPECIES_CRAWDAUNT,
...
#if P_FAMILY_COMBEE
static const u16 sVespiquenFormSpeciesIdTable[] = {
    SPECIES_VESPIQUEN,
...
#if P_FAMILY_KLINK
static const u16 sKlinklangFormSpeciesIdTable[] = {
    SPECIES_KLINKLANG,
...
#if P_FAMILY_SKIDDO
static const u16 sSkiddoFormSpeciesIdTable[] = {
    SPECIES_SKIDDO,
    SPECIES_SKIDDO_EMERIBIAN,
    FORM_SPECIES_END,
};

static const u16 sGogoatFormSpeciesIdTable[] = {
    SPECIES_GOGOAT,
...
#if P_FAMILY_SWIRLIX
static const u16 sSlurpuffFormSpeciesIdTable[] = {
    SPECIES_SLURPUFF,
