...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_FIRSTDOWNROXANNE]                     = sText_FirstDownRoxanne,
    [STRINGID_FIRSTDOWNBRAWLY]                      = sText_FirstDownBrawly,
    [STRINGID_FIRSTDOWNWATTSON]                     = sText_FirstDownWattson,
    [STRINGID_FIRSTDOWNFLANNERY]                    = sText_FirstDownFlannery,
    [STRINGID_FIRSTDOWNNORMAN]                      = sText_FirstDownNorman,
    [STRINGID_FIRSTDOWNWINONA]                      = sText_FirstDownWinona,
    [STRINGID_FIRSTDOWNLIZATATE]                    = sText_FirstDownLizaTate,
    [STRINGID_FIRSTDOWNJUAN]                        = sText_FirstDownJuan,
    [STRINGID_FIRSTDOWNSIDNEY]                      = sText_FirstDownSidney,
    [STRINGID_FIRSTDOWNPHOEBE]                      = sText_FirstDownPhoebe,
    [STRINGID_FIRSTDOWNGLACIA]                      = sText_FirstDownGlacia,
    [STRINGID_FIRSTDOWNDRAKE]                       = sText_FirstDownDrake,
    [STRINGID_FIRSTDOWNWALLACE]                     = sText_FirstDownWallace,
    [STRINGID_LASTSWITCHROXANNE]                    = sText_LastSwitchRoxanne,
    [STRINGID_LASTSWITCHBRAWLY]                     = sText_LastSwitchBrawly,
    [STRINGID_LASTSWITCHWATTSON]                    = sText_LastSwitchWattson,
    [STRINGID_LASTSWITCHFLANNERY]                   = sText_LastSwitchFlannery,
    [STRINGID_LASTSWITCHNORMAN]                     = sText_LastSwitchNorman,
    [STRINGID_LASTSWITCHWINONA]                     = sText_LastSwitchWinona,
    [STRINGID_LASTSWITCHLIZATATE]                   = sText_LastSwitchLizaTate,
    [STRINGID_LASTSWITCHJUAN]                       = sText_LastSwitchJuan,
    [STRINGID_LASTSWITCHSIDNEY]                     = sText_LastSwitchSidney,
    [STRINGID_LASTSWITCHPHOEBE]                     = sText_LastSwitchPhoebe,
    [STRINGID_LASTSWITCHGLACIA]                     = sText_LastSwitchGlacia,
    [STRINGID_LASTSWITCHDRAKE]                      = sText_LastSwitchDrake,
    [STRINGID_LASTSWITCHWALLACE]                    = sText_LastSwitchWallace,
    [STRINGID_MEGALIZATATE]                         = sText_MegaLizaTate,
    [STRINGID_MEGAJUAN]                             = sText_MegaJuan,
    [STRINGID_MEGASIDNEY]                           = sText_MegaSidney,
    [STRINGID_MEGAPHOEBE]                           = sText_MegaPhoebe,
    [STRINGID_MEGAGLACIA]                           = sText_MegaGlacia,
    [STRINGID_MEGADRAKE]                            = sText_MegaDrake,
    [STRINGID_MEGAWALLACE]                          = sText_MegaWallace,
    [STRINGID_LASTHALFSIDNEY]                       = sText_LastHalfSidney,
    [STRINGID_LASTHALFPHOEBE]                       = sText_LastHalfPhoebe,
    [STRINGID_LASTHALFGLACIA]                       = sText_LastHalfGlacia,
    [STRINGID_LASTHALFDRAKE]                        = sText_LastHalfDrake,
    [STRINGID_LASTHALFWALLACE]                      = sText_LastHalfWallace,
    [STRINGID_BEFOREFIRSTTURNWALLACE]               = sText_BeforeFirstTurnWallace,
    [STRINGID_LASTSWITCHMAXIEMTCHIMNEY]             = sText_LastSwitchMaxieMtChimney,
    [STRINGID_LASTSWITCHMAXIEMAGMAHIDEOUT]          = sText_LastSwitchMaxieMagmaHideout,
    [STRINGID_LASTSWITCHMAXIEMOSSDEEP]              = sText_LastSwitchMaxieMossdeep,
    [STRINGID_LASTSWITCHARCHIE]                     = sText_LastSwitchArchie,
    [STRINGID_MEGAMAXIEMAGMAHIDEOUT]                = sText_MegaMaxieMagmaHideout,
    [STRINGID_MEGAARCHIE]                           = sText_MegaArchie,
    [STRINGID_MEGACRITICALHITMAXIE]                 = sText_CriticalHitMaxie,
    [STRINGID_MEGACRITICALHITARCHIE]                = sText_CriticalHitArchie,
    [STRINGID_LASTHALFMAXIEMOSSDEEP]                = sText_LastHalfMaxieMossdeep,
    [STRINGID_LASTHALFARCHIE]                       = sText_LastHalfArchie,
};
...
static const u8 sText_InGamePartnerReadyGoN[] = _("{B_PARTNER_NAME} is ready!\nGo, {B_PLAYER_MON1_NAME}!");
        ...
        if (GetBattlerSide(battler) == B_SIDE_PLAYER)
        {
            if (IsDoubleBattle() && IsValidForBattle(&gPlayerParty[gBattlerPartyIndexes[BATTLE_PARTNER(battler)]]))
            {
                if (gBattleTypeFlags & BATTLE_TYPE_INGAME_PARTNER)
					if (FlagGet(FLAG_WILD_PARTNER))
						stringPtr = sText_InGamePartnerReadyGoN;
					else
...
static const struct TrainerSlide sTrainerSlides[] =
{
    ...
    */
    ...
    },
    {
        ...
        .isFrontierTrainer = FALSE,
        .msgFirstDown = sText_FirstDownSidney,
		.msgMegaEvolution = sText_MegaSidney,
        .msgLastSwitchIn = sText_LastSwitchSidney,
        .msgLastHalfHp = sText_LastHalfSidney,
    },
    {
        .trainerId = TRAINER_PHOEBE,
        .isFrontierTrainer = FALSE,
        .msgFirstDown = sText_FirstDownPhoebe,
		.msgMegaEvolution = sText_MegaPhoebe,
        .msgLastSwitchIn = sText_LastSwitchPhoebe,
        .msgLastHalfHp = sText_LastHalfPhoebe,
    },
    {
        .trainerId = TRAINER_GLACIA,
        .isFrontierTrainer = FALSE,
        .msgFirstDown = sText_FirstDownGlacia,
		.msgMegaEvolution = sText_MegaGlacia,
        .msgLastSwitchIn = sText_LastSwitchGlacia,
        .msgLastHalfHp = sText_LastHalfGlacia,
    },
    {
        .trainerId = TRAINER_DRAKE,
        .isFrontierTrainer = FALSE,
        .msgFirstDown = sText_FirstDownDrake,
		.msgMegaEvolution = sText_MegaDrake,
        .msgLastSwitchIn = sText_LastSwitchDrake,
        .msgLastHalfHp = sText_LastHalfDrake,
    },
    {
        .trainerId = TRAINER_WALLACE,
        .isFrontierTrainer = FALSE,
        .msgBeforeFirstTurn = sText_BeforeFirstTurnWallace,
        .msgFirstDown = sText_FirstDownWallace,
		.msgMegaEvolution = sText_MegaWallace,
        .msgLastSwitchIn = sText_LastSwitchWallace,
        .msgLastHalfHp = sText_LastHalfWallace,
    },
    {
