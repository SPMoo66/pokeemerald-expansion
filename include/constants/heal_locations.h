...
enum {
    ...
    HEAL_LOCATION_MAUVE_CAMP,
    HEAL_LOCATION_ILLUSORY_GROTTO_LOWER,
    HEAL_LOCATION_ILLUSORY_GROTTO_UPPER,
    ...
    HEAL_LOCATION_SS_TIDAL_DUNGEON_1F_1R,
    HEAL_LOCATION_SUBMERGED_CAVE_1F_3R,
    NUM_HEAL_LOCATIONS
};
