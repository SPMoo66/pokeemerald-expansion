...
const u8 gText_MatchCallJakson_Strategy[] = _("");
const u8 gText_MatchCallJakson_Pokemon[] = _("");
const u8 gText_MatchCallJakson_Intro1[] = _("");
const u8 gText_MatchCallJakson_Intro2[] = _("");
const u8 gText_MatchCallHarper_Strategy[] = _("");
const u8 gText_MatchCallHarper_Pokemon[] = _("");
const u8 gText_MatchCallHarper_Intro1[] = _("");
const u8 gText_MatchCallHarper_Intro2[] = _("");
const u8 gText_MatchCallRedd_Strategy[] = _("");
const u8 gText_MatchCallRedd_Pokemon[] = _("");
const u8 gText_MatchCallRedd_Intro1[] = _("");
const u8 gText_MatchCallRedd_Intro2[] = _("");
const u8 gText_MatchCallSakura_Strategy[] = _("");
const u8 gText_MatchCallSakura_Pokemon[] = _("");
const u8 gText_MatchCallSakura_Intro1[] = _("");
const u8 gText_MatchCallSakura_Intro2[] = _("");
const u8 gText_MatchCallBaron_Strategy[] = _("");
const u8 gText_MatchCallBaron_Pokemon[] = _("");
const u8 gText_MatchCallBaron_Intro1[] = _("");
const u8 gText_MatchCallBaron_Intro2[] = _("");
