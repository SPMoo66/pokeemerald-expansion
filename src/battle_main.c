...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    TRAINER_CLASS(BIRD_KEEPER, "Bird Keeper", 5),
    TRAINER_CLASS(COLLECTOR, "Collector", 12, ITEM_PREMIER_BALL),
    TRAINER_CLASS(SWIMMER_M, "Swimmer♂", 2, ITEM_DIVE_BALL),
    TRAINER_CLASS(TEAM_MAGMA, "Team Magma"),
    TRAINER_CLASS(EXPERT, "Expert", 10, ITEM_TIMER_BALL),
    TRAINER_CLASS(AQUA_ADMIN, "Aqua Admin", 10, ITEM_ULTRA_BALL),
    ...
    TRAINER_CLASS(AROMA_LADY, "Aroma Lady", 6, ITEM_LOVE_BALL),
    TRAINER_CLASS(RUIN_MANIAC, "Ruin Maniac", 10),
    TRAINER_CLASS(INTERVIEWER, "Interviewer", 10),
    ...
    TRAINER_CLASS(POKEMANIAC, "Pokémaniac", 15, ITEM_CHERISH_BALL),
    TRAINER_CLASS(GUITARIST, "Guitarist", 5),
    TRAINER_CLASS(KINDLER, "Kindler", 6),
    TRAINER_CLASS(CAMPER, "Camper", 4),
    TRAINER_CLASS(PICNICKER, "Picnicker", 4),
    TRAINER_CLASS(BUG_MANIAC, "Bug Maniac", 12, ITEM_NET_BALL),
    TRAINER_CLASS(PSYCHIC, "Psychic", 6, ITEM_MOON_BALL),
    ...
    TRAINER_CLASS(POKEFAN, "Pokéfan", 15),
    ...
    TRAINER_CLASS(TRIATHLETE, "Triathlete", 10, ITEM_SPORT_BALL),
    TRAINER_CLASS(DRAGON_TAMER, "Dragon Tamer", 12),
    TRAINER_CLASS(NINJA_BOY, "Ninja Boy", 3),
    TRAINER_CLASS(BATTLE_GIRL, "Battle Girl", 6),
    TRAINER_CLASS(PARASOL_LADY, "Parasol Lady", 8),
    TRAINER_CLASS(SWIMMER_F, "Swimmer♀", 2, ITEM_DIVE_BALL),
    TRAINER_CLASS(TWINS, "Twins", 3, ITEM_REPEAT_BALL),
    TRAINER_CLASS(SAILOR, "Sailor", 6, ITEM_LURE_BALL),
    TRAINER_CLASS(WILD, "Wild", 1, ITEM_PARK_BALL),
    TRAINER_CLASS(MAGMA_ADMIN, "Magma Admin", 10, ITEM_ULTRA_BALL),
    TRAINER_CLASS(RIVAL, "{PKMN} Trainer", 15),
    TRAINER_CLASS(BUG_CATCHER, "Bug Catcher", 3, ITEM_NET_BALL),
    TRAINER_CLASS(PKMN_RANGER, "{PKMN} Ranger", 12, ITEM_SAFARI_BALL),
    TRAINER_CLASS(MAGMA_LEADER, "Magma Leader", 20, ITEM_MASTER_BALL),
    TRAINER_CLASS(LASS, "Lass", 4),
    TRAINER_CLASS(YOUNG_COUPLE, "Young Couple", 8, ITEM_QUICK_BALL),
    TRAINER_CLASS(OLD_COUPLE, "Old Couple", 8, ITEM_TIMER_BALL),
    TRAINER_CLASS(SIS_AND_BRO, "Sis and Bro", 3),
    TRAINER_CLASS(SKIER, "Skier", 4),
    ...
    TRAINER_CLASS(BOSS, "Boss", 15, ITEM_MASTER_BALL),
};
