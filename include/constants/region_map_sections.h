...
enum {
    ...
    MAPSEC_SECRET_BASE,
    MAPSEC_DYNAMIC,
    MAPSEC_LEAFY_CLEARING,
    MAPSEC_CAVE_OF_DREAMS,
    MAPSEC_WOODLAND_CRADLE,
    MAPSEC_SEASIDE_GROTTO,
    MAPSEC_REALMS_FRAY,
    MAPSEC_SUBMERGED_CAVERN,
    MAPSEC_TRACKLESS_FOREST,
    MAPSEC_NAMELESS_CAVERN,
    MAPSEC_CRESCENT_ISLE,
    MAPSEC_PATHLESS_PLAIN,
    MAPSEC_FLORAL_PARADISE,
    MAPSEC_GNARLED_DEN,
    MAPSEC_FABLED_CAVE,
    MAPSEC_FLURRY_PEAK,
    MAPSEC_DRAKES_SANCTUM,
    MAPSEC_SEA_SPIRITS_DEN,
    MAPSEC_MYSTERY,
    MAPSEC_GALEFORCE_CLIFF,
    MAPSEC_SEASIDE_HOLLOW,
    MAPSEC_INFERNAL_DRYLANDS,
    MAPSEC_ROCKET_REFUGE,
    MAPSEC_OVERGROWN_JUNGLE,
    MAPSEC_MAUVE_CAMP,
    MAPSEC_MAUVE_ISLAND_SOUTH,
    MAPSEC_MAUVE_ISLAND_WEST,
    MAPSEC_FAR_OFF_SEA_WEST,
    MAPSEC_FAR_OFF_SEA_WEST_2,
    MAPSEC_FAR_OFF_SEA_SOUTH,
    MAPSEC_ILLUSORY_GROTTO,
    MAPSEC_FAR_OFF_SEA_WEST_2_UNDERWATER_1,
    MAPSEC_FAR_OFF_SEA_WEST_2_UNDERWATER_2,
    MAPSEC_FAR_OFF_SEA_WEST_UNDERWATER_1,
    MAPSEC_MAUVE_ISLAND_SOUTHEAST,
    MAPSEC_MAUVE_ISLAND_SOUTH_UNDERWATER,
    MAPSEC_FAR_OFF_SEA_SOUTH_UNDERWATER,
    MAPSEC_SS_TIDAL_DUNGEON,
    MAPSEC_BLANCHED_DEPTHS,
    MAPSEC_MAUVE_HOLLOW,
    MAPSEC_WELLSPRING_CHASM,
    MAPSEC_BYGONE_VAULT,
    MAPSEC_SUBMERGED_CAVE,
    MAPSEC_TEMPORAL_SPIRE,
    MAPSEC_PALLET_TOWN,
...
#define EXPANSION_1_MAPSEC_START  MAPSEC_MAUVE_CAMP
#define EXPANSION_1_MAPSEC_END    MAPSEC_SUBMERGED_CAVE
#define EXPANSION_1_MAPSEC_COUNT (EXPANSION_1_MAPSEC_END - EXPANSION_1_MAPSEC_START + 1)
