...
// Evolution Items
    ...
    [ITEM_DRAGON_SCALE] =
    {
        ...
        .price = (I_PRICE >= GEN_7) ? 2500 * TREASURE_FACTOR : 2100,
    ...
    [ITEM_PROTECTOR] =
    {
        ...
        .price = (I_PRICE >= GEN_7) ? 3000 * TREASURE_FACTOR : 2100,
        .description = COMPOUND_STRING(
            "Loved by a certain\n"
            "Pokémon. It's stiff\n"
            "and heavy."),
    ...
    [ITEM_PRISM_SCALE] =
    {
        ...
        .price = (I_PRICE >= GEN_9) ? 5000 : ((I_PRICE >= GEN_7) ? 2000 : 500),
        .description = COMPOUND_STRING(
            "A mysterious scale\n"
            "that evolves a\n"
            "certain Pokémon."),
...
// Mega Stones
    ...
    [ITEM_MEGA_STONE_X] =
    {
        .name = ITEM_NAME("Megalite X"),
        .pluralName = ITEM_PLURAL_NAME("Megalites X"),
        .price = 1000,
    ...
    [ITEM_MEGA_STONE_Y] =
    {
        .name = ITEM_NAME("Megalite Y"),
        .pluralName = ITEM_PLURAL_NAME("Megalites Y"),
        .price = 1000,
        .holdEffect = HOLD_EFFECT_MEGA_STONE,
    ...
    [ITEM_MEGA_STONE_G] =
    {
        .name = ITEM_NAME("Megalite G"),
        .pluralName = ITEM_PLURAL_NAME("Megalites G"),
        .price = 1000,
        .holdEffect = HOLD_EFFECT_MEGA_STONE,
    ...
    [ITEM_MEGA_STONE_LX] =
    {
        .name = ITEM_NAME("Megalite LX"),
        .pluralName = ITEM_PLURAL_NAME("Megalites LX"),
        .price = 1000,
        .holdEffect = HOLD_EFFECT_MEGA_STONE,
    ...
    [ITEM_MEGA_STONE_LY] =
    {
        .name = ITEM_NAME("Megalite LY"),
        .pluralName = ITEM_PLURAL_NAME("Megalites LY"),
        .price = 1000,
        .holdEffect = HOLD_EFFECT_MEGA_STONE,
    ...
    [ITEM_PIDGEOTITE] =
    {
        ...
        .price = 0,
        .holdEffect = HOLD_EFFECT_MEGA_STONE,
        .description = sMegaStoneUnusedDesc,
        .pocket = POCKET_ITEMS,
        .sortType = ITEM_TYPE_MEGA_STONE,
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_CannotUse,
...
// Misc. Held Items
    ...
    [ITEM_RAZOR_CLAW] =
    {
        ...
        .price = (I_PRICE >= GEN_9) ? 5000 : ((I_PRICE >= GEN_7) ? 5000 : 2100),
        .holdEffect = HOLD_EFFECT_SCOPE_LENS,
        .description = COMPOUND_STRING(
            "A hooked claw that\n"
            "ups the holder's\n"
