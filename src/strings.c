...
const u8 gText_UnkHeight[] = _("{CLEAR_TO 0x12}??'??”");
...
const u8 gText_YouWantedVar1ThatllBe_Cap[] = _("You wanted {STR_VAR_1}?\nThat'll be 1 Bottle Cap. Will that\lbe okay?");
...
const u8 gText_CountChallengeBalls[] = _("Challenge Balls Completed");
const u8 gText_NumPokeblocks[] = _("{STR_VAR_1}{COLOR DARK_GRAY}{SHADOW LIGHT_GRAY}");
const u8 gText_PokemonHeals[] = _("Times Fully Healed");
