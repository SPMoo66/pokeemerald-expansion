...
#define FLABEBE_MISC_INFO(Form, FORM, iconPal)                                        \
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 22, SPECIES_FLOETTE_ ##FORM})
...
#define FLORGES_MISC_INFO(Form, iconPal)                                              \
    ...
    [SPECIES_SKIDDO] =
    {
        ...
        .formSpeciesIdTable = sSkiddoFormSpeciesIdTable,
    ...
    [SPECIES_SKIDDO_EMERIBIAN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_FIELD, EGG_GROUP_FIELD },
        .abilities = { ABILITY_OVERGROW, ABILITY_HOSPITALITY, ABILITY_GRASS_PELT },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Skiddo"),
        .cryId = CRY_SKIDDO,
        .natDexNum = NATIONAL_DEX_SKIDDO,
        .categoryName = _("Tundra Kin"),
        .height = 9,
        .weight = 310,
        .description = COMPOUND_STRING(
            "Native to tundra with minimal food\n"
            "supplies, it can burrow a small hole to\n"
            "hide within and go weeks without new\n"
            "food styled sustenance."),
        .pokemonScale = 338,
        .pokemonOffset = 8,
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_SkiddoEmeribian,
        .frontPicSize = MON_COORDS_SIZE(48, 56),
        .frontPicYOffset = 2,
        .frontAnimFrames = sAnims_SkiddoEmeribian,
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .backPic = gMonBackPic_SkiddoEmeribian,
        .backPicSize = MON_COORDS_SIZE(56, 48),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_SMALL,
        .palette = gMonPalette_SkiddoEmeribian,
        ...
        .formSpeciesIdTable = sSkiddoFormSpeciesIdTable,
        .eggMoveLearnset = sSkiddoEmeribianEggMoveLearnset,
        .evolutions = EVOLUTION({EVO_LEVEL, 32, SPECIES_GOGOAT_EMERIBIAN}),
    },

    [SPECIES_GOGOAT_EMERIBIAN] =
    {
        .baseHP        = 123,
        .baseAttack    = 85,
        .baseDefense   = 95,
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_FIELD, EGG_GROUP_FIELD },
        .abilities = { ABILITY_OVERGROW, ABILITY_HOSPITALITY, ABILITY_STAMINA },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Gogoat"),
        .cryId = CRY_GOGOAT,
        .natDexNum = NATIONAL_DEX_GOGOAT,
        ...
        .trainerScale = 290,
        .trainerOffset = 1,
        .frontPic = gMonFrontPic_GogoatEmeribian,
        .frontPicSize = MON_COORDS_SIZE(56, 64),
        .frontPicYOffset = 2,
        .frontAnimFrames = sAnims_GogoatEmeribian,
        .frontAnimId = ANIM_V_STRETCH,
        .backPic = gMonBackPic_GogoatEmeribian,
        .backPicSize = MON_COORDS_SIZE(64, 56),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_DIP_RIGHT_SIDE,
        .palette = gMonPalette_GogoatEmeribian,
...
#define FURFROU_MISC_INFO(_form, _noFlip, frontWidth, frontYOffset, backWidth, backYOffset, _iconIdx)   \
    ...
    [SPECIES_ESPURR] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL_MALE, 30, SPECIES_MEOWSTIC_M},
                                {EVO_LEVEL_FEMALE, 30, SPECIES_MEOWSTIC_F}),
    },
    ...
    [SPECIES_DOUBLADE] =
    {
        ...
        .formSpeciesIdTable = sDoubladeFormSpeciesIdTable,
...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_HONEDGE_EMERIBIAN] =
    {
        ...
        .abilities = { ABILITY_NO_GUARD, ABILITY_SHADOW_SHIELD, ABILITY_STEELY_SPIRIT },
        .bodyColor = BODY_COLOR_BLACK,
        .speciesName = _("Honedge"),
        .cryId = CRY_HONEDGE,
        .natDexNum = NATIONAL_DEX_HONEDGE,
        .categoryName = _("Smithing"),
        .height = 8,
        .weight = 20,
        .description = COMPOUND_STRING(
            "One legend says it is the lingering\n"
            "will of a blacksmith still at their\n"
            "anvil, hammering away at a project\n"
            "not quite perfected yet."),
        .pokemonScale = 366,
        .pokemonOffset = 7,
        .trainerScale = 257,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_HonedgeEmeribian,
        .frontPicSize = MON_COORDS_SIZE(64, 56),
        .frontPicYOffset = 4,
        .frontAnimFrames = sAnims_HonedgeEmeribian,
        .frontAnimId = ANIM_SWING_CONVEX,
        .enemyMonElevation = 4,
        .backPic = gMonBackPic_HonedgeEmeribian,
        .backPicSize = MON_COORDS_SIZE(48, 56),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_V_SHAKE,
        .palette = gMonPalette_HonedgeEmeribian,
        ...
        .isEmeribianForm = TRUE,
        .formSpeciesIdTable = sHonedgeFormSpeciesIdTable,
        .eggMoveLearnset = sHonedgeEmeribianEggMoveLearnset,
        .evolutions = EVOLUTION({EVO_LEVEL, 25, SPECIES_DOUBLADE_EMERIBIAN}),
    },

    [SPECIES_DOUBLADE_EMERIBIAN] =
    {
        .baseHP        = 75,
        .baseAttack    = 110,
        .baseDefense   = 90,
        ...
        .weight = 45,
        .description = COMPOUND_STRING(
            "When its hammer strikes metal sparks fly\n"
            "that could burn most any target. With\n"
            "enough strikes, it can melt down the\n"
            "target in question to be recrafted."),
        .pokemonScale = 366,
        .pokemonOffset = 7,
        .trainerScale = 257,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_DoubladeEmeribian,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 5,
        .frontAnimFrames = sAnims_DoubladeEmeribian,
        .frontAnimId = ANIM_GROW_VIBRATE,
        .enemyMonElevation = 5,
        .backPic = gMonBackPic_DoubladeEmeribian,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_H_SHAKE,
        .palette = gMonPalette_DoubladeEmeribian,
        ...
        .isEmeribianForm = TRUE,
        .formSpeciesIdTable = sDoubladeFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_FIRE_STONE, SPECIES_AEGISLASH_EMERIBIAN}),
    },

    [SPECIES_AEGISLASH_EMERIBIAN] =
    {
        .baseHP        = 100,
        .baseAttack    = 120,
        .baseDefense   = 100,
        ...
        .trainerScale = 290,
        .trainerOffset = 1,
        .frontPic = gMonFrontPic_AegislashEmeribian,
        .frontPicSize = MON_COORDS_SIZE(56, 64),
        .frontPicYOffset = 1,
        .frontAnimFrames = sAnims_AegislashEmeribian,
        .frontAnimId = ANIM_H_VIBRATE,
        .backPic = gMonBackPic_AegislashEmeribian,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_H_VIBRATE,
        .palette = gMonPalette_AegislashEmeribian,
    ...
    [SPECIES_SLURPUFF] =
    {
        ...
        .formSpeciesIdTable = sSlurpuffFormSpeciesIdTable,
        .formChangeTable = sSlurpuffFormChangeTable,
    },

    [SPECIES_SLURPUFF_MEGA] =
    {
        .baseHP        = 82,
        .baseAttack    = 95,
        .baseDefense   = 106,
        ...
        .trainerScale = 257,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_SlurpuffMega,
        .frontPicSize = MON_COORDS_SIZE(48, 56),
        .frontPicYOffset = 2,
        .frontAnimFrames = sAnims_SlurpuffMega,
        .frontAnimId = ANIM_V_STRETCH,
        .backPic = gMonBackPic_SlurpuffMega,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 4,
        .backAnimId = BACK_ANIM_V_SHAKE_H_SLIDE,
        .palette = gMonPalette_SlurpuffMega,
    ...
    [SPECIES_SKRELP_EMERIBIAN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_GUTS, ABILITY_ADAPTABILITY, ABILITY_SKILL_LINK },
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = _("Skrelp"),
        .cryId = CRY_SKRELP,
        .natDexNum = NATIONAL_DEX_SKRELP,
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_SkrelpEmeribian,
        .frontPicSize = MON_COORDS_SIZE(40, 48),
        .frontPicYOffset = 8,
        .frontAnimFrames = sAnims_SkrelpEmeribian,
        .frontAnimId = ANIM_V_SLIDE_WOBBLE_SMALL,
        .backPic = gMonBackPic_SkrelpEmeribian,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_V_STRETCH,
        .palette = gMonPalette_SkrelpEmeribian,
        ...
        .isEmeribianForm = TRUE,
        .formSpeciesIdTable = sSkrelpFormSpeciesIdTable,
        .eggMoveLearnset = sSkrelpEmeribianEggMoveLearnset,
        .evolutions = EVOLUTION({EVO_LEVEL, 38, SPECIES_DRAGALGE_EMERIBIAN}),
    },
    ...
    [SPECIES_DRAGALGE_EMERIBIAN] =
    {
        ...
        .trainerScale = 286,
        .trainerOffset = 1,
        .frontPic = gMonFrontPic_DragalgeEmeribian,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = sAnims_DragalgeEmeribian,
        .frontAnimId = ANIM_FRONT_FLIP,
        .backPic = gMonBackPic_DragalgeEmeribian,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_H_STRETCH,
        .palette = gMonPalette_DragalgeEmeribian,
    ...
    [SPECIES_TYRUNT] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 32, SPECIES_TYRANTRUM}),
    },
    ...
    [SPECIES_GOOMY] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 30, SPECIES_SLIGGOO},
                                {EVO_LEVEL_TYPE_MON_IN_PARTY, 30, SPECIES_SLIGGOO_HISUI, TYPE_STEEL}),
    },
    ...
    [SPECIES_TREVENANT_EMERIBIAN] =
    {
        ...
        .abilities = { ABILITY_SNOW_CLOAK, ABILITY_ROUGH_SKIN, ABILITY_FLUFFY },
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("Trevenant"),
        .cryId = CRY_TREVENANT,
        .natDexNum = NATIONAL_DEX_TREVENANT,
        .categoryName = _("Jolly Tree"),
        .height = 15,
        .weight = 710,
        .description = COMPOUND_STRING(
            "Many police stations have a decorative\n"
            "wanted poster of this Pokémon for kids to\n"
            "see, where they are accused of stealing a\n"
            "famous non-denominational holiday."),
        .pokemonScale = 268,
        .pokemonOffset = 2,
        .trainerScale = 271,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_TrevenantEmeribian,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 5,
        .frontAnimFrames = sAnims_TrevenantEmeribian,
        .frontAnimId = ANIM_H_SLIDE_SLOW,
        .backPic = gMonBackPic_TrevenantEmeribian,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_V_SHAKE_LOW,
        .palette = gMonPalette_TrevenantEmeribian,
    ...
    [SPECIES_BERGMITE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 37, SPECIES_AVALUGG},
                                {EVO_ITEM, ITEM_KINGS_ROCK, SPECIES_AVALUGG_HISUI}),
    },
