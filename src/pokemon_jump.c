...
static const struct PokemonJumpMons sPokeJumpMons[] =
{
    ...
    { .species = SPECIES_TANGTRIP,                          .jumpType = JUMP_TYPE_NORMAL, },
    ...
    { .species = SPECIES_BUNEARY_EMERIBIAN,                 .jumpType = JUMP_TYPE_FAST, },
    ...
    { .species = SPECIES_ARSELLOSKY,                        .jumpType = JUMP_TYPE_SLOW, },
};
...
static void Msg_CommunicationStandby(void)
{
    ...
    case 0:
        ...
        AddTextPrinterParameterized(sPokemonJumpGfx->msgWindowId, FONT_NORMAL, gText_CommunicationStandby3, 0, 1, TEXT_SKIP_DRAW, NULL);
        CopyWindowToVram(sPokemonJumpGfx->msgWindowId, COPYWIN_GFX);
        sPokemonJumpGfx->mainState++;
        break;
    case 1:
