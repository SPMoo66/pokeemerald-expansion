...
const struct SpeciesInfo gSpeciesInfoGen9[] =
{
    ...
    [SPECIES_LECHONK] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL_MALE, 24, SPECIES_OINKOLOGNE_M},
                                {EVO_LEVEL_FEMALE, 24, SPECIES_OINKOLOGNE_F}),
    },
    ...
    [SPECIES_TANDEMAUS] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL_FAMILY_OF_FOUR, 28, SPECIES_MAUSHOLD_FOUR},
                                {EVO_LEVEL_FAMILY_OF_THREE, 28, SPECIES_MAUSHOLD_THREE}),
    },
