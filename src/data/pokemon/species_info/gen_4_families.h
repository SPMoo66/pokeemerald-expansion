...
const struct SpeciesInfo gSpeciesInfoGen4[] =
{
    ...
    [SPECIES_TURTWIG] =
    {
        ...
        .abilities = { ABILITY_OVERGROW, ABILITY_MOLD_BREAKER, ABILITY_SHELL_ARMOR },
    ...
    [SPECIES_CHIMCHAR] =
    {
        ...
        .abilities = { ABILITY_BLAZE, ABILITY_OBLIVIOUS, ABILITY_IRON_FIST },
    ...
    [SPECIES_PIPLUP] =
    {
        ...
        .abilities = { ABILITY_TORRENT, ABILITY_BATTLE_ARMOR, ABILITY_COMPETITIVE },
    #else
        .abilities = { ABILITY_TORRENT, ABILITY_BATTLE_ARMOR, ABILITY_DEFIANT },
    #endif
    ...
    [SPECIES_STARAPTOR] =
    {
        ...
        .baseSpeed     = 110,
        .baseSpAttack  = 50,
        .baseSpDefense = P_UPDATED_STATS >= GEN_6 ? 65 : 55,
        .types = MON_TYPES(TYPE_NORMAL, TYPE_FLYING),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 243,
    ...
    [SPECIES_STARAPTOR_MEGA] =
    {
        ...
        .baseSpeed     = 140,
        .baseSpAttack  = 60,
        .baseSpDefense = P_UPDATED_STATS >= GEN_6 ? 85 : 75,
    ...
    [SPECIES_KRICKETOT] =
    {
        ...
        .abilities = { ABILITY_SHED_SKIN, ABILITY_SHARPNESS, ABILITY_RUN_AWAY },
    ...
    [SPECIES_SHINX] =
    {
        ...
        .formSpeciesIdTable = sShinxFormSpeciesIdTable,
    ...
    [SPECIES_LUXRAY_MEGA] =
    {
        ...
        .abilities = { ABILITY_ELECTROMORPHOSIS, ABILITY_ELECTROMORPHOSIS, ABILITY_ELECTROMORPHOSIS },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Luxray"),
        .cryId = CRY_LUXRAY,
        .natDexNum = NATIONAL_DEX_LUXRAY,
    ...
    [SPECIES_SHINX_EMERIBIAN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_TELEPATHY, ABILITY_DEFIANT, ABILITY_PRANKSTER },
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Shinx"),
        .cryId = CRY_SHINX,
        .natDexNum = NATIONAL_DEX_SHINX,
        .categoryName = _("Crescent"),
        .height = 5,
        .weight = 95,
        .description = COMPOUND_STRING(
            "It rapidly contracts and relaxes its\n"
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_ShinxEmeribian,
        .frontPicSize = MON_COORDS_SIZE(48, 40),
        .frontPicYOffset = 13,
        .frontAnimFrames = sAnims_ShinxEmeribian,
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .backPic = gMonBackPic_ShinxEmeribian,
        .backPicSize = MON_COORDS_SIZE(64, 48),
        .backPicYOffset = 7,
        .backAnimId = BACK_ANIM_JOLT_RIGHT,
        .palette = gMonPalette_ShinxEmeribian,
        .shinyPalette = gMonShinyPalette_ShinxEmeribian,
        .iconSprite = gMonIcon_ShinxEmeribian,
        .iconPalIndex = 0,
        FOOTPRINT(Shinx)
        ...
        .formSpeciesIdTable = sShinxFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 15, SPECIES_LUXIO_EMERIBIAN}),
    },

    [SPECIES_LUXIO_EMERIBIAN] =
    {
        .baseHP        = 60,
        .baseAttack    = 90,
        .baseDefense   = 50,
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_LuxioEmeribian,
        .frontPicSize = MON_COORDS_SIZE(48, 48),
        .frontPicYOffset = 5,
        .frontAnimFrames = sAnims_LuxioEmeribian,
        .frontAnimId = ANIM_H_STRETCH,
        .backPic = gMonBackPic_LuxioEmeribian,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_JOLT_RIGHT,
        .palette = gMonPalette_LuxioEmeribian,
        .shinyPalette = gMonShinyPalette_LuxioEmeribian,
        .iconSprite = gMonIcon_LuxioEmeribian,
        .iconPalIndex = 0,
        FOOTPRINT(Luxio)
        .levelUpLearnset = sLuxioEmeribianLevelUpLearnset,
        .teachableLearnset = sLuxioEmeribianTeachableLearnset,
        .formSpeciesIdTable = sLuxioFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 34, SPECIES_LUXRAY_EMERIBIAN}),
    },

    [SPECIES_LUXRAY_EMERIBIAN] =
    {
        .baseHP        = 80,
        .baseAttack    = 125,
        .baseDefense   = 79,
        ...
        .trainerScale = 262,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_LuxrayEmeribian,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 4,
        .frontAnimFrames = sAnims_LuxrayEmeribian,
        .frontAnimId = ANIM_GLOW_YELLOW,
        .backPic = gMonBackPic_LuxrayEmeribian,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_SHRINK_GROW_VIBRATE,
        .palette = gMonPalette_LuxrayEmeribian,
        .shinyPalette = gMonShinyPalette_LuxrayEmeribian,
        .iconSprite = gMonIcon_LuxrayEmeribian,
        .iconPalIndex = 0,
        FOOTPRINT(Luxray)
    ...
    [SPECIES_CRANIDOS] =
    {
        ...
        .abilities = { ABILITY_MOLD_BREAKER, ABILITY_WEAK_ARMOR, ABILITY_SHEER_FORCE },
        .bodyColor = BODY_COLOR_BLUE,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 32, SPECIES_RAMPARDOS}),
    },
    ...
    [SPECIES_SHIELDON] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_STURDY, ABILITY_ROCKY_PAYLOAD, ABILITY_SOUNDPROOF },
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 32, SPECIES_BASTIODON}),
    },
    ...
    [SPECIES_WORMADAM_PLANT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_ANTICIPATION, ABILITY_SEED_SOWER, ABILITY_OVERCOAT },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_WORMADAM_SANDY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_ANTICIPATION, ABILITY_SAND_SPIT, ABILITY_OVERCOAT },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Wormadam"),
        .cryId = CRY_WORMADAM,
        .natDexNum = NATIONAL_DEX_WORMADAM,
...
#define MOTHIM_SPECIES_INFO                                                 \
    ...
    [SPECIES_COMBEE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_HONEY_GATHER, ABILITY_SUPERSWEET_SYRUP, ABILITY_HUSTLE },
        .bodyColor = BODY_COLOR_YELLOW,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL_FEMALE, 24, SPECIES_VESPIQUEN}),
    },
    ...
    [SPECIES_VESPIQUEN] =
    {
        ...
        .formSpeciesIdTable = sVespiquenFormSpeciesIdTable,
        .formChangeTable = sVespiquenFormChangeTable,
    },

    [SPECIES_VESPIQUEN_MEGA] =
    {
        .baseHP        = 71,
        .baseAttack    = 101,
        .baseDefense   = 94,
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_VespiquenMega,
        .frontPicSize = MON_COORDS_SIZE(48, 56),
        .frontPicYOffset = 4,
        .frontAnimFrames = sAnims_VespiquenMega,
        .frontAnimId = ANIM_LUNGE_GROW,
        .enemyMonElevation = 4,
        .backPic = gMonBackPic_VespiquenMega,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 15,
        .backAnimId = BACK_ANIM_CIRCLE_COUNTERCLOCKWISE,
        .palette = gMonPalette_VespiquenMega,
        .shinyPalette = gMonShinyPalette_VespiquenMega,
        .iconSprite = gMonIcon_Vespiquen,
        .iconPalIndex = 0,
        FOOTPRINT(Vespiquen)
        .levelUpLearnset = sVespiquenLevelUpLearnset,
    ...
    [SPECIES_DRIFLOON] =
    {
        ...
        .formSpeciesIdTable = sDrifloonFormSpeciesIdTable,
    ...
    [SPECIES_DRIFLOON_EMERIBIAN] =
    {
        ...
        .abilities = { ABILITY_LEVITATE, ABILITY_UNBURDEN, ABILITY_MOODY },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Drifloon"),
        .cryId = CRY_DRIFLOON,
        .natDexNum = NATIONAL_DEX_DRIFLOON,
        ...
        .weight = 12,
        .description = COMPOUND_STRING(
            "It served as the original inspiration\n"
            "for the hot air balloon in ages past.\n"
            "This is despite the fact that it uses\n"
            "ghostly powers, not hot air, to levitate."),
        .pokemonScale = 491,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_DrifloonEmeribian,
        .frontPicSize = MON_COORDS_SIZE(32, 56),
        .frontPicYOffset = 3,
        .frontAnimFrames = sAnims_DrifloonEmeribian,
        .frontAnimId = ANIM_V_SLIDE_WOBBLE,
        .enemyMonElevation = 5,
        .backPic = gMonBackPic_DrifloonEmeribian,
        .backPicSize = MON_COORDS_SIZE(40, 64),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_SMALL,
        ...
        .formSpeciesIdTable = sDrifloonFormSpeciesIdTable,
        .eggMoveLearnset = sDrifloonEmeribianEggMoveLearnset,
        .evolutions = EVOLUTION({EVO_LEVEL, 30, SPECIES_DRIFBLIM_EMERIBIAN}),
    },

    [SPECIES_DRIFBLIM_EMERIBIAN] =
    {
        .baseHP        = 130,
        .baseAttack    = 75,
        .baseDefense   = 44,
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_DrifblimEmeribian,
        .frontPicSize = MON_COORDS_SIZE(56, 56),
        .frontPicYOffset = 7,
        .frontAnimFrames = sAnims_DrifblimEmeribian,
        .frontAnimId = ANIM_V_SLIDE_WOBBLE,
        .enemyMonElevation = 7,
        .backPic = gMonBackPic_DrifblimEmeribian,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_CONVEX_DOUBLE_ARC,
        .palette = gMonPalette_DrifblimEmeribian,
        .shinyPalette = gMonShinyPalette_DrifblimEmeribian,
        .iconSprite = gMonIcon_DrifblimEmeribian,
        .iconPalIndex = 2,
        FOOTPRINT(Drifblim)
    ...
    [SPECIES_BUNEARY] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 32, SPECIES_LOPUNNY}),
    },
    ...
    [SPECIES_BUNEARY_EMERIBIAN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_THICK_FAT, ABILITY_SLUSH_RUSH, ABILITY_CONTRARY },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Buneary"),
        .cryId = CRY_BUNEARY,
        .natDexNum = NATIONAL_DEX_BUNEARY,
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_BunearyEmeribian,
        .frontPicSize = MON_COORDS_SIZE(32, 64),
        .frontPicYOffset = 4,
        .frontAnimFrames = sAnims_BunearyEmeribian,
        .frontAnimId = ANIM_H_JUMPS_V_STRETCH,
        .backPic = gMonBackPic_BunearyEmeribian,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_SMALL,
        .palette = gMonPalette_BunearyEmeribian,
        .shinyPalette = gMonShinyPalette_BunearyEmeribian,
        .iconSprite = gMonIcon_BunearyEmeribian,
        .iconPalIndex = 2,
        FOOTPRINT(Buneary)
        ...
        .isEmeribianForm = TRUE,
        .formSpeciesIdTable = sBunearyFormSpeciesIdTable,
        .eggMoveLearnset = sBunearyEmeribianEggMoveLearnset,
        .evolutions = EVOLUTION({EVO_LEVEL, 32, SPECIES_LOPUNNY_EMERIBIAN}),
    },
    ...
    [SPECIES_LOPUNNY_EMERIBIAN] =
    {
        ...
        .frontPicSize = MON_COORDS_SIZE(56, 56),
        .frontPicYOffset = 2,
        .frontAnimFrames = sAnims_LopunnyEmeribian,
        .frontAnimId = ANIM_SHRINK_GROW,
        .backPic = gMonBackPic_LopunnyEmeribian,
        .backPicSize = MON_COORDS_SIZE(64, 56),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_SHRINK_GROW_VIBRATE,
        .palette = gMonPalette_LopunnyEmeribian,
        .shinyPalette = gMonShinyPalette_LopunnyEmeribian,
        .iconSprite = gMonIcon_LopunnyEmeribian,
        .iconPalIndex = 2,
        FOOTPRINT(Lopunny)
        ...
        .isEmeribianForm = TRUE,
        .formSpeciesIdTable = sLopunnyFormSpeciesIdTable,
        .formChangeTable = sLopunnyEmeribianFormChangeTable,
    },
    ...
    [SPECIES_LOPUNNY_EMERIBIAN_MEGA] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_LopunnyEmeribianMega,
        .frontPicSize = MON_COORDS_SIZE(56, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = sAnims_LopunnyEmeribianMega,
        //.frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .backPic = gMonBackPic_LopunnyEmeribianMega,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_LARGE,
        .palette = gMonPalette_LopunnyEmeribianMega,
        .shinyPalette = gMonShinyPalette_LopunnyEmeribianMega,
        .iconSprite = gMonIcon_LopunnyEmeribian,
        .iconPalIndex = 2,
        FOOTPRINT(Lopunny)
        .isMegaEvolution = TRUE,
    ...
    [SPECIES_HIPPOPOTAS] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SAND_STREAM, ABILITY_EARTH_EATER, ABILITY_SAND_FORCE },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_LUMINEON_MEGA] =
    {
        ...
        .abilities = { ABILITY_STORM_DRAIN, ABILITY_STORM_DRAIN, ABILITY_STORM_DRAIN },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Lumineon"),
        .cryId = CRY_LUMINEON,
        .natDexNum = NATIONAL_DEX_LUMINEON,
        ...
        .frontPicSize = MON_COORDS_SIZE(56, 56),
        .frontPicYOffset = 5,
        .frontAnimFrames = sAnims_LumineonMega,
        .frontAnimId = ANIM_H_STRETCH,
    ...
    [SPECIES_SNOVER] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_GRASS),
        .abilities = { ABILITY_SNOW_WARNING, ABILITY_GRASSY_SURGE, ABILITY_SOUNDPROOF },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_ROTOM_WASH] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_LEVITATE, ABILITY_NONE, ABILITY_WATER_COMPACTION },
        .bodyColor = BODY_COLOR_RED,
        .noFlip = TRUE,
        .speciesName = _("Rotom"),
        .cryId = CRY_ROTOM,
    ...
    [SPECIES_ROTOM_FAN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_LEVITATE, ABILITY_NONE, ABILITY_WIND_POWER },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Rotom"),
        .cryId = CRY_ROTOM,
        .natDexNum = NATIONAL_DEX_ROTOM,
    ...
    [SPECIES_ROTOM_MOW] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_LEVITATE, ABILITY_NONE, ABILITY_SEED_SOWER },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Rotom"),
        .cryId = CRY_ROTOM,
        .natDexNum = NATIONAL_DEX_ROTOM,
