...
#define OW_FLAG_NO_ENCOUNTER        FLAG_NO_WILD_ENCOUNTER  // If this flag is set, wild encounters will be disabled.
#define OW_FLAG_NO_TRAINER_SEE      FLAG_NO_TRAINER_SIGHT   // If this flag is set, trainers will not battle the player unless they're talked to.
