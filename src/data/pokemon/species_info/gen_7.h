...
const struct SpeciesInfo gSpeciesInfoGen7[] =
{
    ...
    [SPECIES_DARTRIX] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 34, SPECIES_DECIDUEYE},
                                {EVO_MOVE, MOVE_MACH_PUNCH, SPECIES_DECIDUEYE_HISUIAN}),
    },
...
#define WISHIWASHI_MISC_INFO                                    \
    ...
    [SPECIES_TSAREENA_MEGA] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(TsareenaMega, 56, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = sAnims_TsareenaMega,
        .frontAnimId = ANIM_SHRINK_GROW,
        BACK_PIC(TsareenaMega, 56, 56),
        .backPicYOffset = 0,
        //.backAnimId = BACK_ANIM_NONE,
        PALETTES(TsareenaMega),
        ICON(Tsareena, 1),
        .footprint = gMonFootprint_Tsareena,
        LEARNSETS(Tsareena),
        .formSpeciesIdTable = sTsareenaFormSpeciesIdTable,
...
#define MINIOR_CORE_SPECIES_INFO(Form, color, iconPal)          \
    ...
    [SPECIES_TURTONATOR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_MONSTER, EGG_GROUP_DRAGON },
        .abilities = { ABILITY_SHELL_ARMOR, ABILITY_IRON_BARBS, ABILITY_ANGER_SHELL },
        .bodyColor = BODY_COLOR_RED,
