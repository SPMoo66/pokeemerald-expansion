...
const struct TrainerSprite gTrainerSprites[] =
{
    ...
    TRAINER_SPRITE(AQUA_ADMIN_MATT, AquaAdminMatt),
    TRAINER_SPRITE(AQUA_ADMIN_SHELLY, AquaAdminShelly),
    ...
    TRAINER_SPRITE(MAGMA_ADMIN_COURTNEY, MagmaAdminCourtney),
    TRAINER_SPRITE(MAGMA_ADMIN_TABITHA, MagmaAdminTabitha),
    ...
    TRAINER_SPRITE(BARON, Baron),
    TRAINER_SPRITE(HARPER, Harper),
    TRAINER_SPRITE(JAKSON, Jakson),
    TRAINER_SPRITE(REDD, Redd),
    TRAINER_SPRITE(SAKURA, Sakura),
...
const struct TrainerBacksprite gTrainerBacksprites[] =
{
    ...
    TRAINER_BACK_SPRITE(BLANK, 4, Blank, Palette_Wally, Hoenn),
};
