...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_DOUBLE_SLAP] =
    {
        .name = COMPOUND_STRING("Multi-Slap"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HYDRO_PUMP] =
    {
        ...
        .description = COMPOUND_STRING(
            "Two blasts of water at\n"
            "high power strike the foe."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 55 : 60,
        .type = TYPE_WATER,
        .accuracy = 80,
        .pp = 5,
        .target = TARGET_SELECTED,
    ...
    [MOVE_ROCK_SMASH] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_4 ? 50 : 30,
        .type = TYPE_FIGHTING,
        .accuracy = 100,
        .pp = 15,
        .target = TARGET_SELECTED,
    ...
    [MOVE_FROST_BREATH] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "in a critical hit."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 65 : 45,
        .type = TYPE_ICE,
        .accuracy = 100,
        .pp = 10,
        .target = TARGET_SELECTED,
    ...
    [MOVE_BEHEMOTH_BLADE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Strikes as a sword. Deals 1.5x\n"
            "damage to Mega Pokémon."),
        .effect = EFFECT_DYNAMAX_DOUBLE_DMG,
        .power = 100,
        .type = TYPE_STEEL,
        .accuracy = 100,
    ...
    [MOVE_BEHEMOTH_BASH] =
    {
        ...
        .description = COMPOUND_STRING(
            "Attacks as a shield. Deals 1.5x\n"
            "damage to Mega Pokémon."),
        .effect = EFFECT_DYNAMAX_DOUBLE_DMG,
        .power = 100,
        .type = TYPE_STEEL,
    ...
    [MOVE_CHILLY_RECEPTION] =
    {
        ...
        .mirrorMoveBanned = TRUE,
        .metronomeBanned = TRUE,
        .argument = { .weatherType = (B_PREFERRED_ICE_WEATHER == B_ICE_WEATHER_HAIL) ? BATTLE_WEATHER_HAIL : BATTLE_WEATHER_HAIL },
    ...
    [MOVE_BLAZING_TORQUE] =
    {
        ...
        .description = COMPOUND_STRING("May inflict a burn."),
        .effect = EFFECT_HIT,
        .power = 90,
        .type = TYPE_FIRE,
        .accuracy = 100,
    ...
    [MOVE_WICKED_TORQUE] =
    {
        ...
        .description = COMPOUND_STRING("May put the target to sleep."),
        .effect = EFFECT_HIT,
        .power = 90,
        .type = TYPE_DARK,
        .accuracy = 100,
    ...
    [MOVE_NOXIOUS_TORQUE] =
    {
        ...
        .description = COMPOUND_STRING("May poison the target."),
        .effect = EFFECT_HIT,
        .power = 90,
        .type = TYPE_POISON,
        .accuracy = 100,
    ...
    [MOVE_COMBAT_TORQUE] =
    {
        ...
        .description = COMPOUND_STRING("May paralyze the target."),
        .effect = EFFECT_HIT,
        .power = 90,
        .type = TYPE_FIGHTING,
        .accuracy = 100,
    ...
    [MOVE_MAGICAL_TORQUE] =
    {
        ...
        .description = COMPOUND_STRING("May confuse the target."),
        .effect = EFFECT_HIT,
        .power = 90,
        .type = TYPE_FAIRY,
        .accuracy = 100,
