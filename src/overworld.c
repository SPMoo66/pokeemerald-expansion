...
static const u8 sMapsecToRegion[] = {
    ...
    [MAPSEC_ROUTE_13]                   = REGION_IS_EXPANSION_1, // 3
    [MAPSEC_ROUTE_14]                   = REGION_IS_EXPANSION_1, // 3
    [MAPSEC_ROUTE_15]                   = REGION_IS_KANTO,       // 1
    [MAPSEC_ROUTE_16]                   = REGION_IS_KANTO,       // 1
    [MAPSEC_ROUTE_17]                   = REGION_IS_KANTO,       // 1
    [MAPSEC_ROUTE_18]                   = REGION_IS_KANTO,       // 1
    [MAPSEC_ROUTE_19]                   = REGION_IS_KANTO,       // 1
    [MAPSEC_ROUTE_20]                   = REGION_IS_KANTO,       // 1
