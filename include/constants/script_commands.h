...
#define SCR_OP_READELITEFOUR 0xe7
#define SCR_OP_SHUFFLEELITEFOUR 0xe8
#define SCR_OP_READGYMLEADER 0xe9
#define SCR_OP_SHUFFLEGYMLEADER 0xea
#define SCR_OP_HIDEFOLLOWER 0xeb
#define SCR_OP_WARPCONTINUESCRIPT 0xec
