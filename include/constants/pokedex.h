...
enum NationalDexOrder
{
    ...
    NATIONAL_DEX_TANGTRIP,
    NATIONAL_DEX_SLUDGMA,
    NATIONAL_DEX_MUDCARGO,
    NATIONAL_DEX_KOTORA,
    NATIONAL_DEX_RAITORA,
    NATIONAL_DEX_MADAME,
    NATIONAL_DEX_APIMARILL,
    NATIONAL_DEX_SOLFLORA,
    NATIONAL_DEX_SHIBIREFUGU,
    NATIONAL_DEX_DELIJOY,
    NATIONAL_DEX_COGMENT,
    NATIONAL_DEX_MAGNEMELT,
    NATIONAL_DEX_CHOUTEI,
    NATIONAL_DEX_KAILANT,
    NATIONAL_DEX_CORPELLA,
    NATIONAL_DEX_CALAMITY_MAW,
    NATIONAL_DEX_OCEAN_GLEAM,
    NATIONAL_DEX_REND_ECLIPSE,
    NATIONAL_DEX_TUNDRA_HUSK,
    NATIONAL_DEX_REGIAGUA,
};

#define JOHTO_DEX_COUNT     NATIONAL_DEX_CELEBI

#if P_GEN_9_POKEMON == TRUE
    #define NATIONAL_DEX_COUNT  NATIONAL_DEX_REGIAGUA
