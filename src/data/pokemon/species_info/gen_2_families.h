...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_CHIKORITA] =
    {
        ...
        .abilities = { ABILITY_OVERGROW, ABILITY_FLOWER_GIFT, ABILITY_LEAF_GUARD },
    ...
    [SPECIES_BAYLEEF] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 32, SPECIES_MEGANIUM},
                                {EVO_LEVEL_TYPE_MON_IN_PARTY, 32, SPECIES_MEGANIUM_EMERIBIAN, TYPE_DRAGON}),
    },
    ...
    [SPECIES_MEGANIUM_EMERIBIAN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_GRASS),
        .abilities = { ABILITY_OVERGROW, ABILITY_SEED_SOWER, ABILITY_DRAGONS_MAW },
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("Meganium"),
        .cryId = CRY_MEGANIUM,
        .natDexNum = NATIONAL_DEX_MEGANIUM,
        ...
        .trainerScale = 277,
        .trainerOffset = 1,
        .frontPic = gMonFrontPic_MeganiumEmeribian,
        .frontPicSize = MON_COORDS_SIZE(48, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = sAnims_MeganiumEmeribian,
        .frontAnimId = ANIM_GROW_VIBRATE,
        .backPic = gMonBackPic_MeganiumEmeribian,
        .backPicSize = MON_COORDS_SIZE(56, 64),
        .backPicYOffset = 1,
        .backAnimId = BACK_ANIM_V_SHAKE,
        .palette = gMonPalette_MeganiumEmeribian,
        .shinyPalette = gMonShinyPalette_MeganiumEmeribian,
        .iconSprite = gMonIcon_MeganiumEmeribian,
        .iconPalIndex = 1,
        FOOTPRINT(Meganium)
    ...
    [SPECIES_QUILAVA] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 36, SPECIES_TYPHLOSION},
                                {EVO_MOVE, MOVE_HEX, SPECIES_TYPHLOSION_HISUIAN},
                                {EVO_LEVEL_TYPE_MON_IN_PARTY, 36, SPECIES_TYPHLOSION_EMERIBIAN, TYPE_ELECTRIC}),
    },
    ...
    [SPECIES_TYPHLOSION_EMERIBIAN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_BLAZE, ABILITY_ELECTROMORPHOSIS, ABILITY_ELECTRIC_SURGE },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Typhlosion"),
        .cryId = CRY_TYPHLOSION,
        .natDexNum = NATIONAL_DEX_TYPHLOSION,
        .categoryName = _("Firestorm"),
        .height = 17,
        .weight = 795,
        .description = COMPOUND_STRING(
            "It can hide behind a shimmering heat haze\n"
        ...
        .trainerScale = 268,
        .trainerOffset = 1,
        .frontPic = gMonFrontPic_TyphlosionEmeribian,
        .frontPicSize = MON_COORDS_SIZE(56, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = sAnims_TyphlosionEmeribian,
        .frontAnimId = ANIM_V_SHAKE,
        .frontAnimDelay = 20,
        .backPic = gMonBackPic_TyphlosionEmeribian,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_SHAKE_GLOW_RED,
        .palette = gMonPalette_TyphlosionEmeribian,
        .shinyPalette = gMonShinyPalette_TyphlosionEmeribian,
        .iconSprite = gMonIcon_TyphlosionEmeribian,
        .iconPalIndex = 3,
        FOOTPRINT(Typhlosion)
    ...
    [SPECIES_CROCONAW] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 30, SPECIES_FERALIGATR},
                                {EVO_LEVEL_TYPE_MON_IN_PARTY, 30, SPECIES_FERALIGATR_EMERIBIAN, TYPE_STEEL}),
    },
    ...
    [SPECIES_FERALIGATR_EMERIBIAN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_WATER_1),
        .abilities = { ABILITY_TORRENT, ABILITY_STRONG_JAW, ABILITY_EARTH_EATER },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Feraligatr"),
        .cryId = CRY_FERALIGATR,
        .natDexNum = NATIONAL_DEX_FERALIGATR,
        ...
        .trainerScale = 342,
        .trainerOffset = 7,
        .frontPic = gMonFrontPic_FeraligatrEmeribian,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 1,
        .frontAnimFrames = sAnims_FeraligatrEmeribian,
        .frontAnimId = ANIM_H_SHAKE,
        .frontAnimDelay = 5,
        .backPic = gMonBackPic_FeraligatrEmeribian,
        .backPicSize = MON_COORDS_SIZE(56, 64),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_V_SHAKE,
        .palette = gMonPalette_FeraligatrEmeribian,
        .shinyPalette = gMonShinyPalette_FeraligatrEmeribian,
        .iconSprite = gMonIcon_FeraligatrEmeribian,
        .iconPalIndex = 0,
        FOOTPRINT(Feraligatr)
    ...
    [SPECIES_SENTRET] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 18, SPECIES_FURRET}),
    },
    ...
    [SPECIES_NOCTOWL] =
    {
        ...
        .baseDefense   = 55,
        .baseSpeed     = 75,
        .baseSpAttack  = P_UPDATED_STATS >= GEN_7 ? 96 : 86,
        .baseSpDefense = 96,
        .types = MON_TYPES(TYPE_NORMAL, TYPE_FLYING),
        .catchRate = 90,
    ...
    [SPECIES_NOCTOWL_EMERIBIAN] =
    {
        ...
        .abilities = { ABILITY_INSOMNIA, ABILITY_COMPOUND_EYES, ABILITY_BAD_DREAMS },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Noctowl"),
        .cryId = CRY_NOCTOWL,
        .natDexNum = NATIONAL_DEX_NOCTOWL,
        .categoryName = _("More Owl"),
        .height = 16,
        .weight = 487,
        .description = COMPOUND_STRING(
            "What if you had bad dreams? What if you\n"
            "could never get to sleep? What if this\n"
            "insomnia drove you to a manic state that\n"
            "wanted to inflict this upon everyone?"),
        .pokemonScale = 278,
        .pokemonOffset = 3,
        .trainerScale = 256,
        .trainerOffset = 0,
       .frontPic = gMonFrontPic_NoctowlEmeribian,
        .frontPicSize = MON_COORDS_SIZE(40, 64),
        .frontPicYOffset = 2,
        .frontAnimFrames = sAnims_NoctowlEmeribian,
        .frontAnimId = ANIM_V_STRETCH,
        .backPic = gMonBackPic_NoctowlEmeribian,
        .backPicSize = MON_COORDS_SIZE(48, 64),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_TRIANGLE_DOWN,
        .palette = gMonPalette_NoctowlEmeribian,
        .shinyPalette = gMonShinyPalette_NoctowlEmeribian,
        .iconSprite = gMonIcon_Noctowl,
        .iconPalIndex = 2,
        FOOTPRINT(Noctowl)
        .levelUpLearnset = sNoctowlLevelUpLearnset,
    ...
    [SPECIES_SPINARAK_EMERIBIAN] =
    {
        ...
        .abilities = { ABILITY_ILLUMINATE, ABILITY_STATIC, ABILITY_POISON_TOUCH },
        ...
        .weight = 85,
        .description = COMPOUND_STRING(
            "It has learned to live off radioactive\n"
            "waste as a food supply. Pokémon Centers\n"
            "find caring for this variant difficult\n"
            "due to it being a picky eater."),
        .pokemonScale = 414,
        .pokemonOffset = 21,
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_SpinarakEmeribian,
        .frontPicSize = MON_COORDS_SIZE(48, 32),
        .frontPicYOffset = 16,
        .frontAnimFrames = sAnims_SpinarakEmeribian,
        .frontAnimId = ANIM_CIRCLE_C_CLOCKWISE_SLOW,
        .backPic = gMonBackPic_SpinarakEmeribian,
        .backPicSize = MON_COORDS_SIZE(64, 32),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_V_SHAKE_H_SLIDE,
        ...
        .isEmeribianForm = TRUE,
        .formSpeciesIdTable = sSpinarakFormSpeciesIdTable,
        .eggMoveLearnset = sSpinarakEmeribianEggMoveLearnset,
        .evolutions = EVOLUTION({EVO_LEVEL, 22, SPECIES_ARIADOS_EMERIBIAN}),
    },

    [SPECIES_ARIADOS_EMERIBIAN] =
    {
        .baseHP        = 65,
        .baseAttack    = 73,
        .baseDefense   = 92,
        .baseSpeed     = 102,
        .baseSpAttack  = 96,
        .baseSpDefense = P_UPDATED_STATS >= GEN_7 ? 67 : 57,
        .types = { TYPE_POISON, TYPE_ELECTRIC},
        .catchRate = 90,
        .expYield = 140,
        .evYield_Speed = 2,
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = { EGG_GROUP_BUG, EGG_GROUP_BUG },
        .abilities = { ABILITY_BATTERY, ABILITY_TRANSISTOR, ABILITY_TOXIC_CHAIN },
        .bodyColor = BODY_COLOR_BLACK,
        .speciesName = _("Ariados"),
        .cryId = CRY_ARIADOS,
        .natDexNum = NATIONAL_DEX_ARIADOS,
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_AriadosEmeribian,
        .frontPicSize = MON_COORDS_SIZE(64, 56),
        .frontPicYOffset = 5,
        .frontAnimFrames = sAnims_AriadosEmeribian,
        .frontAnimId = ANIM_H_SHAKE,
        .backPic = gMonBackPic_AriadosEmeribian,
        .backPicSize = MON_COORDS_SIZE(64, 48),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_H_SLIDE,
    ...
    [SPECIES_CHINCHOU] =
    {
        ...
        .abilities = { ABILITY_VOLT_ABSORB, ABILITY_ELECTRIC_SURGE, ABILITY_WATER_ABSORB },
        .bodyColor = BODY_COLOR_BLUE,
...
#define AMPHAROS_DEFENSE (P_UPDATED_STATS >= GEN_6 ? 85 : 75)
    ...
    [SPECIES_AMPHAROS] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_FIELD),
        .abilities = { ABILITY_STATIC, ABILITY_SURGE_SURFER, ABILITY_PLUS },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_JUMPLUFF] =
    {
        ...
        .baseSpeed     = 110,
        .baseSpAttack  = 70,
        .baseSpDefense = P_UPDATED_STATS >= GEN_6 ? 100 : 90,
        .types = MON_TYPES(TYPE_GRASS, TYPE_FLYING),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 230,
    ...
    [SPECIES_HOPPIP_EMERIBIAN] =
    {
        ...
        .isEmeribianForm = TRUE,
        .formSpeciesIdTable = sHoppipFormSpeciesIdTable,
        .eggMoveLearnset = sHoppipEmeribianEggMoveLearnset,
    ...
    [SPECIES_WOOPER_PALDEAN] =
    {
        ...
        .formSpeciesIdTable = sWooperFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 22, SPECIES_CLODSIRE}),
    },
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_WYNAUT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_SHADOW_TAG, ABILITY_MAGIC_GUARD, ABILITY_TELEPATHY },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_PINECO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_STURDY, ABILITY_SWARM, ABILITY_OVERCOAT },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_FORRETRESS] =
    {
        ...
        .evYield_Defense = 2,
        .itemCommon = ITEM_GANLON_BERRY,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 20,
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_STURDY, ABILITY_IRON_BARBS, ABILITY_OVERCOAT },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_DUDUNSPARCE_MEGA] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_DudunsparceMega,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = sAnims_Dudunsparce,
        //.frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .backPic = gMonBackPic_DudunsparceMega,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 0,
        //.backAnimId = BACK_ANIM_NONE,
        .palette = gMonPalette_DudunsparceMega,
        .shinyPalette = gMonShinyPalette_DudunsparceMega,
        .iconSprite = gMonIcon_Dudunsparce,
        .iconPalIndex = 0,
        //FOOTPRINT(Dudunsparce),
        .levelUpLearnset = sDudunsparceLevelUpLearnset,
    ...
    [SPECIES_SNUBBULL] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 26, SPECIES_GRANBULL}),
    },
    ...
    [SPECIES_QWILFISH] =
    {
        ...
        .evolutions = EVOLUTION({EVO_MOVE, MOVE_BARB_BARRAGE, SPECIES_SHIBIREFUGU}),
    },
    ...
    [SPECIES_SHUCKLE_FRIBIAN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = { EGG_GROUP_BUG, EGG_GROUP_BUG },
        .abilities = { ABILITY_REGENERATOR, ABILITY_OBLIVIOUS, ABILITY_HEATPROOF },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Shuckle"),
        .cryId = CRY_SHUCKLE,
        .natDexNum = NATIONAL_DEX_SHUCKLE,
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_ShuckleFribian,
        .frontPicSize = MON_COORDS_SIZE(56, 48),
        .frontPicYOffset = 3,
        .frontAnimFrames = sAnims_ShuckleFribian,
        .frontAnimId = ANIM_SWING_CONCAVE,
        .backPic = gMonBackPic_ShuckleFribian,
        .backPicSize = MON_COORDS_SIZE(48, 48),
        .backPicYOffset = 11,
        .backAnimId = BACK_ANIM_DIP_RIGHT_SIDE,
        .palette = gMonPalette_ShuckleFribian,
        .shinyPalette = gMonShinyPalette_ShuckleFribian,
        .iconSprite = gMonIcon_ShuckleFribian,
        .iconPalIndex = 0,
        FOOTPRINT(Shuckle)
        ...
        .isFribianForm = TRUE,
        .formSpeciesIdTable = sShuckleFormSpeciesIdTable,
        .eggMoveLearnset = sShuckleFribianEggMoveLearnset,
    },
    ...
    [SPECIES_WEAVILE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_PRESSURE, ABILITY_DARK_AURA, ABILITY_PICKPOCKET },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_URSARING] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 41, SPECIES_URSALUNA},
    ...
    [SPECIES_MAGCARGO] =
    {
        .baseHP        = P_UPDATED_STATS >= GEN_7 ? 70 : 60,
        .baseAttack    = 50,
        .baseDefense   = 130,
        .baseSpeed     = 40,
        .baseSpAttack  = P_UPDATED_STATS >= GEN_7 ? 100 : 90,
        .baseSpDefense = 100,
    ...
    [SPECIES_MAGCARGO_EMERIBIAN] =
    {
        .baseHP        = P_UPDATED_STATS >= GEN_7 ? 80 : 70,
        .baseAttack    = 100,
        .baseDefense   = 130,
        .baseSpeed     = 30,
        .baseSpAttack  = P_UPDATED_STATS >= GEN_7 ? 60 : 50,
        .baseSpDefense = 90,
        ...
        .abilities = { ABILITY_BATTLE_ARMOR, ABILITY_STEAM_ENGINE, ABILITY_WELL_BAKED_BODY },
        .bodyColor = BODY_COLOR_RED,
        .noFlip = TRUE,
        .speciesName = _("Magcargo"),
        .cryId = CRY_MAGCARGO,
        ...
        .weight = 786,
        .description = COMPOUND_STRING(
            "Its 18,000 degree F body is constantly\n"
            "at odds with its metallic shell. However,\n"
            "the shell is constantly reforged in the\n"
            "heat, regrowing like a snake's skin."),
        .pokemonScale = 332,
        .pokemonOffset = 15,
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_MagcargoEmeribian,
        .frontPicSize = MON_COORDS_SIZE(56, 64),
        .frontPicYOffset = 3,
        .frontAnimFrames = sAnims_MagcargoEmeribian,
        .frontAnimId = ANIM_V_STRETCH,
        .backPic = gMonBackPic_MagcargoEmeribian,
        .backPicSize = MON_COORDS_SIZE(64, 56),
        .backPicYOffset = 7,
        .backAnimId = BACK_ANIM_SHAKE_GLOW_RED,
        .palette = gMonPalette_MagcargoEmeribian,
        .shinyPalette = gMonShinyPalette_MagcargoEmeribian,
        .iconSprite = gMonIcon_MagcargoEmeribian,
        .iconPalIndex = 0,
        FOOTPRINT(Magcargo)
...
#define CORSOLA_DEFENSES (P_UPDATED_STATS >= GEN_7 ? 95 : 85)
    ...
    [SPECIES_CORSOLA_GALARIAN] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_WATER_3),
        .abilities = { ABILITY_WEAK_ARMOR, ABILITY_AFTERMATH, ABILITY_CURSED_BODY },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Corsola"),
        .cryId = CRY_CORSOLA,
        .natDexNum = NATIONAL_DEX_CORSOLA,
    ...
    [SPECIES_REMORAID] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 30, SPECIES_OCTILLERY},
                                {EVO_ITEM, ITEM_FIRE_STONE, SPECIES_OCTILLERY_FRIBIAN}),
    },
    ...
    [SPECIES_OCTILLERY] =
    {
        ...
        .formSpeciesIdTable = sOctilleryFormSpeciesIdTable,
    },
	
    [SPECIES_OCTILLERY_FRIBIAN] =
    {
        .baseHP        = 95,
        .baseAttack    = 80,
        .baseDefense   = 85,
        ...
        .abilities = { ABILITY_STEAM_ENGINE, ABILITY_SNIPER, ABILITY_TECHNICIAN},
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Octillery"),
        .cryId = CRY_OCTILLERY,
        .natDexNum = NATIONAL_DEX_OCTILLERY,
        ...
        .weight = 285,
        .description = COMPOUND_STRING(
            "Taking up residence in sunken steam\n"
            "ships, it was clever enough to start\n"
            "emulating the machinery within."),
        .pokemonScale = 296,
        .pokemonOffset = 3,
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_OctilleryFribian,
        .frontPicSize = MON_COORDS_SIZE(56, 48),
        .frontPicYOffset = 8,
        .frontAnimFrames = sAnims_OctilleryFribian,
        .frontAnimId = ANIM_V_STRETCH,
        .frontAnimDelay = 20,
        .backPic = gMonBackPic_OctilleryFribian,
        .backPicSize = MON_COORDS_SIZE(64, 56),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_SHRINK_GROW,
        .palette = gMonPalette_OctilleryFribian,
        .shinyPalette = gMonShinyPalette_OctilleryFribian,
        .iconSprite = gMonIcon_OctilleryFribian,
        .iconPalIndex = 0,
        FOOTPRINT(Octillery)
    ...
    [SPECIES_SKARMORY_FRIBIAN] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = { EGG_GROUP_FLYING, EGG_GROUP_FLYING },
        .abilities = { ABILITY_KEEN_EYE, ABILITY_LEVITATE, ABILITY_SPEED_BOOST },
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = _("Skarmory"),
        .cryId = CRY_SKARMORY,
        .natDexNum = NATIONAL_DEX_SKARMORY,
        ...
        .trainerScale = 271,
        .trainerOffset = 1,
        .frontPic = gMonFrontPic_SkarmoryFribian,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 1,
        .frontAnimFrames = sAnims_SkarmoryFribian,
        .frontAnimId = ANIM_V_SHAKE,
        .backPic = gMonBackPic_SkarmoryFribian,
        .backPicSize = MON_COORDS_SIZE(48, 64),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_JOLT_RIGHT,
        .palette = gMonPalette_SkarmoryFribian,
        .shinyPalette = gMonShinyPalette_SkarmoryFribian,
        .iconSprite = gMonIcon_SkarmoryFribian,
        .iconPalIndex = 0,
        FOOTPRINT(Skarmory)
    ...
    [SPECIES_HOUNDOUR] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 26, SPECIES_HOUNDOOM}),
    },
    ...
    [SPECIES_PHANPY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_PICKUP, ABILITY_ROCKY_PAYLOAD, ABILITY_SAND_VEIL },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_DONPHAN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_STURDY, ABILITY_ROCKY_PAYLOAD, ABILITY_SAND_VEIL },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_LARVITAR] =
    {
        ...
        .abilities = { ABILITY_GUTS, ABILITY_ROCK_HEAD, ABILITY_SAND_VEIL },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_PUPITAR] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_SHED_SKIN, ABILITY_ROCK_HEAD, ABILITY_NONE },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_TYRANITAR] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_SAND_STREAM, ABILITY_ROCK_HEAD, ABILITY_UNNERVE },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_HO_OH_MEGA] =
    {
        ...
        .trainerScale = 610,
        .trainerOffset = 17,
        .frontPic = gMonFrontPic_HoOhMega,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = sAnims_HoOhMega,
        .frontAnimId = ANIM_GROW_VIBRATE,
        .enemyMonElevation = 6,
        .backPic = gMonBackPic_HoOhMega,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 5,
        .backAnimId = BACK_ANIM_SHAKE_GLOW_RED,
        .palette = gMonPalette_HoOhMega,
        .shinyPalette = gMonShinyPalette_HoOhMega,
        .iconSprite = gMonIcon_HoOh,
        .iconPalIndex = 1,
        FOOTPRINT(HoOh)
        .isLegendary = TRUE,
