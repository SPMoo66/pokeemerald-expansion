...
enum ScrOp
{
    ...
    SCR_OP_POKEVIAL = 0xE3,
    SCR_OP_DYNMULTICHOICE = 0xE4,
    SCR_OP_DYNMULTIPUSH = 0xE5,
    SCR_OP_READELITEFOUR = 0xE6,
    SCR_OP_SHUFFLEELITEFOUR = 0xE7,
    SCR_OP_READGYMLEADER = 0xE8,
    SCR_OP_SHUFFLEGYMLEADER = 0xE9,
    SCR_OP_HIDEFOLLOWER = 0xEA,
    SCR_OP_WARPCONTINUESCRIPT = 0xEB,
    SCR_OP_GETBRAILLESTRINGWIDTH = 0xEC,
};
