...
static const u8 sMapsecToRegion[] = {
    ...
    [MAPSEC_ROUTE_10]                   = REGION_IS_EXPANSION_1, // 3
    [MAPSEC_ROUTE_11]                   = REGION_IS_EXPANSION_1, // 3
    [MAPSEC_ROUTE_12]                   = REGION_IS_EXPANSION_1, // 3
    [MAPSEC_ROUTE_13]                   = REGION_IS_KANTO,       // 1
    [MAPSEC_ROUTE_14]                   = REGION_IS_KANTO,       // 1
