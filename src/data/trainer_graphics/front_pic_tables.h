const struct MonCoords gTrainerFrontPicCoords[] =
{
    ...
    [TRAINER_PIC_AQUA_ADMIN_MATT] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_AQUA_ADMIN_SHELLY] = {.size = 8, .y_offset = 1},
    ...
    [TRAINER_PIC_MAGMA_ADMIN_COURTNEY] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_MAGMA_ADMIN_TABITHA] = {.size = 8, .y_offset = 1},
...
const struct CompressedSpriteSheet gTrainerFrontPicTable[] =
{
    ...
    TRAINER_SPRITE(AQUA_ADMIN_MATT, gTrainerFrontPic_AquaAdminMatt, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(AQUA_ADMIN_SHELLY, gTrainerFrontPic_AquaAdminShelly, TRAINER_PIC_SIZE),
    ...
    TRAINER_SPRITE(MAGMA_ADMIN_COURTNEY, gTrainerFrontPic_MagmaAdminCourtney, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(MAGMA_ADMIN_TABITHA, gTrainerFrontPic_MagmaAdminTabitha, TRAINER_PIC_SIZE),
...
const struct CompressedSpritePalette gTrainerFrontPicPaletteTable[] =
{
    ...
    TRAINER_PAL(AQUA_ADMIN_MATT, gTrainerPalette_AquaAdminMatt),
    TRAINER_PAL(AQUA_ADMIN_SHELLY, gTrainerPalette_AquaAdminShelly),
    ...
    TRAINER_PAL(MAGMA_ADMIN_COURTNEY, gTrainerPalette_MagmaAdminCourtney),
    TRAINER_PAL(MAGMA_ADMIN_TABITHA, gTrainerPalette_MagmaAdminTabitha),
