...
#define VAR_STARTER_SET                                  0x404E // Used to save starter set
...
#define VAR_ROUTE106_STATE                               0x4065 // Challenge Ball tutorial
...
#define VAR_INVESTOR_MONEY                               0x409B // Stores the investment money value (0-3)
#define VAR_ELITE_4_STATE                                0x409C
#define VAR_LOOKER_ROCKET                                0x409D // Was unused
#define VAR_MOSSDEEP_SPACE_CENTER_STAIR_GUARD_STATE      0x409E
#define VAR_MOSSDEEP_SPACE_CENTER_STATE                  0x409F
#define VAR_SLATEPORT_HARBOR_STATE                       0x40A0
#define VAR_OVERWORLD_SPEEDUP                            0x40A1 // Was unused
...
#define VAR_GIFT_UNUSED_1                                0x40DE // Var is written to (0), but never read
#define VAR_GIFT_UNUSED_2                                0x40DF // Var is written to (0), but never read
#define VAR_GIFT_UNUSED_3                                0x40E0 // Var is written to (0), but never read
#define VAR_GIFT_UNUSED_4                                0x40E1 // Var is written to (0), but never read
#define VAR_GIFT_UNUSED_5                                0x40E2 // Var is written to (0), but never read
#define VAR_GIFT_UNUSED_6                                0x40E3 // Var is written to (0), but never read
#define VAR_GIFT_UNUSED_7                                0x40E4 // var is written to (0), but never read
