...
const struct SpeciesInfo gSpeciesInfoGen9[] =
{
    ...
    [SPECIES_LECHONK] =
    {
        ...
        LEARNSETS(Lechonk),
        .evolutions = EVOLUTION({EVO_LEVEL_MALE, 24, SPECIES_OINKOLOGNE_MALE},
                                {EVO_LEVEL_FEMALE, 24, SPECIES_OINKOLOGNE_FEMALE}),
    },
...
#define OINKOLOGNE_MISC_INFO                                \
    ...
    [SPECIES_TANDEMAUS] =
    {
        ...
        LEARNSETS(Tandemaus),
        .evolutions = EVOLUTION({EVO_LEVEL_FAMILY_OF_FOUR, 28, SPECIES_MAUSHOLD_FAMILY_OF_FOUR},
                                {EVO_LEVEL_FAMILY_OF_THREE, 28, SPECIES_MAUSHOLD_FAMILY_OF_THREE}),
    },
...
#define SQUAWKABILLY_MISC_INFO                                  \
    ...
    [SPECIES_TOEDSCOOL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = { EGG_GROUP_GRASS, EGG_GROUP_GRASS },
        .abilities = { ABILITY_MYCELIUM_MIGHT, ABILITY_REGENERATOR, ABILITY_POISON_HEAL },
        .bodyColor = BODY_COLOR_YELLOW,
...
#define PALAFIN_MISC_INFO                                       \
    ...
    [SPECIES_GREAVARD] =
    {
        ...
        LEARNSETS(Greavard),
        .evolutions = EVOLUTION({EVO_LEVEL_NIGHT, 32, SPECIES_HOUNDSTONE}),
    },
