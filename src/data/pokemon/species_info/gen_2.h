...
#define TYPHLOSION_MISC_INFO                                            \
    ...
    [SPECIES_NOCTOWL_EMERIBIAN] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(NoctowlEmeribian, 40, 64),
        .frontPicYOffset = 2,
        .frontAnimFrames = sAnims_NoctowlEmeribian,
        .frontAnimId = ANIM_V_STRETCH,
        BACK_PIC(NoctowlEmeribian, 48, 64),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_TRIANGLE_DOWN,
        PALETTES(NoctowlEmeribian),
        ICON(NoctowlEmeribian, 2),
        .footprint = gMonFootprint_Noctowl,
        .formSpeciesIdTable = sNoctowlFormSpeciesIdTable,
        LEARNSETS(NoctowlEmeribian),
    ...
    [SPECIES_SPINARAK_EMERIBIAN] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(SpinarakEmeribian, 48, 32),
        .frontPicYOffset = 16,
        .frontAnimFrames = sAnims_SpinarakEmeribian,
        .frontAnimId = ANIM_CIRCLE_C_CLOCKWISE_SLOW,
        BACK_PIC(SpinarakEmeribian, 64, 32),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_V_SHAKE_H_SLIDE,
        PALETTES(SpinarakEmeribian),
        ICON(SpinarakEmeribian, 1),
        .footprint = gMonFootprint_Spinarak,
        .formSpeciesIdTable = sSpinarakFormSpeciesIdTable,
        LEARNSETS(SpinarakEmeribian),
        .isEmeribianForm = TRUE,
    ...
    [SPECIES_ARIADOS_EMERIBIAN] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(AriadosEmeribian, 64, 56),
        .frontPicYOffset = 5,
        .frontAnimFrames = sAnims_AriadosEmeribian,
        .frontAnimId = ANIM_H_SHAKE,
        BACK_PIC(AriadosEmeribian, 64, 48),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_H_SLIDE,
        PALETTES(AriadosEmeribian),
        ICON(AriadosEmeribian, 1),
        .footprint = gMonFootprint_Ariados,
        .formSpeciesIdTable = sAriadosFormSpeciesIdTable,
        LEARNSETS(AriadosEmeribian),
        .isEmeribianForm = TRUE,
    },
...
#define QWILFISH_MISC_INFO                                                              \
    ...
    [SPECIES_SHUCKLE_FRIBIAN] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(ShuckleFribian, 56, 48),
        .frontPicYOffset = 3,
        .frontAnimFrames = sAnims_ShuckleFribian,
        .frontAnimId = ANIM_SWING_CONCAVE,
        BACK_PIC(ShuckleFribian, 48, 48),
        .backPicYOffset = 11,
        .backAnimId = BACK_ANIM_DIP_RIGHT_SIDE,
        PALETTES(ShuckleFribian),
        ICON(ShuckleFribian, 0),
        .footprint = gMonFootprint_Shuckle,
        .formSpeciesIdTable = sShuckleFormSpeciesIdTable,
        LEARNSETS(ShuckleFribian),
        .isFribianForm = TRUE,
    },
...
#define URSALUNA_MISC_INFO                                  \
    ...
    [SPECIES_MAGCARGO_EMERIBIAN] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(MagcargoEmeribian, 56, 64),
        .frontPicYOffset = 3,
        .frontAnimFrames = sAnims_MagcargoEmeribian,
        .frontAnimId = ANIM_V_STRETCH,
        BACK_PIC(MagcargoEmeribian, 64, 56),
        .backPicYOffset = 7,
        .backAnimId = BACK_ANIM_SHAKE_GLOW_RED,
        PALETTES(MagcargoEmeribian),
        ICON(MagcargoEmeribian, 0),
        .footprint = gMonFootprint_Magcargo,
        .formSpeciesIdTable = sMagcargoFormSpeciesIdTable,
        LEARNSETS(MagcargoEmeribian),
        .isEmeribianForm = TRUE,
    },
...
#define CORSOLA_MISC_INFO                                       \
    ...
    [SPECIES_OCTILLERY_FRIBIAN] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(OctilleryFribian, 56, 48),
        .frontPicYOffset = 8,
        .frontAnimFrames = sAnims_OctilleryFribian,
        .frontAnimId = ANIM_V_STRETCH,
        .frontAnimDelay = 20,
        BACK_PIC(OctilleryFribian, 64, 56),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_SHRINK_GROW,
        PALETTES(OctilleryFribian),
        ICON(OctilleryFribian, 0),
        .footprint = gMonFootprint_Octillery,
        .formSpeciesIdTable = sOctilleryFormSpeciesIdTable,
        LEARNSETS(OctilleryFribian),
        .isFribianForm = TRUE,
    },
    ...
    [SPECIES_SKARMORY_FRIBIAN] =
    {
        ...
        .trainerScale = 271,
        .trainerOffset = 1,
        FRONT_PIC(SkarmoryFribian, 64, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = sAnims_SkarmoryFribian,
        .frontAnimId = ANIM_V_SHAKE,
        .enemyMonElevation = 8,
        BACK_PIC(SkarmoryFribian, 48, 64),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_JOLT_RIGHT,
        PALETTES(SkarmoryFribian),
        ICON(SkarmoryFribian, 0),
        .footprint = gMonFootprint_Skarmory,
        .formSpeciesIdTable = sSkarmoryFormSpeciesIdTable,
        LEARNSETS(SkarmoryFribian),
        .isFribianForm = TRUE,
    },
...
#define HOUNDOOM_MISC_INFO                                  \
    ...
    [SPECIES_PUPITAR] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = { EGG_GROUP_MONSTER, EGG_GROUP_MONSTER },
        .abilities = { ABILITY_SHED_SKIN, ABILITY_ROCK_HEAD, ABILITY_REGENERATOR },
        .bodyColor = BODY_COLOR_GRAY,
