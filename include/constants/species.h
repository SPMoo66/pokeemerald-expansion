...
enum __attribute__((packed)) Species
{
    ...
    FAKE_START = SPECIES_MIMIKYU_BUSTED_TOTEM,

// Fribian Species
    SPECIES_ARSELLOSKY = 1524,
    SPECIES_EVALEON = 1525,
    SPECIES_AEREON = 1526,
    SPECIES_CONTAGEON = 1527,
    SPECIES_LANEON = 1528,
    SPECIES_SCALEON = 1529,
// Fribian Forms
    SPECIES_GOLEM_FRIBIAN = 1530,
    SPECIES_CLOYSTER_FRIBIAN = 1531,
    SPECIES_SHUCKLE_FRIBIAN = 1532,
    SPECIES_OCTILLERY_FRIBIAN = 1533,
	SPECIES_SKARMORY_FRIBIAN = 1534,
    SPECIES_BRELOOM_FRIBIAN = 1535,
    SPECIES_GIGALITH_FRIBIAN = 1536,
    SPECIES_WOOLOO_FRIBIAN = 1537,
    SPECIES_DUBWOOL_FRIBIAN = 1538,

// Emeribian Species
    SPECIES_TITANEON = 1539,
    SPECIES_TANGTRIP = 1540,
    SPECIES_SLUDGMA = 1541,
    SPECIES_MUDCARGO = 1542,
    SPECIES_KOTORA = 1543,
    SPECIES_RAITORA = 1544,
    SPECIES_MADAME = 1545,
    SPECIES_APIMARILL = 1546,
    SPECIES_SOLFLORA = 1547,
    SPECIES_SHIBIREFUGU = 1548,
    SPECIES_DELIJOY = 1549,
    SPECIES_COGMENT = 1550,
// Emeribian Forms
    SPECIES_CHARIZARD_EMERIBIAN = 1551,
    SPECIES_NINETALES_EMERIBIAN = 1552,
    SPECIES_ODDISH_EMERIBIAN = 1553,
    SPECIES_GLOOM_EMERIBIAN = 1554,
    SPECIES_VILEPLUME_EMERIBIAN = 1555,
    SPECIES_DODUO_EMERIBIAN = 1556,
    SPECIES_DODRIO_EMERIBIAN = 1557,
    SPECIES_MEGANIUM_EMERIBIAN = 1558,
    SPECIES_TYPHLOSION_EMERIBIAN = 1559,
    SPECIES_FERALIGATR_EMERIBIAN = 1560,
    SPECIES_NOCTOWL_EMERIBIAN = 1561,
    SPECIES_SPINARAK_EMERIBIAN = 1562,
    SPECIES_ARIADOS_EMERIBIAN = 1563,
    SPECIES_BELLOSSOM_EMERIBIAN = 1564,
    SPECIES_HOPPIP_EMERIBIAN = 1565,
    SPECIES_SKIPLOOM_EMERIBIAN = 1566,
    SPECIES_JUMPLUFF_EMERIBIAN = 1567,
    SPECIES_MAGCARGO_EMERIBIAN = 1568,
    SPECIES_MIGHTYENA_EMERIBIAN = 1569,
    SPECIES_RALTS_EMERIBIAN = 1570,
    SPECIES_KIRLIA_EMERIBIAN = 1571,
    SPECIES_GARDEVOIR_EMERIBIAN = 1572,
    SPECIES_SHINX_EMERIBIAN = 1573,
    SPECIES_LUXIO_EMERIBIAN = 1574,
    SPECIES_LUXRAY_EMERIBIAN = 1575,
    SPECIES_DRIFLOON_EMERIBIAN = 1576,
    SPECIES_DRIFBLIM_EMERIBIAN = 1577,
    SPECIES_BUNEARY_EMERIBIAN = 1578,
    SPECIES_LOPUNNY_EMERIBIAN = 1579,
    SPECIES_SKIDDO_EMERIBIAN = 1580,
    SPECIES_GOGOAT_EMERIBIAN = 1581,
    SPECIES_HONEDGE_EMERIBIAN = 1582,
    SPECIES_DOUBLADE_EMERIBIAN = 1583,
    SPECIES_AEGISLASH_EMERIBIAN = 1584,
    SPECIES_SKRELP_EMERIBIAN = 1585,
    SPECIES_DRAGALGE_EMERIBIAN = 1586,
    SPECIES_TREVENANT_EMERIBIAN = 1587,
    SPECIES_MIMIKYU_EMERIBIAN = 1588,
    SPECIES_FALINKS_EMERIBIAN = 1589,

    FAKE_MEGA_START = SPECIES_FALINKS_EMERIBIAN,

// Fribian Megas
    SPECIES_WIGGLYTUFF_MEGA = 1590,
    SPECIES_STARMIE_MEGA_F = 1591,
    SPECIES_MEGANIUM_MEGA_F = 1592,
    SPECIES_FLYGON_MEGA = 1593,
    SPECIES_MILOTIC_MEGA = 1594,
    SPECIES_CHIMECHO_MEGA_F = 1595,
    SPECIES_TORTERRA_MEGA = 1596,
    SPECIES_EMPOLEON_MEGA = 1597,
    SPECIES_VESPIQUEN_MEGA = 1598,
    SPECIES_DUSKNOIR_MEGA = 1599,
    SPECIES_FROSLASS_MEGA_F = 1600,
    SPECIES_KLINKLANG_MEGA = 1601,
    SPECIES_HAXORUS_MEGA = 1602,
    SPECIES_HYDREIGON_MEGA = 1603,
    SPECIES_DELPHOX_MEGA_F = 1604,
    SPECIES_AURORUS_MEGA = 1605,
    SPECIES_DUDUNSPARCE_MEGA = 1606,
// Emeribian Megas
    SPECIES_FEAROW_MEGA = 1607,
    SPECIES_NIDOQUEEN_MEGA = 1608,
    SPECIES_NIDOKING_MEGA = 1609,
    SPECIES_CLEFABLE_MEGA_E = 1610,
    SPECIES_RAPIDASH_MEGA = 1611,
    SPECIES_TYPHLOSION_MEGA = 1612,
    SPECIES_LUGIA_MEGA = 1613,
    SPECIES_HO_OH_MEGA = 1614,
    SPECIES_GARDEVOIR_MEGA_Q = 1615,
    SPECIES_GARDEVOIR_EMERIBIAN_MEGA = 1616,
    SPECIES_EXPLOUD_MEGA = 1617,
    SPECIES_CRAWDAUNT_MEGA = 1618,
    SPECIES_MILOTIC_MEGA_E = 1619,
    SPECIES_INFERNAPE_MEGA = 1620,
    SPECIES_STARAPTOR_MEGA_E = 1621,
    SPECIES_LUXRAY_MEGA = 1622,
    SPECIES_LOPUNNY_EMERIBIAN_MEGA = 1623,
    SPECIES_LUMINEON_MEGA = 1624,
    SPECIES_ELECTIVIRE_MEGA = 1625,
    SPECIES_MAGMORTAR_MEGA = 1626,
    SPECIES_GALLADE_MEGA_Q = 1627,
    SPECIES_SERPERIOR_MEGA = 1628,
    SPECIES_SLURPUFF_MEGA = 1629,
    SPECIES_TSAREENA_MEGA = 1630,

    // Legends Z-A
    SPECIES_CLEFABLE_MEGA = 1631,
    SPECIES_VICTREEBEL_MEGA = 1632,
    SPECIES_STARMIE_MEGA = 1633,
    SPECIES_DRAGONITE_MEGA = 1634,
    SPECIES_MEGANIUM_MEGA = 1635,
    SPECIES_FERALIGATR_MEGA = 1636,
    SPECIES_SKARMORY_MEGA = 1637,
    SPECIES_FROSLASS_MEGA = 1638,
    SPECIES_EMBOAR_MEGA = 1639,
    SPECIES_EXCADRILL_MEGA = 1640,
    SPECIES_SCOLIPEDE_MEGA = 1641,
    SPECIES_SCRAFTY_MEGA = 1642,
    SPECIES_EELEKTROSS_MEGA = 1643,
    SPECIES_CHANDELURE_MEGA = 1644,
    SPECIES_CHESNAUGHT_MEGA = 1645,
    SPECIES_DELPHOX_MEGA = 1646,
    SPECIES_GRENINJA_MEGA = 1647,
    SPECIES_PYROAR_MEGA = 1648,
    SPECIES_MALAMAR_MEGA = 1649,
    SPECIES_DRAGALGE_MEGA = 1650,
    SPECIES_HAWLUCHA_MEGA = 1651,
    SPECIES_FLOETTE_MEGA = 1652,
    SPECIES_BARBARACLE_MEGA = 1653,
    SPECIES_ZYGARDE_MEGA = 1654,
    SPECIES_DRAMPA_MEGA = 1655,
    SPECIES_FALINKS_MEGA = 1656,
    SPECIES_HEATRAN_MEGA = 1657,
    SPECIES_DARKRAI_MEGA = 1658,
    SPECIES_ZERAORA_MEGA = 1659,
    SPECIES_RAICHU_MEGA_X = 1660,
    SPECIES_RAICHU_MEGA_Y = 1661,
    SPECIES_CHIMECHO_MEGA = 1662,
    SPECIES_ABSOL_MEGA_Z = 1663,
    SPECIES_STARAPTOR_MEGA = 1664,
    SPECIES_GARCHOMP_MEGA_Z = 1665,
    SPECIES_LUCARIO_MEGA_Z = 1666,
    SPECIES_GOLURK_MEGA = 1667,
    SPECIES_MEOWSTIC_M_MEGA = 1668,
    SPECIES_MEOWSTIC_F_MEGA = 1669,
    SPECIES_CRABOMINABLE_MEGA = 1670,
    SPECIES_GOLISOPOD_MEGA = 1671,
    SPECIES_MAGEARNA_MEGA = 1672,
    SPECIES_MAGEARNA_ORIGINAL_MEGA = 1673,
    SPECIES_SCOVILLAIN_MEGA = 1674,
    SPECIES_BAXCALIBUR_MEGA = 1675,
    SPECIES_TATSUGIRI_CURLY_MEGA = 1676,
    SPECIES_TATSUGIRI_DROOPY_MEGA = 1677,
    SPECIES_TATSUGIRI_STRETCHY_MEGA = 1678,
    SPECIES_GLIMMORA_MEGA = 1679,

    FAKE_EXP_1_START = SPECIES_GLIMMORA_MEGA,

// Expansion 1
    SPECIES_MAGNEMELT = 1680,
    SPECIES_CHOUTEI = 1681,
    SPECIES_KAILANT = 1682,
    SPECIES_CORPELLA = 1683,
    SPECIES_OCEAN_GLEAM = 1684,
    SPECIES_REND_ECLIPSE = 1685,
    SPECIES_TUNDRA_HUSK = 1686,
    SPECIES_CALAMITY_MAW = 1687,
    SPECIES_REGIAGUA = 1688,
// Expansion 1 Forms
    SPECIES_EKANS_EXP_1 = 1689,
    SPECIES_ARBOK_EXP_1 = 1690,
    SPECIES_MAGNEMITE_EXP_1 = 1691,
    SPECIES_MAGNETON_EXP_1 = 1692,
    SPECIES_GRIMER_EXP_1 = 1693,
    SPECIES_MUK_EXP_1 = 1694,
    SPECIES_MAREEP_EXP_1 = 1695,
    SPECIES_FLAAFFY_EXP_1 = 1696,
    SPECIES_AMPHAROS_EXP_1 = 1697,
    SPECIES_SHROOMISH_EXP_1 = 1698,
    SPECIES_BRELOOM_EXP_1 = 1699,
    SPECIES_SABLEYE_EXP_1 = 1700,
    SPECIES_BUDEW_EXP_1 = 1701,
    SPECIES_ROSELIA_EXP_1 = 1702,
    SPECIES_ROSERADE_EXP_1 = 1703,
    SPECIES_SWABLU_EXP_1 = 1704,
    SPECIES_ALTARIA_EXP_1 = 1705,
    SPECIES_BRONZOR_EXP_1 = 1706,
    SPECIES_BRONZONG_EXP_1 = 1707,
    SPECIES_WIMPOD_EXP_1 = 1708,
    SPECIES_GOLISOPOD_EXP_1 = 1709,
// Expansion 1 Megas
    SPECIES_SABLEYE_EXP_1_MEGA = 1710,
    SPECIES_TROPIUS_MEGA = 1711,
    SPECIES_TENTACRUEL_MEGA = 1712,
    SPECIES_YANMEGA_MEGA = 1713,
// Expansion 1 Unobtainables
    SPECIES_CALAMITY_MAW_BOSS = 1714,
    SPECIES_MISSINGNO_YELLOW_BOSS = 1715,

    FAKE_SPECIES_END = SPECIES_MISSINGNO_YELLOW_BOSS,


    SPECIES_CUSTOM_START = SPECIES_MISSINGNO_YELLOW_BOSS,
