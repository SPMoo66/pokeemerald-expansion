...
const struct SpeciesInfo gSpeciesInfoGen8[] =
{
    ...
    [SPECIES_GROOKEY] =
    {
        ...
        .abilities = { ABILITY_OVERGROW, ABILITY_TANGLING_HAIR, ABILITY_GRASSY_SURGE },
...
#define RILLABOOM_MISC_INFO                                                     \
    ...
    [SPECIES_SCORBUNNY] =
    {
        ...
        .abilities = { ABILITY_BLAZE, ABILITY_STEADFAST, ABILITY_LIBERO },
...
#define CINDERACE_MISC_INFO                                             \
    ...
    [SPECIES_SOBBLE] =
    {
        ...
        .abilities = { ABILITY_TORRENT, ABILITY_TINTED_LENS, ABILITY_SNIPER },
...
#define INTELEON_MISC_INFO                                              \
    ...
    [SPECIES_SKWOVET] =
    {
        ...
        .abilities = { ABILITY_CHEEK_POUCH, ABILITY_CUD_CHEW, ABILITY_GLUTTONY },
...
#define ORBEETLE_MISC_INFO                                                  \
    ...
    [SPECIES_NICKIT] =
    {
        ...
        LEARNSETS(Nickit),
        .evolutions = EVOLUTION({EVO_LEVEL, 24, SPECIES_THIEVUL}),
    },
    ...
    [SPECIES_WOOLOO_FRIBIAN] =
    {
        ...
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_MEDIUM_FAST,
        .abilities = { ABILITY_FLUFFY, ABILITY_RUN_AWAY, ABILITY_ANALYTIC },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Wooloo"),
        .cryId = CRY_WOOLOO,
        .natDexNum = NATIONAL_DEX_WOOLOO,
        ...
        .weight = 60,
        .description = COMPOUND_STRING(
            "Unlike more domesticated variants of\n"
            "its kind, it fights back viciously\n"
            "against predators. Its ensemble is\n"
            "designed to scare them away."),
        .pokemonScale = 422,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(WoolooFribian, 40, 40),
        .frontPicYOffset = 6,
        .frontAnimFrames = sAnims_WoolooFribian,
        //.frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        BACK_PIC(WoolooFribian, 56, 32),
        .backPicYOffset = 16,
        //.backAnimId = BACK_ANIM_NONE,
        PALETTES(WoolooFribian),
        ICON(WoolooFribian, 0),
        .footprint = gMonFootprint_Wooloo,
        .formSpeciesIdTable = sWoolooFormSpeciesIdTable,
        LEARNSETS(WoolooFribian),
        .evolutions = EVOLUTION({EVO_LEVEL, 24, SPECIES_DUBWOOL_FRIBIAN}),
        .isFribianForm = TRUE,
    },

    [SPECIES_DUBWOOL_FRIBIAN] =
    {
        .baseHP        = 72,
        .baseAttack    = 80,
        .baseDefense   = 100,
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_FIELD, EGG_GROUP_FIELD },
        .abilities = { ABILITY_FLUFFY, ABILITY_INFILTRATOR, ABILITY_GORILLA_TACTICS },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Dubwool"),
        .cryId = CRY_DUBWOOL,
        .natDexNum = NATIONAL_DEX_DUBWOOL,
        ...
        .weight = 430,
        .description = COMPOUND_STRING(
            "It hunts bigger and bigger prety out of\n"
            "a desire for more glorious trophies. It\n"
            "will often use these as disguise\n"
            "for the next hunt."),
        .pokemonScale = 272,
        .pokemonOffset = 3,
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(DubwoolFribian, 48, 56),
        .frontPicYOffset = 5,
        .frontAnimFrames = sAnims_DubwoolFribian,
        //.frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        BACK_PIC(DubwoolFribian, 64, 40),
        .backPicYOffset = 0,
        //.backAnimId = BACK_ANIM_NONE,
        PALETTES(DubwoolFribian),
        ICON(DubwoolFribian, 2),
        .footprint = gMonFootprint_Dubwool,
        .formSpeciesIdTable = sDubwoolFormSpeciesIdTable,
        LEARNSETS(DubwoolFribian),
        .isFribianForm = TRUE,
    },
...
#define DREDNAW_MISC_INFO                                         \
    ...
    [SPECIES_YAMPER] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = { EGG_GROUP_FIELD, EGG_GROUP_FIELD },
        .abilities = { ABILITY_BALL_FETCH, ABILITY_ELECTRIC_SURGE, ABILITY_RATTLED },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_BOLTUND] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = { EGG_GROUP_FIELD, EGG_GROUP_FIELD },
        .abilities = { ABILITY_STRONG_JAW, ABILITY_ELECTRIC_SURGE, ABILITY_COMPETITIVE },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_CARKOL] =
    {
        ...
        LEARNSETS(Carkol),
        .evolutions = EVOLUTION({EVO_LEVEL, 37, SPECIES_COALOSSAL}),
    },
...
#define CRAMORANT_MISC_INFO                                     \
    ...
    [SPECIES_ARROKUDA] =
    {
        ...
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_DRIZZLE, ABILITY_PROPELLER_TAIL },
        .bodyColor = BODY_COLOR_BROWN,
...
#define CENTISKORCH_MISC_INFO                                                           \
    ...
    [SPECIES_CENTISKORCH_GIGANTAMAX] =
    {
        ...
        .baseSpAttack  = 110,
        .baseSpDefense = 115,
        .abilities = { ABILITY_WHITE_SMOKE, ABILITY_WHITE_SMOKE, ABILITY_WHITE_SMOKE },
        .height = 750,
        .weight = 0,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_CLOBBOPUS] =
    {
        ...
        .abilities = { ABILITY_LIMBER, ABILITY_WATER_COMPACTION, ABILITY_TECHNICIAN },
        .bodyColor = BODY_COLOR_BROWN,
...
#define POLTEAGEIST_MISC_INFO                                                            \
    ...
    [SPECIES_HATENNA] =
    {
        ...
        LEARNSETS(Hatenna),
        .evolutions = EVOLUTION({EVO_LEVEL, 24, SPECIES_HATTREM}),
    },
...
#define GRIMMSNARL_MISC_INFO                                                    \
    ...
    [SPECIES_MILCERY] =
    {
        ...
        .abilities = { ABILITY_SWEET_VEIL, ABILITY_WELL_BAKED_BODY, ABILITY_AROMA_VEIL },
        .bodyColor = BODY_COLOR_WHITE,
...
#define ALCREMIE_REGULAR_SPECIES_INFO(sweet, cream, color)                                \
    ...
    [SPECIES_FALINKS_EMERIBIAN] =
    {
        ...
        .abilities = { ABILITY_STEAM_ENGINE, ABILITY_CORROSION, ABILITY_SPEED_BOOST },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Falinks"),
        .cryId = CRY_FALINKS,
        .natDexNum = NATIONAL_DEX_FALINKS,
        ...
        .weight = 2200,
        .description = COMPOUND_STRING(
            "First bred as part of the age of trains\n"
            "and coal being king, many of these\n"
            "Pokémon still roam the world despite\n"
            "their dependence on coal."),
        .pokemonScale = 275,
        .pokemonOffset = 7,
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(FalinksEmeribian, 56, 48),
        .frontPicYOffset = 11,
        .frontAnimFrames = sAnims_FalinksEmeribian,
        //.frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        BACK_PIC(FalinksEmeribian, 64, 40),
        .backPicYOffset = 0,
        //.backAnimId = BACK_ANIM_NONE,
    ...
    [SPECIES_PINCURCHIN] =
    {
        ...
        .abilities = { ABILITY_LIGHTNING_ROD, ABILITY_ELECTROMORPHOSIS, ABILITY_ELECTRIC_SURGE },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_SNOM] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_BUG, EGG_GROUP_BUG },
        .abilities = { ABILITY_SHIELD_DUST, ABILITY_REFRIGERATE, ABILITY_ICE_SCALES },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Snom"),
        .cryId = CRY_SNOM,
    ...
    [SPECIES_STONJOURNER] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = { EGG_GROUP_MINERAL, EGG_GROUP_MINERAL },
        .abilities = { ABILITY_POWER_SPOT, ABILITY_LONG_REACH, ABILITY_SAND_SPIT },
        .bodyColor = BODY_COLOR_GRAY,
...
#define MORPEKO_MISC_INFO                                       \
    ...
    [SPECIES_CUFANT] =
    {
        ...
        .abilities = { ABILITY_SHEER_FORCE, ABILITY_LONG_REACH, ABILITY_HEAVY_METAL },
        .bodyColor = BODY_COLOR_YELLOW,
...
#define ETERNATUS_MISC_INFO                                                             \
    ...
    [SPECIES_KUBFU] =
    {
        ...
        LEARNSETS(Kubfu),
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_SCROLL_OF_DARKNESS, SPECIES_URSHIFU_SINGLE_STRIKE_STYLE},
