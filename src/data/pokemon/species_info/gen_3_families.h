...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    [SPECIES_TREECKO] =
    {
        ...
        .abilities = { ABILITY_OVERGROW, ABILITY_INFILTRATOR, ABILITY_UNBURDEN },
    ...
    [SPECIES_MUDKIP] =
    {
        ...
        .abilities = { ABILITY_TORRENT, ABILITY_OWN_TEMPO, ABILITY_DAMP },
    ...
    [SPECIES_POOCHYENA] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 22, SPECIES_MIGHTYENA},
								{EVO_LEVEL_MOVE, MOVE_FIRE_FANG, SPECIES_MIGHTYENA_EMERIBIAN, 22}),
    },
    ...
    [SPECIES_MIGHTYENA_EMERIBIAN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_STRONG_JAW, ABILITY_BLAZE, ABILITY_MOXIE },
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_MightyenaEmeribian,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 6,
        .frontAnimFrames = sAnims_MightyenaEmeribian,
        .frontAnimId = ANIM_V_SHAKE,
        .backPic = gMonBackPic_MightyenaEmeribian,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_H_SHAKE,
        .palette = gMonPalette_MightyenaEmeribian,
        .shinyPalette = gMonShinyPalette_MightyenaEmeribian,
        .iconSprite = gMonIcon_MightyenaEmeribian,
        .iconPalIndex = 2,
        FOOTPRINT(Mightyena)
    ...
    [SPECIES_ZIGZAGOON] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 22, SPECIES_LINOONE}),
    },
    ...
    [SPECIES_ZIGZAGOON_GALAR] =
    {
        ...
        .formSpeciesIdTable = sZigzagoonFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 22, SPECIES_LINOONE_GALAR}),
    },
    ...
    [SPECIES_WURMPLE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL_SILCOON, 8, SPECIES_SILCOON},
                                {EVO_LEVEL_CASCOON, 8, SPECIES_CASCOON}),
    },
    ...
    [SPECIES_BEAUTIFLY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SWARM, ABILITY_AERILATE, ABILITY_RIVALRY },
    ...
    [SPECIES_DUSTOX] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SHIELD_DUST, ABILITY_MERCILESS, ABILITY_COMPOUND_EYES },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_TAILLOW] =
    {
        ...
        .abilities = { ABILITY_GUTS, ABILITY_SHARPNESS, ABILITY_SCRAPPY },
        .bodyColor = BODY_COLOR_BLUE,
...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_GARDEVOIR_MEGA_Q] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_GardevoirMegaQ,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = sAnims_GardevoirMegaQ,
        //.frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .backPic = gMonBackPic_GardevoirMegaQ,
        .backPicSize = MON_COORDS_SIZE(48, 56),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_SHAKE_GLOW_GREEN,
        .palette = gMonPalette_GardevoirMegaQ,
        .shinyPalette = gMonShinyPalette_GardevoirMegaQ,
        .iconSprite = gMonIcon_GardevoirMega,
        .iconPalIndex = 1,
        FOOTPRINT(Gardevoir)
        .isMegaEvolution = TRUE,
    ...
    [SPECIES_RALTS_EMERIBIAN] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_RaltsEmeribian,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 12,
        .frontAnimFrames = sAnims_RaltsEmeribian,
        //.frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .backPic = gMonBackPic_RaltsEmeribian,
        .backPicSize = MON_COORDS_SIZE(48, 56),
        .backPicYOffset = 1,
        .backAnimId = BACK_ANIM_SHAKE_GLOW_GREEN,
        .palette = gMonPalette_RaltsEmeribian,
        .shinyPalette = gMonShinyPalette_RaltsEmeribian,
        .iconSprite = gMonIcon_RaltsEmeribian,
        .iconPalIndex = 0,
        FOOTPRINT(Ralts)
        ...
        .formSpeciesIdTable = sRaltsFormSpeciesIdTable,
        .eggMoveLearnset = sRaltsEmeribianEggMoveLearnset,
    ...
    [SPECIES_KIRLIA_EMERIBIAN] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_KirliaEmeribian,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 3,
        .frontAnimFrames = sAnims_KirliaEmeribian,
        //.frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .backPic = gMonBackPic_KirliaEmeribian,
        .backPicSize = MON_COORDS_SIZE(48, 56),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_SHAKE_GLOW_GREEN,
        .palette = gMonPalette_KirliaEmeribian,
        .shinyPalette = gMonShinyPalette_KirliaEmeribian,
        .iconSprite = gMonIcon_KirliaEmeribian,
        .iconPalIndex = 0,
        FOOTPRINT(Kirlia)
    ...
    [SPECIES_GARDEVOIR_EMERIBIAN] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_GardevoirEmeribian,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 3,
        .frontAnimFrames = sAnims_GardevoirEmeribian,
        //.frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .backPic = gMonBackPic_GardevoirEmeribian,
        .backPicSize = MON_COORDS_SIZE(48, 56),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_SHAKE_GLOW_GREEN,
        .palette = gMonPalette_GardevoirEmeribian,
        .shinyPalette = gMonShinyPalette_GardevoirEmeribian,
        .iconSprite = gMonIcon_GardevoirEmeribian,
        .iconPalIndex = 0,
        FOOTPRINT(Gardevoir)
    ...
    [SPECIES_GARDEVOIR_EMERIBIAN_MEGA] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_GardevoirEmeribianMega,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 3,
        .frontAnimFrames = sAnims_GardevoirEmeribianMega,
        //.frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .backPic = gMonBackPic_GardevoirEmeribianMega,
        .backPicSize = MON_COORDS_SIZE(48, 56),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_SHAKE_GLOW_GREEN,
        .palette = gMonPalette_GardevoirEmeribianMega,
        .shinyPalette = gMonShinyPalette_GardevoirEmeribianMega,
        .iconSprite = gMonIcon_GardevoirEmeribian,
        .iconPalIndex = 0,
        FOOTPRINT(Gardevoir)
        .isMegaEvolution = TRUE,
    ...
    [SPECIES_GALLADE_MEGA_Q] =
    {
        ...
        .trainerScale = 296,
        .trainerOffset = 1,
        .frontPic = gMonFrontPic_GalladeMegaQ,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = sAnims_GalladeMegaQ,
        //.frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .backPic = gMonBackPic_GalladeMegaQ,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_SHRINK_GROW_VIBRATE,
        .palette = gMonPalette_GalladeMegaQ,
        .shinyPalette = gMonShinyPalette_GalladeMegaQ,
        .iconSprite = gMonIcon_GalladeMega,
        .iconPalIndex = 1,
        FOOTPRINT(Gallade)
        .isMegaEvolution = TRUE,
    ...
    [SPECIES_MASQUERAIN] =
    {
        ...
        .baseSpAttack  = P_UPDATED_STATS >= GEN_7 ? 106 : 86,
        .baseSpDefense = 90,
        .types = MON_TYPES(TYPE_BUG, TYPE_FLYING),
        .catchRate = 75,
    #if P_UPDATED_EXP_YIELDS >= GEN_7
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_BUG),
        .abilities = { ABILITY_INTIMIDATE, ABILITY_COSTAR, ABILITY_UNNERVE },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_BRELOOM_FRIBIAN] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_BreloomFribian,
        .frontPicSize = MON_COORDS_SIZE(48, 64),
        .frontPicYOffset = 1,
        .frontAnimFrames = sAnims_BreloomFribian,
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .backPic = gMonBackPic_BreloomFribian,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 8,
        .backAnimId = BACK_ANIM_JOLT_RIGHT,
        .palette = gMonPalette_BreloomFribian,
        .shinyPalette = gMonShinyPalette_BreloomFribian,
        .iconSprite = gMonIcon_BreloomFribian,
        .iconPalIndex = 0,
        FOOTPRINT(Breloom)
        .formSpeciesIdTable = sBreloomFormSpeciesIdTable,
    ...
    [SPECIES_NINCADA] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_COMPOUND_EYES, ABILITY_SHED_SKIN, ABILITY_RUN_AWAY },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_NINJASK] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SPEED_BOOST, ABILITY_SHELL_ARMOR, ABILITY_INFILTRATOR },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_EXPLOUD_MEGA] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_ExploudMega,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 3,
        .frontAnimFrames = sAnims_ExploudMega,
        .frontAnimId = ANIM_V_SHAKE_TWICE,
        .backPic = gMonBackPic_ExploudMega,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 8,
        .backAnimId = BACK_ANIM_GROW_STUTTER,
        .palette = gMonPalette_ExploudMega,
        .shinyPalette = gMonShinyPalette_ExploudMega,
        .iconSprite = gMonIcon_Exploud,
        .iconPalIndex = 2,
        FOOTPRINT(Exploud)
        .isMegaEvolution = TRUE,
    ...
    [SPECIES_DELCATTY] =
    {
        ...
        .baseAttack    = 80,
        .baseDefense   = 70,
        .baseSpeed     = P_UPDATED_STATS >= GEN_7 ? 110 : 90,
        .baseSpAttack  = 55,
        .baseSpDefense = 65,
        .types = MON_TYPES(TYPE_NORMAL),
        .catchRate = 60,
    ...
    [SPECIES_VOLBEAT] =
    {
        ...
        .abilities = { ABILITY_TINTED_LENS, ABILITY_SWARM, ABILITY_PRANKSTER },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_CARVANHA] =
    {
        ...
        .abilities = { ABILITY_ROUGH_SKIN, ABILITY_HYDRATION, ABILITY_SPEED_BOOST },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_LUNATONE] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_LEVITATE, ABILITY_TELEPATHY, ABILITY_NONE },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_CRAWDAUNT] =
    {
        ...
        .formSpeciesIdTable = sCrawdauntFormSpeciesIdTable,
        .formChangeTable = sCrawdauntFormChangeTable,
    },

    [SPECIES_CRAWDAUNT_MEGA] =
    {
        .baseHP        = 63,
        .baseAttack    = 150,
        .baseDefense   = 110,
        ...
        .catchRate = 155,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 214 : 211,
        .evYield_Attack = 2,
        .itemCommon = ITEM_LANSAT_BERRY,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 15,
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_CrawdauntMega,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 4,
        .frontAnimFrames = sAnims_CrawdauntMega,
        .frontAnimId = ANIM_GROW_VIBRATE,
        .backPic = gMonBackPic_CrawdauntMega,
        .backPicSize = MON_COORDS_SIZE(64, 56),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_JOLT_RIGHT,
        .palette = gMonPalette_CrawdauntMega,
        .shinyPalette = gMonShinyPalette_CrawdauntMega,
        .iconSprite = gMonIcon_Crawdaunt,
        .iconPalIndex = 0,
        FOOTPRINT(Crawdaunt)
        OVERWORLD(
    ...
    [SPECIES_BALTOY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_LEVITATE, ABILITY_TELEPATHY, ABILITY_WELL_BAKED_BODY },
        .bodyColor = BODY_COLOR_BROWN,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 34, SPECIES_CLAYDOL}),
    },
    ...
    [SPECIES_LILEEP] =
    {
        ...
        .abilities = { ABILITY_SUCTION_CUPS, ABILITY_SAP_SIPPER, ABILITY_STORM_DRAIN },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    #endif
        .evYield_Attack = 1,
        .itemRare = ITEM_MARANGA_BERRY,
        .genderRatio = PERCENT_FEMALE(12.5),
        .eggCycles = 30,
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_3),
        .abilities = { ABILITY_BATTLE_ARMOR, ABILITY_SHARPNESS, ABILITY_SWIFT_SWIM },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_MILOTIC_MEGA_E] =
    {
        ...
        .trainerScale = 360,
        .trainerOffset = 7,
        .frontPic = gMonFrontPic_MiloticMegaE,
        .frontPicSize = MON_COORDS_SIZE(64, 64),
        .frontPicYOffset = 1,
        .frontAnimFrames = sAnims_MiloticMegaE,
        .frontAnimId = ANIM_CIRCULAR_STRETCH_TWICE,
        .frontAnimDelay = 45,
        .backPic = gMonBackPic_MiloticMegaE,
        .backPicSize = MON_COORDS_SIZE(64, 64),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_SHAKE_GLOW_BLUE,
        .palette = gMonPalette_MiloticMegaE,
        .shinyPalette = gMonShinyPalette_MiloticMegaE,
        .iconSprite = gMonIcon_MiloticMegaE,
        .iconPalIndex = 3,
        FOOTPRINT(Milotic)
        .levelUpLearnset = sMiloticLevelUpLearnset,
        .teachableLearnset = sMiloticTeachableLearnset,
    ...
    [SPECIES_KECLEON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_COLOR_CHANGE, ABILITY_MOODY, ABILITY_PROTEAN },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_DUSKULL] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_LEVITATE, ABILITY_AFTERMATH, ABILITY_FRISK },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_DUSCLOPS] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_PRESSURE, ABILITY_AFTERMATH, ABILITY_FRISK },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_CHINGLING] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_LEVITATE, ABILITY_NONE, ABILITY_VICTORY_STAR },
        .bodyColor = BODY_COLOR_YELLOW,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 25, SPECIES_CHIMECHO}),
    },
#endif //P_GEN_4_CROSS_EVOS
    ...
    [SPECIES_FROSLASS] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY, EGG_GROUP_MINERAL),
        .abilities = { ABILITY_SNOW_CLOAK, ABILITY_SUPER_LUCK, ABILITY_CURSED_BODY },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_SPHEAL] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 23, SPECIES_SEALEO}),
    },
    ...
    [SPECIES_SEALEO] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 41, SPECIES_WALREIN}),
    },
    ...
    [SPECIES_LUVDISC] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_DRIZZLE, ABILITY_HYDRATION },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_BAGON] =
    {
        ...
        .abilities = { ABILITY_ROCK_HEAD, ABILITY_DEFIANT, ABILITY_SHEER_FORCE },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Bagon"),
        .cryId = CRY_BAGON,
    ...
    [SPECIES_SHELGON] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_DRAGON),
        .abilities = { ABILITY_ROCK_HEAD, ABILITY_BATTLE_ARMOR, ABILITY_OVERCOAT },
        .bodyColor = BODY_COLOR_WHITE,
