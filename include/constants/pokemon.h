...
enum EvolutionMethods {
    ...
    EVO_LEVEL_TYPE_MON_IN_PARTY,         // Pokémon reaches the specified level with an input Type Pokémon in party
    ...
    EVO_LEVEL_MOVE,                      // Pokémon knows specified move and reaches the specified level
};
...
#define STARTER_SET_KANTO  0
#define STARTER_SET_JOHTO  1
#define STARTER_SET_HOENN  2
#define STARTER_SET_SINNOH 3
#define STARTER_SET_UNOVA  4
#define STARTER_SET_KALOS  5
#define STARTER_SET_ALOLA  6
#define STARTER_SET_GALAR  7
#define STARTER_SET_PALDEA 8

#define STARTER_MON_COUNT  3
#define STARTER_SET_COUNT  9
