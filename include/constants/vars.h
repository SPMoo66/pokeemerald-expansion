...
#define VAR_MAGEARNA_STATE                               0x4052 // Was Dewford Town State
...
#define VAR_EMERALBODY_RIVAL_BATTLE_STATE                0x40A8 // Tracks which battle is next for Emeralbody rivals, will be different per rival but same variable
