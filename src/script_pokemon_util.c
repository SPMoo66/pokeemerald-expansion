...
void CreateScriptedDoubleWildMon(enum Species species1, u8 level1, enum Item item1, u8 abilityNum1, enum Species species2, u8 level2, enum Item item2, u8 abilityNum2, u16 move11, u16 move12, u16 move13, u16 move14, u16 move21, u16 move22, u16 move23, u16 move24)
{
    u8 heldItem1[2];
    u8 heldItem2[2];
