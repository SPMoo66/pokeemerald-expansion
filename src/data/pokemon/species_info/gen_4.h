...
const struct SpeciesInfo gSpeciesInfoGen4[] =
{
    ...
    [SPECIES_TORTERRA_MEGA] =
    {
        ...
        .trainerScale = 348,
        .trainerOffset = 6,
        FRONT_PIC(TorterraMega, 64, 64),
        .frontPicYOffset = 2,
        .frontAnimFrames = sAnims_TorterraMega,
        .frontAnimId = ANIM_H_SHAKE,
        BACK_PIC(TorterraMega, 64, 56),
        .backPicYOffset = 14,
        .backAnimId = BACK_ANIM_SHAKE_GLOW_GREEN,
        PALETTES(TorterraMega),
        ICON(Torterra, 1),
        .footprint = gMonFootprint_Torterra,
        LEARNSETS(Torterra),
        .formSpeciesIdTable = sTorterraFormSpeciesIdTable,
    ...
    [SPECIES_INFERNAPE_MEGA] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(InfernapeMega, 64, 64),
        .frontPicYOffset = 2,
        .frontAnimFrames = sAnims_InfernapeMega,
        .frontAnimId = ANIM_V_STRETCH,
        BACK_PIC(InfernapeMega, 64, 64),
        .backPicYOffset = 1,
        .backAnimId = BACK_ANIM_SHAKE_GLOW_RED,
        PALETTES(InfernapeMega),
        ICON(Infernape, 0),
        .footprint = gMonFootprint_Infernape,
        LEARNSETS(Infernape),
        .formSpeciesIdTable = sInfernapeFormSpeciesIdTable,
    ...
    [SPECIES_LUXRAY_MEGA] =
    {
        ...
        .trainerScale = 262,
        .trainerOffset = 0,
        FRONT_PIC(LuxrayMega, 64, 64),
        .frontPicYOffset = 2,
        .frontAnimFrames = sAnims_LuxrayMega,
        .frontAnimId = ANIM_GLOW_YELLOW,
        BACK_PIC(LuxrayMega, 64, 64),
        .backPicYOffset = 5,
        .backAnimId = BACK_ANIM_SHRINK_GROW_VIBRATE,
        PALETTES(LuxrayMega),
        ICON(Luxray, 0),
...
#define WORMADAM_MISC_INFO                                                      \
    ...
    [SPECIES_VESPIQUEN_MEGA] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(VespiquenMega, 48, 56),
        .frontPicYOffset = 4,
        .frontAnimFrames = sAnims_VespiquenMega,
        .frontAnimId = ANIM_LUNGE_GROW,
        .enemyMonElevation = 4,
        BACK_PIC(VespiquenMega, 64, 64),
        .backPicYOffset = 15,
        .backAnimId = BACK_ANIM_CIRCLE_COUNTERCLOCKWISE,
        PALETTES(VespiquenMega),
        ICON(Vespiquen, 0),
        .footprint = gMonFootprint_Vespiquen,
        LEARNSETS(Vespiquen),
        .formSpeciesIdTable = sVespiquenFormSpeciesIdTable,
...
#define GASTRODON_MISC_INFO                                                             \
    ...
    [SPECIES_DRIFLOON_EMERIBIAN] =
    {
        ...
        .frontAnimId = ANIM_V_SLIDE_WOBBLE,
        .enemyMonElevation = 5,
        BACK_PIC(DrifloonEmeribian, 40, 64),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_CONCAVE_ARC_SMALL,
        PALETTES(DrifloonEmeribian),
        ICON(DrifloonEmeribian, 2),
        .footprint = gMonFootprint_Drifloon,
        .formSpeciesIdTable = sDrifloonFormSpeciesIdTable,
        LEARNSETS(DrifloonEmeribian),
    ...
    [SPECIES_DRIFBLIM_EMERIBIAN] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(DrifblimEmeribian, 56, 56),
        .frontPicYOffset = 7,
        .frontAnimFrames = sAnims_DrifblimEmeribian,
        .frontAnimId = ANIM_V_SLIDE_WOBBLE,
        .enemyMonElevation = 7,
        BACK_PIC(DrifblimEmeribian, 64, 64),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_CONVEX_DOUBLE_ARC,
        PALETTES(DrifblimEmeribian),
        ICON(DrifblimEmeribian, 2),
        .footprint = gMonFootprint_Drifblim,
        .formSpeciesIdTable = sDrifblimFormSpeciesIdTable,
        LEARNSETS(DrifblimEmeribian),
        .isEmeribianForm = TRUE,
    },
...
#define LUCARIO_MISC_INFO                                       \
    ...
    [SPECIES_LUMINEON_MEGA] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(LumineonMega, 56, 56),
        .frontPicYOffset = 5,
        .frontAnimFrames = sAnims_LumineonMega,
        .frontAnimId = ANIM_H_STRETCH,
        BACK_PIC(LumineonMega, 56, 64),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_CONVEX_DOUBLE_ARC,
        PALETTES(LumineonMega),
        ICON(Lumineon, 0),
        .footprint = gMonFootprint_Lumineon,
        LEARNSETS(Lumineon),
        .formSpeciesIdTable = sLumineonFormSpeciesIdTable,
