...
#define CHARIZARD_MISC_INFO                                             \
    ...
    [SPECIES_CHARIZARD_EMERIBIAN] =
    {
        ...
        .trainerScale = 302,
        .trainerOffset = 3,
        FRONT_PIC(CharizardEmeribian, 64, 64),
        .frontPicYOffset = 0,
        ...
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_SHAKE_GLOW_RED,
        PALETTES(CharizardEmeribian),
        ICON(CharizardEmeribian, 0),
        .footprint = gMonFootprint_Charizard,
        LEARNSETS(CharizardEmeribian),
        .formSpeciesIdTable = sCharizardFormSpeciesIdTable,
        .formChangeTable = sCharizardFormChangeTable,
...
#define RATICATE_MISC_INFO                  \
    ...
    [SPECIES_FEAROW_MEGA] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(FearowMega, 64, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = sAnims_FearowMega,
        .frontAnimId = ANIM_FIGURE_8,
        .frontAnimDelay = 2,
        .enemyMonElevation = 6,
        BACK_PIC(FearowMega, 64, 56),
        .backPicYOffset = 4,
        .backAnimId = BACK_ANIM_JOLT_RIGHT,
        PALETTES(FearowMega),
        ICON(Fearow, 0),
...
#define SANDSLASH_MISC_INFO                                 \
    ...
    [SPECIES_CLEFABLE_MEGA] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(ClefableMega, 56, 56),
        .frontPicYOffset = 5,
        .frontAnimFrames = sAnims_ClefableMega,
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        BACK_PIC(ClefableMega, 64, 48),
        .backPicYOffset = 9,
        .backAnimId = BACK_ANIM_DIP_RIGHT_SIDE,
...
#define NINETALES_MISC_INFO                                 \
    ...
    [SPECIES_NINETALES_EMERIBIAN] =
    {
        ...
        .frontAnimId = ANIM_GROW_VIBRATE,
        BACK_PIC(NinetalesEmeribian, 64, 56),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_H_VIBRATE,
        PALETTES(NinetalesEmeribian),
        ICON(NinetalesEmeribian, 3),
        LEARNSETS(NinetalesEmeribian),
        .isEmeribianForm = TRUE,
    },
    ...
    [SPECIES_WIGGLYTUFF_MEGA] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(WigglytuffMega, 48, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = sAnims_WigglytuffMega,
        .frontAnimId = ANIM_H_JUMPS,
        .enemyMonElevation = 3,
        BACK_PIC(WigglytuffMega, 56, 64),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_GROW,
        PALETTES(WigglytuffMega),
        ICON(Wigglytuff, 0),
        .footprint = gMonFootprint_Wigglytuff,
        LEARNSETS(Wigglytuff),
        .formSpeciesIdTable = sWigglytuffFormSpeciesIdTable,
    ...
    [SPECIES_ODDISH_EMERIBIAN] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(OddishEmeribian, 40, 40),
        .frontPicYOffset = 15,
        .frontAnimFrames = sAnims_OddishEmeribian,
        .frontAnimId = ANIM_V_JUMPS_H_JUMPS,
        BACK_PIC(OddishEmeribian, 48, 48),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_H_SLIDE,
        PALETTES(OddishEmeribian),
        ICON(OddishEmeribian, 4),
        .footprint = gMonFootprint_Oddish,
        .formSpeciesIdTable = sOddishFormSpeciesIdTable,
        LEARNSETS(OddishEmeribian),
        .isEmeribianForm = TRUE,
    ...
    [SPECIES_GLOOM_EMERIBIAN] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(GloomEmeribian, 56, 48),
        .frontPicYOffset = 11,
        .frontAnimFrames = sAnims_GloomEmeribian,
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE_SLOW,
        BACK_PIC(GloomEmeribian, 64, 48),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_H_SLIDE,
        PALETTES(GloomEmeribian),
        ICON(GloomEmeribian, 4),
        .footprint = gMonFootprint_Gloom,
        .formSpeciesIdTable = sGloomFormSpeciesIdTable,
        LEARNSETS(GloomEmeribian),
        .isEmeribianForm = TRUE,
    ...
    [SPECIES_VILEPLUME_EMERIBIAN] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(VileplumeEmeribian, 56, 56),
        .frontPicYOffset = 7,
        .frontAnimFrames = sAnims_VileplumeEmeribian,
        .frontAnimId = ANIM_V_SQUISH_AND_BOUNCE_SLOW,
        BACK_PIC(VileplumeEmeribian, 64, 56),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_SHRINK_GROW_VIBRATE,
        PALETTES(VileplumeEmeribian),
        ICON(VileplumeEmeribian, 0),
        .footprint = gMonFootprint_Vileplume,
        .formSpeciesIdTable = sVileplumeFormSpeciesIdTable,
        LEARNSETS(VileplumeEmeribian),
        .isEmeribianForm = TRUE,
    },
    ...
    [SPECIES_BELLOSSOM_EMERIBIAN] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        FRONT_PIC(BellossomEmeribian, 32, 40),
        .frontPicYOffset = 12,
        .frontAnimFrames = sAnims_BellossomEmeribian,
        .frontAnimId = ANIM_H_SLIDE_SLOW,
        BACK_PIC(BellossomEmeribian, 48, 48),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_CONVEX_DOUBLE_ARC,
        PALETTES(BellossomEmeribian),
        ICON(BellossomEmeribian, 4),
        .footprint = gMonFootprint_Bellossom,
        .formSpeciesIdTable = sBellossomFormSpeciesIdTable,
        LEARNSETS(BellossomEmeribian),
        .isEmeribianForm = TRUE,
    },
#endif //P_GEN_2_CROSS_EVOS
...
#define PERSIAN_MISC_INFO                                   \
    ...
    [SPECIES_MEOWTH_ALOLAN] =
    {
        ...
        .isAlolanForm = TRUE,
        .evolutions = EVOLUTION({EVO_LEVEL, 28, SPECIES_PERSIAN_ALOLAN}),
    },
...
#define ALOLAN_GEODUDE_FAMILY_INFO                                              \
    ...
    [SPECIES_GRAVELER_ALOLAN] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_LINKING_CORD, SPECIES_GOLEM_ALOLAN}),
    },
    ...
    [SPECIES_GOLEM_FRIBIAN] =
    {
        ...
        .backPicYOffset = 0,
        //.backAnimId = BACK_ANIM_NONE,
        PALETTES(GolemFribian),
        ICON(GolemFribian, 2),
        .footprint = gMonFootprint_Golem,
        LEARNSETS(GolemFribian),
        .formSpeciesIdTable = sGolemFormSpeciesIdTable,
        .isFribianForm = TRUE,
    },
...
#define RAPIDASH_MISC_INFO                                  \
    ...
    [SPECIES_RAPIDASH_MEGA] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "serious, its fiery manes flare and blaze\n"
            "as it gallops its way up to 150 mph."),
        FRONT_PIC(RapidashMega, 64, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = sAnims_RapidashMega,
        .frontAnimId = ANIM_H_SHAKE,
        BACK_PIC(RapidashMega, 64, 64),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_JOLT_RIGHT,
        PALETTES(RapidashMega),
        ICON(Rapidash, 3),
        LEARNSETS(Rapidash),
        .formChangeTable = sRapidashFormChangeTable,
        .isMegaEvolution = TRUE,
...
#define GALARIAN_PONYTA_FAMILY_INFO                                                  \
    ...
    [SPECIES_PONYTA_GALARIAN] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 35, SPECIES_RAPIDASH_GALARIAN}),
    },
...
#define ALOLAN_GRIMER_FAMILY_INFO                                                           \
    ...
    [SPECIES_CLOYSTER_FRIBIAN] =
    {
        ...
        .trainerScale = 269,
        .trainerOffset = 1,
        FRONT_PIC(CloysterFribian, 64, 64),
        .frontPicYOffset = 3,
        .frontAnimFrames = sAnims_CloysterFribian,
        .frontAnimId = ANIM_V_SHAKE_TWICE,
        BACK_PIC(CloysterFribian, 64, 56),
        .backPicYOffset = 11,
        .backAnimId = BACK_ANIM_TRIANGLE_DOWN,
        PALETTES(CloysterFribian),
        ICON(CloysterFribian, 0),
        .footprint = gMonFootprint_Cloyster,
        .formSpeciesIdTable = sCloysterFormSpeciesIdTable,
        LEARNSETS(CloysterFribian),
        .isFribianForm = TRUE,
    },
...
#define GENGAR_ABILITIES {ABILITY_CURSED_BODY, ABILITY_TELEPATHY}
#else
#define GENGAR_ABILITIES {ABILITY_LEVITATE, ABILITY_TELEPATHY}
#endif
...
#define MAROWAK_MISC_INFO                                       \
    ...
    [SPECIES_KOFFING] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 35, SPECIES_WEEZING},
                                ...
                                {EVO_ITEM, ITEM_GALARICA_WREATH, SPECIES_WEEZING_GALARIAN}),
    },
...
#define SCIZOR_MISC_INFO                                \
    ...
    [SPECIES_ELECTIVIRE_MEGA] =
    {
        ...
        .trainerScale = 286,
        .trainerOffset = 1,
        FRONT_PIC(ElectivireMega, 64, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = sAnims_ElectivireMega,
        .frontAnimId = ANIM_GLOW_YELLOW,
        BACK_PIC(ElectivireMega, 64, 48),
        .backPicYOffset = 0,
        .backAnimId = BACK_ANIM_SHAKE_FLASH_YELLOW,
        PALETTES(ElectivireMega),
        ICON(Electivire, 1),
        .footprint = gMonFootprint_Electivire,
        LEARNSETS(Electivire),
        .formSpeciesIdTable = sElectivireFormSpeciesIdTable,
    ...
    [SPECIES_MAGMORTAR_MEGA] =
    {
        ...
        .trainerScale = 296,
        .trainerOffset = 1,
        FRONT_PIC(MagmortarMega, 64, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = sAnims_MagmortarMega,
        .frontAnimId = ANIM_V_STRETCH,
        BACK_PIC(MagmortarMega, 64, 56),
        .backPicYOffset = 6,
        .backAnimId = BACK_ANIM_SHAKE_GLOW_RED,
        PALETTES(MagmortarMega),
        ICON(Magmortar, 0),
        .footprint = gMonFootprint_Magmortar,
        LEARNSETS(Magmortar),
        .formSpeciesIdTable = sMagmortarFormSpeciesIdTable,
