...
const u32 gMessageBox_Gfx[] = INCGFX_U32("graphics/text_window/message_box.png", ".4bpp");
const u32 gSignpostWindow_Gfx[] = INCGFX_U32("graphics/text_window/signpost.png", ".4bpp");
