...
void SetFollowerNPCData(enum FollowerNPCDataTypes type, u32 value)
{
    ...
    case FNPC_DATA_MAP_ID:
        gSaveBlock1Ptr->NPCfollower.map.id = value;
        break;
    case FNPC_DATA_MAP_NUM:
        gSaveBlock1Ptr->NPCfollower.map.number = value;
        break;
    case FNPC_DATA_MAP_GROUP:
        gSaveBlock1Ptr->NPCfollower.map.group = value;
        break;
...
u32 GetFollowerNPCData(enum FollowerNPCDataTypes type)
{
    ...
    case FNPC_DATA_MAP_ID:
        return gSaveBlock1Ptr->NPCfollower.map.id;
    case FNPC_DATA_MAP_NUM:
        return gSaveBlock1Ptr->NPCfollower.map.number;
    case FNPC_DATA_MAP_GROUP:
        return gSaveBlock1Ptr->NPCfollower.map.group;
    case FNPC_DATA_EVENT_FLAG:
