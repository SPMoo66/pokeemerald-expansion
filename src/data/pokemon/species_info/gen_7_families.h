...
const struct SpeciesInfo gSpeciesInfoGen7[] =
{
    ...
    [SPECIES_ROWLET] =
    {
        ...
        .abilities = { ABILITY_OVERGROW, ABILITY_NO_GUARD, ABILITY_LONG_REACH },
    ...
    [SPECIES_DARTRIX] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 34, SPECIES_DECIDUEYE_HISUI, CONDITIONS({IF_KNOWS_MOVE, MOVE_MACH_PUNCH})},
    ...
    [SPECIES_LITTEN] =
    {
        ...
        .abilities = { ABILITY_BLAZE, ABILITY_SCRAPPY, ABILITY_INTIMIDATE },
    ...
    [SPECIES_POPPLIO] =
    {
        ...
        .abilities = { ABILITY_TORRENT, ABILITY_BIG_PECKS, ABILITY_LIQUID_VOICE },
    ...
    [SPECIES_PIKIPEK] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 15, SPECIES_TRUMBEAK}),
    },
    ...
    [SPECIES_TRUMBEAK] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 32, SPECIES_TOUCANNON}),
    },
    ...
    [SPECIES_LYCANROC_DUSK] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_TOUGH_CLAWS, ABILITY_GUARD_DOG, ABILITY_STEADFAST },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Lycanroc"),
    ...
    [SPECIES_MUDBRAY] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 36, SPECIES_MUDSDALE}),
    },
    ...
    [SPECIES_DEWPIDER] =
    {
        ...
        .abilities = { ABILITY_WATER_BUBBLE, ABILITY_DRIZZLE, ABILITY_WATER_ABSORB },
        .bodyColor = BODY_COLOR_GREEN,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 24, SPECIES_ARAQUANID}),
    },
    ...
    [SPECIES_FOMANTIS] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 28, SPECIES_LURANTIS}),
    },
    ...
    [SPECIES_MORELULL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_MAGIC_BOUNCE, ABILITY_EFFECT_SPORE, ABILITY_RAIN_DISH },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_SALANDIT] =
    {
        ...
        .abilities = { ABILITY_CORROSION, ABILITY_RATTLED, ABILITY_OBLIVIOUS },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_SALAZZLE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_CORROSION, ABILITY_QUEENLY_MAJESTY, ABILITY_OBLIVIOUS },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_STUFFUL] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 31, SPECIES_BEWEAR}),
    },
    ...
    [SPECIES_TSAREENA_MEGA] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_TsareenaMega,
        .frontPicSize = MON_COORDS_SIZE(56, 64),
        .frontPicYOffset = 0,
        .frontAnimFrames = sAnims_SingleFramePlaceHolder,
        .frontAnimId = ANIM_SHRINK_GROW,
        .backPic = gMonBackPic_TsareenaMega,
        .backPicSize = MON_COORDS_SIZE(56, 56),
        .backPicYOffset = 0,
        .palette = gMonPalette_TsareenaMega,
    ...
    [SPECIES_WIMPOD] =
    {
        ...
        .abilities = { ABILITY_WIMP_OUT, ABILITY_SHELL_ARMOR, ABILITY_ANGER_SHELL },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_SANDYGAST] =
    {
        ...
        .abilities = { ABILITY_WATER_COMPACTION, ABILITY_EARTH_EATER, ABILITY_SAND_VEIL },
        .bodyColor = BODY_COLOR_BROWN,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 40, SPECIES_PALOSSAND}),
    },
    ...
    [SPECIES_PYUKUMUKU] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1),
        .abilities = { ABILITY_INNARDS_OUT, ABILITY_TOXIC_CHAIN, ABILITY_UNAWARE },
        .bodyColor = BODY_COLOR_BLACK,
...
#define MINIOR_CORE_SPECIES_INFO(Form, color, iconPal)          \
    ...
    [SPECIES_TURTONATOR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_SHELL_ARMOR, ABILITY_IRON_BARBS, ABILITY_NONE },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_MIMIKYU_EMERIBIAN] =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_MimikyuEmeribian,
        .frontPicSize = MON_COORDS_SIZE(48, 40),
        .frontPicYOffset = 1,
        .frontAnimFrames = sAnims_SingleFramePlaceHolder,
        .frontAnimId = ANIM_DEEP_V_SQUISH_AND_BOUNCE,
        .backPic = gMonBackPic_MimikyuEmeribian,
        .backPicSize = MON_COORDS_SIZE(56, 56),
        .backPicYOffset = 0,
        //.backAnimId = BACK_ANIM_NONE,
        .palette = gMonPalette_MimikyuEmeribian,
    ...
    [SPECIES_DHELMISE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_STEELWORKER, ABILITY_NONE, ABILITY_THERMAL_EXCHANGE },
        .bodyColor = BODY_COLOR_GREEN,
        .noFlip = TRUE,
    ...
    [SPECIES_MELTAN] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_METAL_ALLOY, SPECIES_MELMETAL}),
    },
