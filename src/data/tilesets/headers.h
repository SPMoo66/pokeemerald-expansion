...
const struct Tileset gTileset_CaveExp1 =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_CaveExp1,
    .palettes = gTilesetPalettes_CaveExp1,
    .metatiles = gMetatiles_CaveExp1,
    .metatileAttributes = gMetatileAttributes_CaveExp1,
    .callback = InitTilesetAnim_CaveExp1,
};

const struct Tileset gTileset_OceanExp1 =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_OceanExp1,
    .palettes = gTilesetPalettes_OceanExp1,
    .metatiles = gMetatiles_OceanExp1,
...
const struct Tileset gTileset_Dungeon_Exp_1 =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_Dungeon_Exp_1,
    .palettes = gTilesetPalettes_Dungeon_Exp_1,
    .metatiles = gMetatiles_Dungeon_Exp_1,
...
const struct Tileset gTileset_Underwater_Sub1_Exp1 =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Underwater_Sub1_Exp1,
    .palettes = gTilesetPalettes_Underwater_Sub1_Exp1,
    .metatiles = gMetatiles_Underwater_Sub1_Exp1,
    .metatileAttributes = gMetatileAttributes_Underwater_Sub1_Exp1,
    .callback = NULL,
};
...
const struct Tileset gTileset_Temporal_Spire =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_Temporal_Spire,
    .palettes = gTilesetPalettes_Temporal_Spire,
    .metatiles = gMetatiles_Temporal_Spire,
    .metatileAttributes = gMetatileAttributes_Temporal_Spire,
    .callback = NULL,
};
